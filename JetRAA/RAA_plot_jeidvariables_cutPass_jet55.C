...
void RAA_plot_jeidvariables_cutPass_jet55(){
...
// jet55
    ...
    hMC_chMaxJtpt_jet55[i] = new TH1F(Form("hMC_chMaxJtpt_jet55_cent%d",i),Form("MC chMax/Jtpt, jet55 in centrality bin ",i),100,0,1);
    ...
    hMC_chSumJtpt_jet55[i] = new TH1F(Form("hMC_chSumJtpt_jet55_cent%d",i),Form("MC chSum/Jtpt, jet55 in centrality bin ",i),100,0,3);
    ...
    hMC_eMaxJtpt_jet55[i] = new TH1F(Form("hMC_eMaxJtpt_jet55_cent%d",i),Form("MC eMax/Jtpt, jet55 in centrality bin ",i),100,0,1.4);
    ...
    hMC_eSumJtpt_jet55[i] = new TH1F(Form("hMC_eSumJtpt_jet55_cent%d",i),Form("MC eSum/Jtpt, jet55 in centrality bin ",i),100,0,1.5);
    ...
    hMC_neMaxJtpt_jet55[i] = new TH1F(Form("hMC_neMaxJtpt_jet55_cent%d",i),Form("MC neMax/Jtpt, jet55 in centrality bin ",i),100,0,1.2);
    ...
    hMC_neSumJtpt_jet55[i] = new TH1F(Form("hMC_neSumJtpt_jet55_cent%d",i),Form("MC neSum/Jtpt, jet55 in centrality bin ",i),100,0,1.8);
    ...
    hMC_phMaxJtpt_jet55[i] = new TH1F(Form("hMC_phMaxJtpt_jet55_cent%d",i),Form("MC phMax/Jtpt, jet55 in centrality bin ",i),100,0,1.5);
    ...
    hMC_phSumJtpt_jet55[i] = new TH1F(Form("hMC_phSumJtpt_jet55_cent%d",i),Form("MC phSum/Jtpt, jet55 in centrality bin ",i),100,0,2);
    ...
    hMC_muMaxJtpt_jet55[i] = new TH1F(Form("hMC_muMaxJtpt_jet55_cent%d",i),Form("MC muMax/Jtpt, jet55 in centrality bin ",i),100,0,1);
    ...
    hMC_muSumJtpt_jet55[i] = new TH1F(Form("hMC_muSumJtpt_jet55_cent%d",i),Form("MC muSum/Jtpt, jet55 in centrality bin ",i),100,0,1);
    ...
    hMC_chMaxJtpt_jet55_keep[i] = new TH1F(Form("hMC_chMaxJtpt_jet55_keep_cent%d",i),Form("MC chMax/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1);
    ...
    hMC_chSumJtpt_jet55_keep[i] = new TH1F(Form("hMC_chSumJtpt_jet55_keep_cent%d",i),Form("MC chSum/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,3);
    ...
    hMC_eMaxJtpt_jet55_keep[i] = new TH1F(Form("hMC_eMaxJtpt_jet55_keep_cent%d",i),Form("MC eMax/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1.4);
    ...
    hMC_eSumJtpt_jet55_keep[i] = new TH1F(Form("hMC_eSumJtpt_jet55_keep_cent%d",i),Form("MC eSum/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1.5);
    ...
    hMC_neMaxJtpt_jet55_keep[i] = new TH1F(Form("hMC_neMaxJtpt_jet55_keep_cent%d",i),Form("MC neMax/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1.2);
    ...
    hMC_neSumJtpt_jet55_keep[i] = new TH1F(Form("hMC_neSumJtpt_jet55_keep_cent%d",i),Form("MC neSum/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1.8);
    ...
    hMC_phMaxJtpt_jet55_keep[i] = new TH1F(Form("hMC_phMaxJtpt_jet55_keep_cent%d",i),Form("MC phMax/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1.5);
    ...
    hMC_phSumJtpt_jet55_keep[i] = new TH1F(Form("hMC_phSumJtpt_jet55_keep_cent%d",i),Form("MC phSum/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,2);
    ...
    hMC_muMaxJtpt_jet55_keep[i] = new TH1F(Form("hMC_muMaxJtpt_jet55_keep_cent%d",i),Form("MC muMax/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1);
    ...
    hMC_muSumJtpt_jet55_keep[i] = new TH1F(Form("hMC_muSumJtpt_jet55_keep_cent%d",i),Form("MC muSum/Jtpt, jet55 pass cutA in centrality bin ",i),100,0,1);
    ...
    hMC_chMaxJtpt_jet55_rej[i] = new TH1F(Form("hMC_chMaxJtpt_jet55_rej_cent%d",i),Form("MC chMax/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1);
    ...
    hMC_chSumJtpt_jet55_rej[i] = new TH1F(Form("hMC_chSumJtpt_jet55_rej_cent%d",i),Form("MC chSum/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,3);
    ...
    hMC_eMaxJtpt_jet55_rej[i] = new TH1F(Form("hMC_eMaxJtpt_jet55_rej_cent%d",i),Form("MC eMax/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1.4);
    ...
    hMC_eSumJtpt_jet55_rej[i] = new TH1F(Form("hMC_eSumJtpt_jet55_rej_cent%d",i),Form("MC eSum/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1.5);
    ...
    hMC_neMaxJtpt_jet55_rej[i] = new TH1F(Form("hMC_neMaxJtpt_jet55_rej_cent%d",i),Form("MC neMax/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1.2);
    ...
    hMC_neSumJtpt_jet55_rej[i] = new TH1F(Form("hMC_neSumJtpt_jet55_rej_cent%d",i),Form("MC neSum/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1.8);
    ...
    hMC_phMaxJtpt_jet55_rej[i] = new TH1F(Form("hMC_phMaxJtpt_jet55_rej_cent%d",i),Form("MC phMax/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1.5);
    ...
    hMC_phSumJtpt_jet55_rej[i] = new TH1F(Form("hMC_phSumJtpt_jet55_rej_cent%d",i),Form("MC phSum/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,2);
    ...
    hMC_muMaxJtpt_jet55_rej[i] = new TH1F(Form("hMC_muMaxJtpt_jet55_rej_cent%d",i),Form("MC muMax/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1);
    ...
    hMC_muSumJtpt_jet55_rej[i] = new TH1F(Form("hMC_muSumJtpt_jet55_rej_cent%d",i),Form("MC muSum/Jtpt, jet55 fail cutA in centrality bin ",i),100,0,1);
...
// save those histos to a root file, remembering that I did DrawNormalized, so they are not normalized in the root file!  
  TFile fout("PbPb_JetIDPlots_NoCuts_and_YetkinCuts_matchedAndUn_slantedlinecalopfpt_eMaxSumcand_A_jet55Not65Not80.root","RECREATE");
  for(int i = 0 ; i < nbins_cent ; ++i){
...
// now plot
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet55[i]->SetXTitle("chMax/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cchMaxJtpt_jet55[i]->SaveAs(Form("chMaxJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet55[i]->SetXTitle("eMax/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    ceMaxJtpt_jet55[i]->SaveAs(Form("eMaxJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55[nbins_cent];
    ...
    hMC_phMaxJtpt_jet55[i]->SetXTitle("phMax/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cphMaxJtpt_jet55[i]->SaveAs(Form("phMaxJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet55[i]->SetXTitle("neMax/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cneMaxJtpt_jet55[i]->SaveAs(Form("neMaxJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet55[i]->SetXTitle("muMax/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cmuMaxJtpt_jet55[i]->SaveAs(Form("muMaxJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet55[i]->SetXTitle("chSum/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cchSumJtpt_jet55[i]->SaveAs(Form("chSumJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet55[i]->SetXTitle("eSum/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    ceSumJtpt_jet55[i]->SaveAs(Form("eSumJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55[nbins_cent];
    ...
    hMC_phSumJtpt_jet55[i]->SetXTitle("phSum/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cphSumJtpt_jet55[i]->SaveAs(Form("phSumJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet55[i]->SetXTitle("neSum/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cneSumJtpt_jet55[i]->SaveAs(Form("neSumJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet55[i]->SetXTitle("muSum/(ak3PuPF jet p_{T}) jet55 no cuts");
    ...
    cmuSumJtpt_jet55[i]->SaveAs(Form("muSumJtpt_jet55_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet55_keep[i]->SetXTitle("chMax/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_chMaxJtpt_jet55_keep[i]>0){
      if(nMC_chMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_chMaxJtpt_jet55_keep[i]->SetXTitle("chMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchMaxJtpt_jet55_keep[i]->SaveAs(Form("chMaxJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet55_keep[i]->SetXTitle("eMax/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_eMaxJtpt_jet55_keep[i]>0){
      if(nMC_eMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_eMaxJtpt_jet55_keep[i]->SetXTitle("eMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceMaxJtpt_jet55_keep[i]->SaveAs(Form("eMaxJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_keep[nbins_cent];
    ...
    hMC_phMaxJtpt_jet55_keep[i]->SetXTitle("phMax/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_phMaxJtpt_jet55_keep[i]>0){
      if(nMC_phMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_phMaxJtpt_jet55_keep[i]->SetXTitle("phMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphMaxJtpt_jet55_keep[i]->SaveAs(Form("phMaxJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet55_keep[i]->SetXTitle("neMax/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_neMaxJtpt_jet55_keep[i]>0){
      if(nMC_neMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_neMaxJtpt_jet55_keep[i]->SetXTitle("neMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneMaxJtpt_jet55_keep[i]->SaveAs(Form("neMaxJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet55_keep[i]->SetXTitle("muMax/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_muMaxJtpt_jet55_keep[i]>0){
      if(nMC_muMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_muMaxJtpt_jet55_keep[i]->SetXTitle("muMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuMaxJtpt_jet55_keep[i]->SaveAs(Form("muMaxJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet55_keep[i]->SetXTitle("chSum/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_chSumJtpt_jet55_keep[i]>0){
      if(nMC_chSumJtpt_jet55_keep[i]<=0){
        ...
        hData_chSumJtpt_jet55_keep[i]->SetXTitle("chSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchSumJtpt_jet55_keep[i]->SaveAs(Form("chSumJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet55_keep[i]->SetXTitle("eSum/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_eSumJtpt_jet55_keep[i]>0){
      if(nMC_eSumJtpt_jet55_keep[i]<=0){
        ...
        hData_eSumJtpt_jet55_keep[i]->SetXTitle("eSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceSumJtpt_jet55_keep[i]->SaveAs(Form("eSumJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_keep[nbins_cent];
    ...
    hMC_phSumJtpt_jet55_keep[i]->SetXTitle("phSum/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_phSumJtpt_jet55_keep[i]>0){
      if(nMC_phSumJtpt_jet55_keep[i]<=0){
        ...
        hData_phSumJtpt_jet55_keep[i]->SetXTitle("phSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphSumJtpt_jet55_keep[i]->SaveAs(Form("phSumJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet55_keep[i]->SetXTitle("neSum/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_neSumJtpt_jet55_keep[i]>0){
      if(nMC_neSumJtpt_jet55_keep[i]<=0){
        ...
        hData_neSumJtpt_jet55_keep[i]->SetXTitle("neSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneSumJtpt_jet55_keep[i]->SaveAs(Form("neSumJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet55_keep[i]->SetXTitle("muSum/(ak3PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_muSumJtpt_jet55_keep[i]>0){
      if(nMC_muSumJtpt_jet55_keep[i]<=0){
        ...
        hData_muSumJtpt_jet55_keep[i]->SetXTitle("muSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuSumJtpt_jet55_keep[i]->SaveAs(Form("muSumJtpt_jet55_keep_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet55_rej[i]->SetXTitle("chMax/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_chMaxJtpt_jet55_rej[i]>0){
      if(nMC_chMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_chMaxJtpt_jet55_rej[i]->SetXTitle("chMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchMaxJtpt_jet55_rej[i]->SaveAs(Form("chMaxJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet55_rej[i]->SetXTitle("eMax/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_eMaxJtpt_jet55_rej[i]>0){
      if(nMC_eMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_eMaxJtpt_jet55_rej[i]->SetXTitle("eMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceMaxJtpt_jet55_rej[i]->SaveAs(Form("eMaxJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_rej[nbins_cent];
    ...
    hMC_phMaxJtpt_jet55_rej[i]->SetXTitle("phMax/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_phMaxJtpt_jet55_rej[i]>0){
      if(nMC_phMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_phMaxJtpt_jet55_rej[i]->SetXTitle("phMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphMaxJtpt_jet55_rej[i]->SaveAs(Form("phMaxJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet55_rej[i]->SetXTitle("neMax/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_neMaxJtpt_jet55_rej[i]>0){
      if(nMC_neMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_neMaxJtpt_jet55_rej[i]->SetXTitle("neMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneMaxJtpt_jet55_rej[i]->SaveAs(Form("neMaxJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet55_rej[i]->SetXTitle("muMax/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_muMaxJtpt_jet55_rej[i]>0){
      if(nMC_muMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_muMaxJtpt_jet55_rej[i]->SetXTitle("muMax/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuMaxJtpt_jet55_rej[i]->SaveAs(Form("muMaxJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet55_rej[i]->SetXTitle("chSum/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_chSumJtpt_jet55_rej[i]>0){
      if(nMC_chSumJtpt_jet55_rej[i]<=0){
        ...
        hData_chSumJtpt_jet55_rej[i]->SetXTitle("chSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchSumJtpt_jet55_rej[i]->SaveAs(Form("chSumJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet55_rej[i]->SetXTitle("eSum/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_eSumJtpt_jet55_rej[i]>0){
      if(nMC_eSumJtpt_jet55_rej[i]<=0){
        ...
        hData_eSumJtpt_jet55_rej[i]->SetXTitle("eSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceSumJtpt_jet55_rej[i]->SaveAs(Form("eSumJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_rej[nbins_cent];
    ...
    hMC_phSumJtpt_jet55_rej[i]->SetXTitle("phSum/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_phSumJtpt_jet55_rej[i]>0){
      if(nMC_phSumJtpt_jet55_rej[i]<=0){
        ...
        hData_phSumJtpt_jet55_rej[i]->SetXTitle("phSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphSumJtpt_jet55_rej[i]->SaveAs(Form("phSumJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet55_rej[i]->SetXTitle("neSum/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_neSumJtpt_jet55_rej[i]>0){
      if(nMC_neSumJtpt_jet55_rej[i]<=0){
        ...
        hData_neSumJtpt_jet55_rej[i]->SetXTitle("neSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneSumJtpt_jet55_rej[i]->SaveAs(Form("neSumJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet55_rej[i]->SetXTitle("muSum/(ak3PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_muSumJtpt_jet55_rej[i]>0){
      if(nMC_muSumJtpt_jet55_rej[i]<=0){
        ...
        hData_muSumJtpt_jet55_rej[i]->SetXTitle("muSum/(ak3PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuSumJtpt_jet55_rej[i]->SaveAs(Form("muSumJtpt_jet55_rej_cent%deMax_MCweight.pdf",i),"RECREATE");
