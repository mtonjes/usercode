...
// Run with: 
// .L RAA_plot_jeidvariables_cutPass_jet55.C
// RAA_plot_jeidvariables_cutPass_jet55()

void RAA_plot_jetidvariables_cutPass_jet55(){
  ...
  for(long nentry = 0; nentry < entries; ++nentry){
    ...
    if(pfpt_1>pfptmin){
         if(jet55_1 == 1 && jet65_1==0 && jet80_1 == 0) {
             hData_chMaxJtpt_jet55[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet55[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet55[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet55[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet55[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet55[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet55[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet55[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet55[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet55[centb1]->Fill(muSum_1/pfpt_1);
         }
   if((calopt_1/pfpt_1) <= 0.5 && eMax_1/Sumcand < 0.05 ) {
         if(jet55_1 == 1 && jet65_1==0 && jet80_1 == 0) {
             hData_chMaxJtpt_jet55_keep[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet55_keep[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet55_keep[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet55_keep[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet55_keep[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet55_keep[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet55_keep[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet55_keep[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet55_keep[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet55_keep[centb1]->Fill(muSum_1/pfpt_1);         
         }
   }
...
// rejected:
  if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && (eMax_1/Sumcand >= (18/7 *(Float_t)calopt_1/pfpt_1 - 9/7))){
         if(jet55_1 == 1 && jet65_1==0 && jet80_1 == 0) {
             hData_chMaxJtpt_jet55_rej[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet55_rej[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet55_rej[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet55_rej[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet55_rej[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet55_rej[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet55_rej[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet55_rej[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet55_rej[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet55_rej[centb1]->Fill(muSum_1/pfpt_1);         
         }
   }
   if(calopt_1/pfpt_1 <= 0.5 && eMax_1/Sumcand >= 0.05) {
         if(jet55_1 == 1 && jet65_1==0 && jet80_1 == 0) {
...
//    cout<<"my hiBin_2 is: "<<hiBin_2<<" and I got out the bin: "<<centb2<<endl;
    ...
    if(pfpt_2>pfptmin){
         if(jet55_2 == 1 && jet65_2==0 && jet80_2 == 0){
             hMC_chMaxJtpt_jet55[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet55[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet55[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet55[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet55[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet55[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet55[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet55[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet55[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet55[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   if(calopt_2/pfpt_2 <= 0.5 && eMax_2/Sumcand < 0.05) {
         if(jet55_2 == 1 && jet65_2==0 && jet80_2 == 0){
             hMC_chMaxJtpt_jet55_keep[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet55_keep[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet55_keep[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet55_keep[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet55_keep[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet55_keep[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet55_keep[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet55_keep[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet55_keep[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet55_keep[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   }
...
// rejected:
  if(calopt_2/pfpt_2 > 0.5 && calopt_2/pfpt_2 <= 0.85 && eMax_2/Sumcand >= (18/7 *(Float_t)calopt_2/pfpt_2 - 9/7)){
         if(jet55_2 == 1 && jet65_2==0 && jet80_2 == 0){
             hMC_chMaxJtpt_jet55_rej[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet55_rej[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet55_rej[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet55_rej[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet55_rej[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet55_rej[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet55_rej[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet55_rej[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet55_rej[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet55_rej[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   }
   if(calopt_2/pfpt_2 <= 0.5 && eMax_2/Sumcand >= 0.05) {
         if(jet55_2 == 1 && jet65_2==0 && jet80_2 == 0){
...
// save those histos to a root file, remembering that I did DrawNormalized, so they are not normalized in the root file!  
  TFile fout("PbPb_JetIDPlots_NoCuts_and_YetkinCuts_matchedAndUn_slantedlinecalopfpt_eMaxSumcand_A_jet55Not65Not80_R4.root","RECREATE");
  for(int i = 0 ; i < nbins_cent ; ++i){

    hData_chMaxJtpt_jet55[i]->Write();
    hMC_chMaxJtpt_jet55[i]->Write();
    hData_chSumJtpt_jet55[i]->Write();
    hMC_chSumJtpt_jet55[i]->Write();
    hData_eMaxJtpt_jet55[i]->Write();
    hMC_eMaxJtpt_jet55[i]->Write();
    hData_eSumJtpt_jet55[i]->Write();
    hMC_eSumJtpt_jet55[i]->Write();
    hData_neMaxJtpt_jet55[i]->Write();
    hMC_neMaxJtpt_jet55[i]->Write();
    hData_neSumJtpt_jet55[i]->Write();
    hMC_neSumJtpt_jet55[i]->Write();
    hData_phMaxJtpt_jet55[i]->Write();
    hMC_phMaxJtpt_jet55[i]->Write();
    hData_phSumJtpt_jet55[i]->Write();
    hMC_phSumJtpt_jet55[i]->Write();
    hData_muMaxJtpt_jet55[i]->Write();
    hMC_muMaxJtpt_jet55[i]->Write();
    hData_muSumJtpt_jet55[i]->Write();
    hMC_muSumJtpt_jet55[i]->Write();
...
// now plot
  TCanvas * cchMaxJtpt_jet55[nbins_cent];
  
  for(int i = 0 ; i < nbins_cent ; ++i){

    cchMaxJtpt_jet55[i] = new TCanvas(Form("cchMaxJtpt_jet55_cent%d",i),"",800,600);
    cchMaxJtpt_jet55[i]->SetLogy();
    hMC_chMaxJtpt_jet55[i]->SetMarkerColor(kRed);
    hMC_chMaxJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_chMaxJtpt_jet55[i]->Print("base");
    hMC_chMaxJtpt_jet55[i]->SetTitle(" ");
    hMC_chMaxJtpt_jet55[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_chMaxJtpt_jet55[i]->DrawNormalized();

    hData_chMaxJtpt_jet55[i]->SetMarkerStyle(24);
    hData_chMaxJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_chMaxJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_chMaxJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_chMaxJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cchMaxJtpt_jet55[i]->SaveAs(Form("chMaxJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  
  TCanvas * ceMaxJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    ceMaxJtpt_jet55[i] = new TCanvas(Form("ceMaxJtpt_jet55_cent%d",i),"",800,600);
    ceMaxJtpt_jet55[i]->SetLogy();
    hMC_eMaxJtpt_jet55[i]->SetMarkerColor(kBlue);
    hMC_eMaxJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_eMaxJtpt_jet55[i]->Print("base");
    hMC_eMaxJtpt_jet55[i]->SetTitle(" ");
    hMC_eMaxJtpt_jet55[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_eMaxJtpt_jet55[i]->DrawNormalized();

    hData_eMaxJtpt_jet55[i]->SetMarkerStyle(24);
    hData_eMaxJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_eMaxJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_eMaxJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_eMaxJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    ceMaxJtpt_jet55[i]->SaveAs(Form("eMaxJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }

   TCanvas * cphMaxJtpt_jet55[nbins_cent];
  
    for(int i = 0 ; i < nbins_cent ; ++i){

    cphMaxJtpt_jet55[i] = new TCanvas(Form("cphMaxJtpt_jet55_cent%d",i),"",800,600);
    cphMaxJtpt_jet55[i]->SetLogy();
    hMC_phMaxJtpt_jet55[i]->SetMarkerColor(kGreen+2);
    hMC_phMaxJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_phMaxJtpt_jet55[i]->Print("base");
    hMC_phMaxJtpt_jet55[i]->SetTitle(" ");
    hMC_phMaxJtpt_jet55[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_phMaxJtpt_jet55[i]->DrawNormalized();

    hData_phMaxJtpt_jet55[i]->SetMarkerStyle(24);
    hData_phMaxJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_phMaxJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_phMaxJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_phMaxJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cphMaxJtpt_jet55[i]->SaveAs(Form("phMaxJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cneMaxJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cneMaxJtpt_jet55[i] = new TCanvas(Form("cneMaxJtpt_jet55_cent%d",i),"",800,600);
    cneMaxJtpt_jet55[i]->SetLogy();
    hMC_neMaxJtpt_jet55[i]->SetMarkerColor(kMagenta);
    hMC_neMaxJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_neMaxJtpt_jet55[i]->Print("base");
    hMC_neMaxJtpt_jet55[i]->SetTitle(" ");
    hMC_neMaxJtpt_jet55[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_neMaxJtpt_jet55[i]->DrawNormalized();

    hData_neMaxJtpt_jet55[i]->SetMarkerStyle(24);
    hData_neMaxJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_neMaxJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_neMaxJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_neMaxJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cneMaxJtpt_jet55[i]->SaveAs(Form("neMaxJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
    TCanvas * cmuMaxJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cmuMaxJtpt_jet55[i] = new TCanvas(Form("cmuMaxJtpt_jet55_cent%d",i),"",800,600);
    cmuMaxJtpt_jet55[i]->SetLogy();
    hMC_muMaxJtpt_jet55[i]->SetMarkerColor(kCyan);
    hMC_muMaxJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_muMaxJtpt_jet55[i]->Print("base");
    hMC_muMaxJtpt_jet55[i]->SetTitle(" ");
    hMC_muMaxJtpt_jet55[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_muMaxJtpt_jet55[i]->DrawNormalized();

    hData_muMaxJtpt_jet55[i]->SetMarkerStyle(24);
    hData_muMaxJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_muMaxJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_muMaxJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_muMaxJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cmuMaxJtpt_jet55[i]->SaveAs(Form("muMaxJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }    
// draw some Sum variables
  TCanvas * cchSumJtpt_jet55[nbins_cent];
  
  for(int i = 0 ; i < nbins_cent ; ++i){

    cchSumJtpt_jet55[i] = new TCanvas(Form("cchSumJtpt_jet55_cent%d",i),"",800,600);
    cchSumJtpt_jet55[i]->SetLogy();
    hMC_chSumJtpt_jet55[i]->SetMarkerColor(kRed+1);
    hMC_chSumJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_chSumJtpt_jet55[i]->Print("base");
    hMC_chSumJtpt_jet55[i]->SetTitle(" ");
    hMC_chSumJtpt_jet55[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_chSumJtpt_jet55[i]->DrawNormalized();

    hData_chSumJtpt_jet55[i]->SetMarkerStyle(24);
    hData_chSumJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_chSumJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_chSumJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_chSumJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cchSumJtpt_jet55[i]->SaveAs(Form("chSumJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * ceSumJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    ceSumJtpt_jet55[i] = new TCanvas(Form("ceSumJtpt_jet55_cent%d",i),"",800,600);
    ceSumJtpt_jet55[i]->SetLogy();
    hMC_eSumJtpt_jet55[i]->SetMarkerColor(kBlue+1);
    hMC_eSumJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_eSumJtpt_jet55[i]->Print("base");
    hMC_eSumJtpt_jet55[i]->SetTitle(" ");
    hMC_eSumJtpt_jet55[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_eSumJtpt_jet55[i]->DrawNormalized();

    hData_eSumJtpt_jet55[i]->SetMarkerStyle(24);
    hData_eSumJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_eSumJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_eSumJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_eSumJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    ceSumJtpt_jet55[i]->SaveAs(Form("eSumJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cphSumJtpt_jet55[nbins_cent];
  
    for(int i = 0 ; i < nbins_cent ; ++i){

    cphSumJtpt_jet55[i] = new TCanvas(Form("cphSumJtpt_jet55_cent%d",i),"",800,600);
    cphSumJtpt_jet55[i]->SetLogy();
    hMC_phSumJtpt_jet55[i]->SetMarkerColor(kGreen-3);
    hMC_phSumJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_phSumJtpt_jet55[i]->Print("base");
    hMC_phSumJtpt_jet55[i]->SetTitle(" ");
    hMC_phSumJtpt_jet55[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_phSumJtpt_jet55[i]->DrawNormalized();

    hData_phSumJtpt_jet55[i]->SetMarkerStyle(24);
    hData_phSumJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_phSumJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_phSumJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_phSumJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cphSumJtpt_jet55[i]->SaveAs(Form("phSumJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cneSumJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cneSumJtpt_jet55[i] = new TCanvas(Form("cneSumJtpt_jet55_cent%d",i),"",800,600);
    cneSumJtpt_jet55[i]->SetLogy();
    hMC_neSumJtpt_jet55[i]->SetMarkerColor(kMagenta+1);
    hMC_neSumJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_neSumJtpt_jet55[i]->Print("base");
    hMC_neSumJtpt_jet55[i]->SetTitle(" ");
    hMC_neSumJtpt_jet55[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_neSumJtpt_jet55[i]->DrawNormalized();

    hData_neSumJtpt_jet55[i]->SetMarkerStyle(24);
    hData_neSumJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_neSumJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_neSumJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_neSumJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cneSumJtpt_jet55[i]->SaveAs(Form("neSumJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
    TCanvas * cmuSumJtpt_jet55[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cmuSumJtpt_jet55[i] = new TCanvas(Form("cmuSumJtpt_jet55_cent%d",i),"",800,600);
    cmuSumJtpt_jet55[i]->SetLogy();
    hMC_muSumJtpt_jet55[i]->SetMarkerColor(kCyan+1);
    hMC_muSumJtpt_jet55[i]->SetMarkerStyle(25);
    hMC_muSumJtpt_jet55[i]->Print("base");
    hMC_muSumJtpt_jet55[i]->SetTitle(" ");
    hMC_muSumJtpt_jet55[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet55 no cuts");
    hMC_muSumJtpt_jet55[i]->DrawNormalized();

    hData_muSumJtpt_jet55[i]->SetMarkerStyle(24);
    hData_muSumJtpt_jet55[i]->SetMarkerColor(kBlack);
    hData_muSumJtpt_jet55[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_muSumJtpt_jet55[0],"MC","pl");
    leg->AddEntry(hData_muSumJtpt_jet55[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cmuSumJtpt_jet55[i]->SaveAs(Form("muSumJtpt_jet55_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet55_keep[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_chMaxJtpt_jet55_keep[i]>0){
      if(nMC_chMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_chMaxJtpt_jet55_keep[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchMaxJtpt_jet55_keep[i]->SaveAs(Form("chMaxJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet55_keep[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_eMaxJtpt_jet55_keep[i]>0){
      if(nMC_eMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_eMaxJtpt_jet55_keep[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceMaxJtpt_jet55_keep[i]->SaveAs(Form("eMaxJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_keep[nbins_cent];
    ...
    hMC_phMaxJtpt_jet55_keep[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_phMaxJtpt_jet55_keep[i]>0){
      if(nMC_phMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_phMaxJtpt_jet55_keep[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphMaxJtpt_jet55_keep[i]->SaveAs(Form("phMaxJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet55_keep[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_neMaxJtpt_jet55_keep[i]>0){
      if(nMC_neMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_neMaxJtpt_jet55_keep[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneMaxJtpt_jet55_keep[i]->SaveAs(Form("neMaxJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet55_keep[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_muMaxJtpt_jet55_keep[i]>0){
      if(nMC_muMaxJtpt_jet55_keep[i]<=0){
        ...
        hData_muMaxJtpt_jet55_keep[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuMaxJtpt_jet55_keep[i]->SaveAs(Form("muMaxJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet55_keep[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_chSumJtpt_jet55_keep[i]>0){
      if(nMC_chSumJtpt_jet55_keep[i]<=0){
        ...
        hData_chSumJtpt_jet55_keep[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchSumJtpt_jet55_keep[i]->SaveAs(Form("chSumJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet55_keep[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_eSumJtpt_jet55_keep[i]>0){
      if(nMC_eSumJtpt_jet55_keep[i]<=0){
        ...
        hData_eSumJtpt_jet55_keep[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceSumJtpt_jet55_keep[i]->SaveAs(Form("eSumJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_keep[nbins_cent];
    ...
    hMC_phSumJtpt_jet55_keep[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_phSumJtpt_jet55_keep[i]>0){
      if(nMC_phSumJtpt_jet55_keep[i]<=0){
        ...
        hData_phSumJtpt_jet55_keep[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphSumJtpt_jet55_keep[i]->SaveAs(Form("phSumJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet55_keep[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_neSumJtpt_jet55_keep[i]>0){
      if(nMC_neSumJtpt_jet55_keep[i]<=0){
        ...
        hData_neSumJtpt_jet55_keep[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneSumJtpt_jet55_keep[i]->SaveAs(Form("neSumJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet55_keep[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet55, pass CutA");
    ...
    if (nData_muSumJtpt_jet55_keep[i]>0){
      if(nMC_muSumJtpt_jet55_keep[i]<=0){
        ...
        hData_muSumJtpt_jet55_keep[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuSumJtpt_jet55_keep[i]->SaveAs(Form("muSumJtpt_jet55_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet55_rej[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_chMaxJtpt_jet55_rej[i]>0){
      if(nMC_chMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_chMaxJtpt_jet55_rej[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchMaxJtpt_jet55_rej[i]->SaveAs(Form("chMaxJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet55_rej[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_eMaxJtpt_jet55_rej[i]>0){
      if(nMC_eMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_eMaxJtpt_jet55_rej[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceMaxJtpt_jet55_rej[i]->SaveAs(Form("eMaxJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_rej[nbins_cent];
    ...
    hMC_phMaxJtpt_jet55_rej[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_phMaxJtpt_jet55_rej[i]>0){
      if(nMC_phMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_phMaxJtpt_jet55_rej[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphMaxJtpt_jet55_rej[i]->SaveAs(Form("phMaxJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet55_rej[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_neMaxJtpt_jet55_rej[i]>0){
      if(nMC_neMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_neMaxJtpt_jet55_rej[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneMaxJtpt_jet55_rej[i]->SaveAs(Form("neMaxJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet55_rej[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_muMaxJtpt_jet55_rej[i]>0){
      if(nMC_muMaxJtpt_jet55_rej[i]<=0){
        ...
        hData_muMaxJtpt_jet55_rej[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuMaxJtpt_jet55_rej[i]->SaveAs(Form("muMaxJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet55_rej[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_chSumJtpt_jet55_rej[i]>0){
      if(nMC_chSumJtpt_jet55_rej[i]<=0){
        ...
        hData_chSumJtpt_jet55_rej[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cchSumJtpt_jet55_rej[i]->SaveAs(Form("chSumJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet55_rej[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_eSumJtpt_jet55_rej[i]>0){
      if(nMC_eSumJtpt_jet55_rej[i]<=0){
        ...
        hData_eSumJtpt_jet55_rej[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    ceSumJtpt_jet55_rej[i]->SaveAs(Form("eSumJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_rej[nbins_cent];
    ...
    hMC_phSumJtpt_jet55_rej[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_phSumJtpt_jet55_rej[i]>0){
      if(nMC_phSumJtpt_jet55_rej[i]<=0){
        ...
        hData_phSumJtpt_jet55_rej[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cphSumJtpt_jet55_rej[i]->SaveAs(Form("phSumJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet55_rej[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_neSumJtpt_jet55_rej[i]>0){
      if(nMC_neSumJtpt_jet55_rej[i]<=0){
        ...
        hData_neSumJtpt_jet55_rej[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cneSumJtpt_jet55_rej[i]->SaveAs(Form("neSumJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet55_rej[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet55, fail CutA");
    ...
    if (nData_muSumJtpt_jet55_rej[i]>0){
      if(nMC_muSumJtpt_jet55_rej[i]<=0){
        ...
        hData_muSumJtpt_jet55_rej[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet55, pass CutA");      
    ...
    cmuSumJtpt_jet55_rej[i]->SaveAs(Form("muSumJtpt_jet55_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
