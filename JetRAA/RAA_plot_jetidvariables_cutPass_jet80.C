...
// Run with: 
// .L RAA_plot_jeidvariables_cutPass_jet80.C
// RAA_plot_jeidvariables_cutPass_jet80()

void RAA_plot_jetidvariables_cutPass_jet80(){
...
// jet80
  TH1F * hData_chMaxJtpt_jet80[nbins_cent], * hData_phMaxJtpt_jet80[nbins_cent], * hData_neMaxJtpt_jet80[nbins_cent], * hData_muMaxJtpt_jet80[nbins_cent], * hData_eMaxJtpt_jet80[nbins_cent];
  TH1F * hData_chSumJtpt_jet80[nbins_cent], * hData_phSumJtpt_jet80[nbins_cent], * hData_neSumJtpt_jet80[nbins_cent], * hData_muSumJtpt_jet80[nbins_cent], * hData_eSumJtpt_jet80[nbins_cent];  
  
  TH1F * hMC_chMaxJtpt_jet80[nbins_cent], * hMC_phMaxJtpt_jet80[nbins_cent], * hMC_neMaxJtpt_jet80[nbins_cent], * hMC_muMaxJtpt_jet80[nbins_cent], * hMC_eMaxJtpt_jet80[nbins_cent];
  TH1F * hMC_chSumJtpt_jet80[nbins_cent], * hMC_phSumJtpt_jet80[nbins_cent], * hMC_neSumJtpt_jet80[nbins_cent], * hMC_muSumJtpt_jet80[nbins_cent], * hMC_eSumJtpt_jet80[nbins_cent];  
  ...
  Int_t * nData_chMaxJtpt_jet80_keep[nbins_cent], * nData_phMaxJtpt_jet80_keep[nbins_cent], * nData_neMaxJtpt_jet80_keep[nbins_cent], * nData_muMaxJtpt_jet80_keep[nbins_cent], * nData_eMaxJtpt_jet80_keep[nbins_cent];
  Int_t * nData_chSumJtpt_jet80_keep[nbins_cent], * nData_phSumJtpt_jet80_keep[nbins_cent], * nData_neSumJtpt_jet80_keep[nbins_cent], * nData_muSumJtpt_jet80_keep[nbins_cent], * nData_eSumJtpt_jet80_keep[nbins_cent];  
  
  Int_t * nMC_chMaxJtpt_jet80_keep[nbins_cent], * nMC_phMaxJtpt_jet80_keep[nbins_cent], * nMC_neMaxJtpt_jet80_keep[nbins_cent], * nMC_muMaxJtpt_jet80_keep[nbins_cent], * nMC_eMaxJtpt_jet80_keep[nbins_cent];
  Int_t * nMC_chSumJtpt_jet80_keep[nbins_cent], * nMC_phSumJtpt_jet80_keep[nbins_cent], * nMC_neSumJtpt_jet80_keep[nbins_cent], * nMC_muSumJtpt_jet80_keep[nbins_cent], * nMC_eSumJtpt_jet80_keep[nbins_cent];  

  Int_t * nData_chMaxJtpt_jet80_rej[nbins_cent], * nData_phMaxJtpt_jet80_rej[nbins_cent], * nData_neMaxJtpt_jet80_rej[nbins_cent], * nData_muMaxJtpt_jet80_rej[nbins_cent], * nData_eMaxJtpt_jet80_rej[nbins_cent];
  Int_t * nData_chSumJtpt_jet80_rej[nbins_cent], * nData_phSumJtpt_jet80_rej[nbins_cent], * nData_neSumJtpt_jet80_rej[nbins_cent], * nData_muSumJtpt_jet80_rej[nbins_cent], * nData_eSumJtpt_jet80_rej[nbins_cent];  
  
  Int_t * nMC_chMaxJtpt_jet80_rej[nbins_cent], * nMC_phMaxJtpt_jet80_rej[nbins_cent], * nMC_neMaxJtpt_jet80_rej[nbins_cent], * nMC_muMaxJtpt_jet80_rej[nbins_cent], * nMC_eMaxJtpt_jet80_rej[nbins_cent];
  Int_t * nMC_chSumJtpt_jet80_rej[nbins_cent], * nMC_phSumJtpt_jet80_rej[nbins_cent], * nMC_neSumJtpt_jet80_rej[nbins_cent], * nMC_muSumJtpt_jet80_rej[nbins_cent], * nMC_eSumJtpt_jet80_rej[nbins_cent];  

  for(int i = 0 ; i < nbins_cent ; ++i){


// jet80
    hData_chMaxJtpt_jet80[i] = new TH1F(Form("hData_chMaxJtpt_jet80_cent%d",i),Form("Data chMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
    hMC_chMaxJtpt_jet80[i] = new TH1F(Form("hMC_chMaxJtpt_jet80_cent%d",i),Form("MC chMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
    hData_chSumJtpt_jet80[i] = new TH1F(Form("hData_chSumJtpt_jet80_cent%d",i),Form("Data chSum/Jtpt, Jet80 in centrality bin %d",i),100,0,3);
    hMC_chSumJtpt_jet80[i] = new TH1F(Form("hMC_chSumJtpt_jet80_cent%d",i),Form("MC chSum/Jtpt, Jet80 in centrality bin %d",i),100,0,3);

    hData_eMaxJtpt_jet80[i] = new TH1F(Form("hData_eMaxJtpt_jet80_cent%d",i),Form("Data eMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.4);
    hMC_eMaxJtpt_jet80[i] = new TH1F(Form("hMC_eMaxJtpt_jet80_cent%d",i),Form("MC eMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.4);
    hData_eSumJtpt_jet80[i] = new TH1F(Form("hData_eSumJtpt_jet80_cent%d",i),Form("Data eSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1.5);
    hMC_eSumJtpt_jet80[i] = new TH1F(Form("hMC_eSumJtpt_jet80_cent%d",i),Form("MC eSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1.5);

    hData_neMaxJtpt_jet80[i] = new TH1F(Form("hData_neMaxJtpt_jet80_cent%d",i),Form("Data neMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.2);
    hMC_neMaxJtpt_jet80[i] = new TH1F(Form("hMC_neMaxJtpt_jet80_cent%d",i),Form("MC neMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.2);
    hData_neSumJtpt_jet80[i] = new TH1F(Form("hData_neSumJtpt_jet80_cent%d",i),Form("Data neSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1.8);
    hMC_neSumJtpt_jet80[i] = new TH1F(Form("hMC_neSumJtpt_jet80_cent%d",i),Form("MC neSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1.8);

    hData_phMaxJtpt_jet80[i] = new TH1F(Form("hData_phMaxJtpt_jet80_cent%d",i),Form("Data phMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.5);
    hMC_phMaxJtpt_jet80[i] = new TH1F(Form("hMC_phMaxJtpt_jet80_cent%d",i),Form("MC phMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1.5);
    hData_phSumJtpt_jet80[i] = new TH1F(Form("hData_phSumJtpt_jet80_cent%d",i),Form("Data phSum/Jtpt, Jet80 in centrality bin %d",i),100,0,2);
    hMC_phSumJtpt_jet80[i] = new TH1F(Form("hMC_phSumJtpt_jet80_cent%d",i),Form("MC phSum/Jtpt, Jet80 in centrality bin %d",i),100,0,2);

    hData_muMaxJtpt_jet80[i] = new TH1F(Form("hData_muMaxJtpt_jet80_cent%d",i),Form("Data muMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
    hMC_muMaxJtpt_jet80[i] = new TH1F(Form("hMC_muMaxJtpt_jet80_cent%d",i),Form("MC muMax/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
    hData_muSumJtpt_jet80[i] = new TH1F(Form("hData_muSumJtpt_jet80_cent%d",i),Form("Data muSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
    hMC_muSumJtpt_jet80[i] = new TH1F(Form("hMC_muSumJtpt_jet80_cent%d",i),Form("MC muSum/Jtpt, Jet80 in centrality bin %d",i),100,0,1);
  ...
  for(long nentry = 0; nentry < entries; ++nentry){
    ...
    if(pfpt_1>pfptmin){
         if(jet80_1 == 1) {
             hData_chMaxJtpt_jet80[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet80[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet80[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet80[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet80[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet80[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet80[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet80[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet80[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet80[centb1]->Fill(muSum_1/pfpt_1);
         }
   if((calopt_1/pfpt_1) <= 0.5 && eMax_1/Sumcand < 0.05 ) {
         if(jet80_1 == 1) {
             hData_chMaxJtpt_jet80_keep[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet80_keep[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet80_keep[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet80_keep[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet80_keep[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet80_keep[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet80_keep[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet80_keep[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet80_keep[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet80_keep[centb1]->Fill(muSum_1/pfpt_1);         
         }
   }
...
// rejected:
  if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && (eMax_1/Sumcand >= (18/7 *(Float_t)calopt_1/pfpt_1 - 9/7))){
         if(jet80_1 == 1) {
             hData_chMaxJtpt_jet80_rej[centb1]->Fill(chMax_1/pfpt_1);
             hData_eMaxJtpt_jet80_rej[centb1]->Fill(eMax_1/pfpt_1);
             hData_neMaxJtpt_jet80_rej[centb1]->Fill(neMax_1/pfpt_1);
             hData_phMaxJtpt_jet80_rej[centb1]->Fill(phMax_1/pfpt_1);
             hData_muMaxJtpt_jet80_rej[centb1]->Fill(muMax_1/pfpt_1);
             hData_chSumJtpt_jet80_rej[centb1]->Fill(chSum_1/pfpt_1);
             hData_eSumJtpt_jet80_rej[centb1]->Fill(eSum_1/pfpt_1);
             hData_neSumJtpt_jet80_rej[centb1]->Fill(neSum_1/pfpt_1);
             hData_phSumJtpt_jet80_rej[centb1]->Fill(phSum_1/pfpt_1);
             hData_muSumJtpt_jet80_rej[centb1]->Fill(muSum_1/pfpt_1);         
         }
   }
   if(calopt_1/pfpt_1 <= 0.5 && eMax_1/Sumcand >= 0.05) {
         if(jet80_1 == 1) {
...
//    cout<<"my hiBin_2 is: "<<hiBin_2<<" and I got out the bin: "<<centb2<<endl;
    ...
    if(pfpt_2>pfptmin){
         if(jet80_2 == 1){
             hMC_chMaxJtpt_jet80[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet80[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet80[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet80[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet80[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet80[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet80[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet80[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet80[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet80[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   if(calopt_2/pfpt_2 <= 0.5 && eMax_2/Sumcand < 0.05) {
         if(jet80_2 == 1){
             hMC_chMaxJtpt_jet80_keep[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet80_keep[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet80_keep[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet80_keep[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet80_keep[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet80_keep[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet80_keep[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet80_keep[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet80_keep[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet80_keep[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   }
...
// rejected:
  if(calopt_2/pfpt_2 > 0.5 && calopt_2/pfpt_2 <= 0.85 && eMax_2/Sumcand >= (18/7 *(Float_t)calopt_2/pfpt_2 - 9/7)){
         if(jet80_2 == 1){
             hMC_chMaxJtpt_jet80_rej[centb2]->Fill(chMax_2/pfpt_2,weight_2);
             hMC_eMaxJtpt_jet80_rej[centb2]->Fill(eMax_2/pfpt_2,weight_2);
             hMC_neMaxJtpt_jet80_rej[centb2]->Fill(neMax_2/pfpt_2,weight_2);
             hMC_phMaxJtpt_jet80_rej[centb2]->Fill(phMax_2/pfpt_2,weight_2);
             hMC_muMaxJtpt_jet80_rej[centb2]->Fill(muMax_2/pfpt_2,weight_2);
             hMC_chSumJtpt_jet80_rej[centb2]->Fill(chSum_2/pfpt_2,weight_2);
             hMC_eSumJtpt_jet80_rej[centb2]->Fill(eSum_2/pfpt_2,weight_2);
             hMC_neSumJtpt_jet80_rej[centb2]->Fill(neSum_2/pfpt_2,weight_2);
             hMC_phSumJtpt_jet80_rej[centb2]->Fill(phSum_2/pfpt_2,weight_2);
             hMC_muSumJtpt_jet80_rej[centb2]->Fill(muSum_2/pfpt_2,weight_2);         
         }         
   }
   if(calopt_2/pfpt_2 <= 0.5 && eMax_2/Sumcand >= 0.05) {
         if(jet80_2 == 1){
...
// save those histos to a root file, remembering that I did DrawNormalized, so they are not normalized in the root file!  
  TFile fout("PbPb_JetIDPlots_NoCuts_and_YetkinCuts_matchedAndUn_slantedlinecalopfpt_eMaxSumcand_A_R4_jet80.root","RECREATE");
  for(int i = 0 ; i < nbins_cent ; ++i){

    hData_chMaxJtpt_jet80[i]->Write();
    hMC_chMaxJtpt_jet80[i]->Write();
    hData_chSumJtpt_jet80[i]->Write();
    hMC_chSumJtpt_jet80[i]->Write();
    hData_eMaxJtpt_jet80[i]->Write();
    hMC_eMaxJtpt_jet80[i]->Write();
    hData_eSumJtpt_jet80[i]->Write();
    hMC_eSumJtpt_jet80[i]->Write();
    hData_neMaxJtpt_jet80[i]->Write();
    hMC_neMaxJtpt_jet80[i]->Write();
    hData_neSumJtpt_jet80[i]->Write();
    hMC_neSumJtpt_jet80[i]->Write();
    hData_phMaxJtpt_jet80[i]->Write();
    hMC_phMaxJtpt_jet80[i]->Write();
    hData_phSumJtpt_jet80[i]->Write();
    hMC_phSumJtpt_jet80[i]->Write();
    hData_muMaxJtpt_jet80[i]->Write();
    hMC_muMaxJtpt_jet80[i]->Write();
    hData_muSumJtpt_jet80[i]->Write();
    hMC_muSumJtpt_jet80[i]->Write();
...
// now plot
  TCanvas * cchMaxJtpt_jet80[nbins_cent];
  
  for(int i = 0 ; i < nbins_cent ; ++i){

    cchMaxJtpt_jet80[i] = new TCanvas(Form("cchMaxJtpt_jet80_cent%d",i),"",800,600);
    cchMaxJtpt_jet80[i]->SetLogy();
    hMC_chMaxJtpt_jet80[i]->SetMarkerColor(kRed);
    hMC_chMaxJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_chMaxJtpt_jet80[i]->Print("base");
    hMC_chMaxJtpt_jet80[i]->SetTitle(" ");
    hMC_chMaxJtpt_jet80[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_chMaxJtpt_jet80[i]->DrawNormalized();

    hData_chMaxJtpt_jet80[i]->SetMarkerStyle(24);
    hData_chMaxJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_chMaxJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_chMaxJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_chMaxJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cchMaxJtpt_jet80[i]->SaveAs(Form("chMaxJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  
  TCanvas * ceMaxJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    ceMaxJtpt_jet80[i] = new TCanvas(Form("ceMaxJtpt_jet80_cent%d",i),"",800,600);
    ceMaxJtpt_jet80[i]->SetLogy();
    hMC_eMaxJtpt_jet80[i]->SetMarkerColor(kBlue);
    hMC_eMaxJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_eMaxJtpt_jet80[i]->Print("base");
    hMC_eMaxJtpt_jet80[i]->SetTitle(" ");
    hMC_eMaxJtpt_jet80[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_eMaxJtpt_jet80[i]->DrawNormalized();

    hData_eMaxJtpt_jet80[i]->SetMarkerStyle(24);
    hData_eMaxJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_eMaxJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_eMaxJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_eMaxJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    ceMaxJtpt_jet80[i]->SaveAs(Form("eMaxJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }

   TCanvas * cphMaxJtpt_jet80[nbins_cent];
  
    for(int i = 0 ; i < nbins_cent ; ++i){

    cphMaxJtpt_jet80[i] = new TCanvas(Form("cphMaxJtpt_jet80_cent%d",i),"",800,600);
    cphMaxJtpt_jet80[i]->SetLogy();
    hMC_phMaxJtpt_jet80[i]->SetMarkerColor(kGreen+2);
    hMC_phMaxJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_phMaxJtpt_jet80[i]->Print("base");
    hMC_phMaxJtpt_jet80[i]->SetTitle(" ");
    hMC_phMaxJtpt_jet80[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_phMaxJtpt_jet80[i]->DrawNormalized();

    hData_phMaxJtpt_jet80[i]->SetMarkerStyle(24);
    hData_phMaxJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_phMaxJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_phMaxJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_phMaxJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cphMaxJtpt_jet80[i]->SaveAs(Form("phMaxJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cneMaxJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cneMaxJtpt_jet80[i] = new TCanvas(Form("cneMaxJtpt_jet80_cent%d",i),"",800,600);
    cneMaxJtpt_jet80[i]->SetLogy();
    hMC_neMaxJtpt_jet80[i]->SetMarkerColor(kMagenta);
    hMC_neMaxJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_neMaxJtpt_jet80[i]->Print("base");
    hMC_neMaxJtpt_jet80[i]->SetTitle(" ");
    hMC_neMaxJtpt_jet80[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_neMaxJtpt_jet80[i]->DrawNormalized();

    hData_neMaxJtpt_jet80[i]->SetMarkerStyle(24);
    hData_neMaxJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_neMaxJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_neMaxJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_neMaxJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cneMaxJtpt_jet80[i]->SaveAs(Form("neMaxJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
    TCanvas * cmuMaxJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cmuMaxJtpt_jet80[i] = new TCanvas(Form("cmuMaxJtpt_jet80_cent%d",i),"",800,600);
    cmuMaxJtpt_jet80[i]->SetLogy();
    hMC_muMaxJtpt_jet80[i]->SetMarkerColor(kCyan);
    hMC_muMaxJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_muMaxJtpt_jet80[i]->Print("base");
    hMC_muMaxJtpt_jet80[i]->SetTitle(" ");
    hMC_muMaxJtpt_jet80[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_muMaxJtpt_jet80[i]->DrawNormalized();

    hData_muMaxJtpt_jet80[i]->SetMarkerStyle(24);
    hData_muMaxJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_muMaxJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_muMaxJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_muMaxJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cmuMaxJtpt_jet80[i]->SaveAs(Form("muMaxJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }    
// draw some Sum variables
  TCanvas * cchSumJtpt_jet80[nbins_cent];
  
  for(int i = 0 ; i < nbins_cent ; ++i){

    cchSumJtpt_jet80[i] = new TCanvas(Form("cchSumJtpt_jet80_cent%d",i),"",800,600);
    cchSumJtpt_jet80[i]->SetLogy();
    hMC_chSumJtpt_jet80[i]->SetMarkerColor(kRed+1);
    hMC_chSumJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_chSumJtpt_jet80[i]->Print("base");
    hMC_chSumJtpt_jet80[i]->SetTitle(" ");
    hMC_chSumJtpt_jet80[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_chSumJtpt_jet80[i]->DrawNormalized();

    hData_chSumJtpt_jet80[i]->SetMarkerStyle(24);
    hData_chSumJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_chSumJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_chSumJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_chSumJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cchSumJtpt_jet80[i]->SaveAs(Form("chSumJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * ceSumJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    ceSumJtpt_jet80[i] = new TCanvas(Form("ceSumJtpt_jet80_cent%d",i),"",800,600);
    ceSumJtpt_jet80[i]->SetLogy();
    hMC_eSumJtpt_jet80[i]->SetMarkerColor(kBlue+1);
    hMC_eSumJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_eSumJtpt_jet80[i]->Print("base");
    hMC_eSumJtpt_jet80[i]->SetTitle(" ");
    hMC_eSumJtpt_jet80[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_eSumJtpt_jet80[i]->DrawNormalized();

    hData_eSumJtpt_jet80[i]->SetMarkerStyle(24);
    hData_eSumJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_eSumJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_eSumJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_eSumJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    ceSumJtpt_jet80[i]->SaveAs(Form("eSumJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cphSumJtpt_jet80[nbins_cent];
  
    for(int i = 0 ; i < nbins_cent ; ++i){

    cphSumJtpt_jet80[i] = new TCanvas(Form("cphSumJtpt_jet80_cent%d",i),"",800,600);
    cphSumJtpt_jet80[i]->SetLogy();
    hMC_phSumJtpt_jet80[i]->SetMarkerColor(kGreen-3);
    hMC_phSumJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_phSumJtpt_jet80[i]->Print("base");
    hMC_phSumJtpt_jet80[i]->SetTitle(" ");
    hMC_phSumJtpt_jet80[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_phSumJtpt_jet80[i]->DrawNormalized();

    hData_phSumJtpt_jet80[i]->SetMarkerStyle(24);
    hData_phSumJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_phSumJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_phSumJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_phSumJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cphSumJtpt_jet80[i]->SaveAs(Form("phSumJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
  TCanvas * cneSumJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cneSumJtpt_jet80[i] = new TCanvas(Form("cneSumJtpt_jet80_cent%d",i),"",800,600);
    cneSumJtpt_jet80[i]->SetLogy();
    hMC_neSumJtpt_jet80[i]->SetMarkerColor(kMagenta+1);
    hMC_neSumJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_neSumJtpt_jet80[i]->Print("base");
    hMC_neSumJtpt_jet80[i]->SetTitle(" ");
    hMC_neSumJtpt_jet80[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_neSumJtpt_jet80[i]->DrawNormalized();

    hData_neSumJtpt_jet80[i]->SetMarkerStyle(24);
    hData_neSumJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_neSumJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_neSumJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_neSumJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cneSumJtpt_jet80[i]->SaveAs(Form("neSumJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");

  }
    TCanvas * cmuSumJtpt_jet80[nbins_cent];

  for(int i = 0 ; i < nbins_cent ; ++i){

    cmuSumJtpt_jet80[i] = new TCanvas(Form("cmuSumJtpt_jet80_cent%d",i),"",800,600);
    cmuSumJtpt_jet80[i]->SetLogy();
    hMC_muSumJtpt_jet80[i]->SetMarkerColor(kCyan+1);
    hMC_muSumJtpt_jet80[i]->SetMarkerStyle(25);
    hMC_muSumJtpt_jet80[i]->Print("base");
    hMC_muSumJtpt_jet80[i]->SetTitle(" ");
    hMC_muSumJtpt_jet80[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet80 no cuts");
    hMC_muSumJtpt_jet80[i]->DrawNormalized();

    hData_muSumJtpt_jet80[i]->SetMarkerStyle(24);
    hData_muSumJtpt_jet80[i]->SetMarkerColor(kBlack);
    hData_muSumJtpt_jet80[i]->DrawNormalized("same");
    drawText(Form("%2.0f-%2.0f%%",2.5*boundaries_cent[i],2.5*boundaries_cent[i+1]),0.8,0.8,16);

    TLegend * leg = myLegend(0.15,0.15,0.3,0.3);
    leg->AddEntry(hMC_muSumJtpt_jet80[0],"MC","pl");
    leg->AddEntry(hData_muSumJtpt_jet80[0],"Data","pl");
    leg->SetTextSize(0.04);
    leg->Draw();
    
    cmuSumJtpt_jet80[i]->SaveAs(Form("muSumJtpt_jet80_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet80_keep[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_chMaxJtpt_jet80_keep[i]>0){
      if(nMC_chMaxJtpt_jet80_keep[i]<=0){
        ...
        hData_chMaxJtpt_jet80_keep[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cchMaxJtpt_jet80_keep[i]->SaveAs(Form("chMaxJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet80_keep[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_eMaxJtpt_jet80_keep[i]>0){
      if(nMC_eMaxJtpt_jet80_keep[i]<=0){
        ...
        hData_eMaxJtpt_jet80_keep[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    ceMaxJtpt_jet80_keep[i]->SaveAs(Form("eMaxJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet80_keep[nbins_cent];
    ...
    hMC_phMaxJtpt_jet80_keep[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_phMaxJtpt_jet80_keep[i]>0){
      if(nMC_phMaxJtpt_jet80_keep[i]<=0){
        ...
        hData_phMaxJtpt_jet80_keep[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cphMaxJtpt_jet80_keep[i]->SaveAs(Form("phMaxJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet80_keep[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_neMaxJtpt_jet80_keep[i]>0){
      if(nMC_neMaxJtpt_jet80_keep[i]<=0){
        ...
        hData_neMaxJtpt_jet80_keep[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cneMaxJtpt_jet80_keep[i]->SaveAs(Form("neMaxJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet80_keep[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_muMaxJtpt_jet80_keep[i]>0){
      if(nMC_muMaxJtpt_jet80_keep[i]<=0){
        ...
        hData_muMaxJtpt_jet80_keep[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cmuMaxJtpt_jet80_keep[i]->SaveAs(Form("muMaxJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet80_keep[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_chSumJtpt_jet80_keep[i]>0){
      if(nMC_chSumJtpt_jet80_keep[i]<=0){
        ...
        hData_chSumJtpt_jet80_keep[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cchSumJtpt_jet80_keep[i]->SaveAs(Form("chSumJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet80_keep[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_eSumJtpt_jet80_keep[i]>0){
      if(nMC_eSumJtpt_jet80_keep[i]<=0){
        ...
        hData_eSumJtpt_jet80_keep[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    ceSumJtpt_jet80_keep[i]->SaveAs(Form("eSumJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet80_keep[nbins_cent];
    ...
    hMC_phSumJtpt_jet80_keep[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_phSumJtpt_jet80_keep[i]>0){
      if(nMC_phSumJtpt_jet80_keep[i]<=0){
        ...
        hData_phSumJtpt_jet80_keep[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cphSumJtpt_jet80_keep[i]->SaveAs(Form("phSumJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet80_keep[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_neSumJtpt_jet80_keep[i]>0){
      if(nMC_neSumJtpt_jet80_keep[i]<=0){
        ...
        hData_neSumJtpt_jet80_keep[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cneSumJtpt_jet80_keep[i]->SaveAs(Form("neSumJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet80_keep[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet80, pass CutA");
    ...
    if (nData_muSumJtpt_jet80_keep[i]>0){
      if(nMC_muSumJtpt_jet80_keep[i]<=0){
        ...
        hData_muSumJtpt_jet80_keep[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cmuSumJtpt_jet80_keep[i]->SaveAs(Form("muSumJtpt_jet80_keep_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chMaxJtpt_jet80_rej[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_chMaxJtpt_jet80_rej[i]>0){
      if(nMC_chMaxJtpt_jet80_rej[i]<=0){
        ...
        hData_chMaxJtpt_jet80_rej[i]->SetXTitle("chMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cchMaxJtpt_jet80_rej[i]->SaveAs(Form("chMaxJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eMaxJtpt_jet80_rej[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_eMaxJtpt_jet80_rej[i]>0){
      if(nMC_eMaxJtpt_jet80_rej[i]<=0){
        ...
        hData_eMaxJtpt_jet80_rej[i]->SetXTitle("eMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    ceMaxJtpt_jet80_rej[i]->SaveAs(Form("eMaxJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet80_rej[nbins_cent];
    ...
    hMC_phMaxJtpt_jet80_rej[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_phMaxJtpt_jet80_rej[i]>0){
      if(nMC_phMaxJtpt_jet80_rej[i]<=0){
        ...
        hData_phMaxJtpt_jet80_rej[i]->SetXTitle("phMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cphMaxJtpt_jet80_rej[i]->SaveAs(Form("phMaxJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neMaxJtpt_jet80_rej[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_neMaxJtpt_jet80_rej[i]>0){
      if(nMC_neMaxJtpt_jet80_rej[i]<=0){
        ...
        hData_neMaxJtpt_jet80_rej[i]->SetXTitle("neMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cneMaxJtpt_jet80_rej[i]->SaveAs(Form("neMaxJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muMaxJtpt_jet80_rej[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_muMaxJtpt_jet80_rej[i]>0){
      if(nMC_muMaxJtpt_jet80_rej[i]<=0){
        ...
        hData_muMaxJtpt_jet80_rej[i]->SetXTitle("muMax/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cmuMaxJtpt_jet80_rej[i]->SaveAs(Form("muMaxJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_chSumJtpt_jet80_rej[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_chSumJtpt_jet80_rej[i]>0){
      if(nMC_chSumJtpt_jet80_rej[i]<=0){
        ...
        hData_chSumJtpt_jet80_rej[i]->SetXTitle("chSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cchSumJtpt_jet80_rej[i]->SaveAs(Form("chSumJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_eSumJtpt_jet80_rej[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_eSumJtpt_jet80_rej[i]>0){
      if(nMC_eSumJtpt_jet80_rej[i]<=0){
        ...
        hData_eSumJtpt_jet80_rej[i]->SetXTitle("eSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    ceSumJtpt_jet80_rej[i]->SaveAs(Form("eSumJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet80_rej[nbins_cent];
    ...
    hMC_phSumJtpt_jet80_rej[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_phSumJtpt_jet80_rej[i]>0){
      if(nMC_phSumJtpt_jet80_rej[i]<=0){
        ...
        hData_phSumJtpt_jet80_rej[i]->SetXTitle("phSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cphSumJtpt_jet80_rej[i]->SaveAs(Form("phSumJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_neSumJtpt_jet80_rej[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_neSumJtpt_jet80_rej[i]>0){
      if(nMC_neSumJtpt_jet80_rej[i]<=0){
        ...
        hData_neSumJtpt_jet80_rej[i]->SetXTitle("neSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cneSumJtpt_jet80_rej[i]->SaveAs(Form("neSumJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    hMC_muSumJtpt_jet80_rej[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet80, fail CutA");
    ...
    if (nData_muSumJtpt_jet80_rej[i]>0){
      if(nMC_muSumJtpt_jet80_rej[i]<=0){
        ...
        hData_muSumJtpt_jet80_rej[i]->SetXTitle("muSum/(ak4PuPF jet p_{T}) jet80, pass CutA");      
    ...
    cmuSumJtpt_jet80_rej[i]->SaveAs(Form("muSumJtpt_jet80_rej_cent%deMax_MCweight_R4.pdf",i),"RECREATE");
