...
int jetmatch_MinBias(std::string kSpecies="pbpb",
...
//       tch_pfjet->SetBranchAddress("L1_SingleJet52_BptxAND_Prescl",1,0);       
  ...
  // TTree* noPFCaloJets = new TTree("noPFCaloJets","noPF and Calo jets but genjets (only for MC)");
  // noPFCaloJets->Branch("hiBin",&hiBin,"hiBin/I");
  // noPFCaloJets->Branch("run_value",&run_value,"run_value/I");
  // noPFCaloJets->Branch("evt_value",&evt_value,"evt_value/I");
  // noPFCaloJets->Branch("lumi_value",&lumi_value,"lumi_value/I");
  // if ( kSpecies == "pbpb" ){
  //   noPFCaloJets->Branch("jet80",&jet80,"jet80/I"); noPFCaloJets->Branch("jet80_prescl",&jet80_prescl,"jet80_prescl/I");
  //   noPFCaloJets->Branch("jet65",&jet65,"jet65/I"); noPFCaloJets->Branch("jet65_prescl",&jet65_prescl,"jet65_prescl/I");
  //   noPFCaloJets->Branch("jet55",&jet55,"jet55/I"); noPFCaloJets->Branch("jet55_prescl",&jet55_prescl,"jet55_prescl/I");
  // }else{
  //   noPFCaloJets->Branch("jet80",&jet80,"jet80/I"); noPFCaloJets->Branch("jet80_prescl",&jet80_prescl,"jet80_prescl/I");
  //   noPFCaloJets->Branch("jet60",&jet60,"jet60/I"); noPFCaloJets->Branch("jet60_prescl",&jet60_prescl,"jet60_prescl/I");
  //   noPFCaloJets->Branch("jet40",&jet40,"jet40/I"); noPFCaloJets->Branch("jet40_prescl",&jet40_prescl,"jet40_prescl/I");
  // }
  // noPFCaloJets->Branch("vz",&vz,"vz/F");
  // if( kDataset == "mc" ){
  //   noPFCaloJets->Branch("subid",&subid,"subid/I");    
  //   noPFCaloJets->Branch("weight",&weight,"weight/F");    noPFCaloJets->Branch("pthat",&pthat,"pthat/F");
  //   noPFCaloJets->Branch("refpt",&refpt,"refpt/F");    
  //   noPFCaloJets->Branch("refeta",&refeta,"refeta/F"); 
  //   noPFCaloJets->Branch("refphi",&refphi,"refphi/F"); 
  //   noPFCaloJets->Branch("refdrjt",&refdrjt,"refdrjt/F"); 
  // }
  ...
  for (Long64_t i=0; i<nentries;i++) {
    ...
    //bool noPFCalo   = (pfjets==0 && calojets==0) ? true : false;
