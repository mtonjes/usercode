...
void Draw_MuOverCutA(Int_t radius=3)
{
  gStyle->SetOptStat(0);
  TH1::SetDefaultSumw2();
  TH2::SetDefaultSumw2();
  ...
  fTrk=TFile::Open(Form("Pawan_TTree_PbPb_Data_MC_subid0_spectra_JetID_CutA_finebins_20_eta_20_R0p%d_muMaxOSumAlllt0pt975.root",radius));
