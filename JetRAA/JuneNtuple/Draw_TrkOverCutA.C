...
void Draw_TrkOverCutA(Int_t radius=3)
{
  ...
  for(int i=0;i<nbins_cent;i++){
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) PbPb data",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio->SaveAs(Form("RatioPlots/PbPb_HLTComb_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC reco",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio_MCrec->SaveAs(Form("RatioPlots/PbPb_HLTComb_MCrec_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC gen",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio_MCgen->SaveAs(Form("RatioPlots/PbPb_HLTComb_MCgen_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE");  
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) PbPb data jet55",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio55->SaveAs(Form("RatioPlots/PbPb_Jet55_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC reco jet55",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio55_MCrec->SaveAs(Form("RatioPlots/PbPb_Jet55_MCrec_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC gen jet55",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio55_MCgen->SaveAs(Form("RatioPlots/PbPb_Jet55_MCgen_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE");   
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) PbPb data jet65",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio65->SaveAs(Form("RatioPlots/PbPb_Jet65_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC reco jet65",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio65_MCrec->SaveAs(Form("RatioPlots/PbPb_Jet65_MCrec_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC gen jet65",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio65_MCgen->SaveAs(Form("RatioPlots/PbPb_Jet65_MCgen_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE");   
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) PbPb data jet80",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio80->SaveAs(Form("RatioPlots/PbPb_Jet80_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC reco jet80",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
  ...
  cRatio80_MCrec->SaveAs(Form("RatioPlots/PbPb_Jet80_MCrec_CutAOverTrkCutA_R0p%d.pdf",radius),"RECREATE"); 
    ...
    makeHistTitle(hBlankRatio,"",Form("akPu%dPF Jet p_{T} (GeV/c) MC gen jet80",radius),"CutA/(TrkMax/JetpT>0.01 & CutA)");    
