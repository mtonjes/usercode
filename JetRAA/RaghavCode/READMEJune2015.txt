...
( June 4: will soon switch to Pawan's trees which retain nice event-based information)
...
**********************************
June 4 edit:
[6/4/15 4:11:24 PM] Raghav Kunnawalkam Elayavalli: run RAA_plot_yetkinCutEfficiency.C (inside CMSSW_5_3_20/src/Macros/RAA/.)
[6/4/15 4:11:45 PM] Raghav Kunnawalkam Elayavalli: so that and RAA_plot_yetkinCutEfficiency_pp.C
their output is fed into RAA_analyze (there is a step inbetween where i copy them over to CERN to run teh data driven unfolding error correction macro)
