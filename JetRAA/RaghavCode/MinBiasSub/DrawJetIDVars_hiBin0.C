...
static const int nbins_cent = 1;
//static const int nbins_cent_hiBin = 1;
...
static const Double_t boundaries_cent[nbins_cent+1] = {0,2};
...
void DrawJetIDVars_hiBin0(int radius=3, std::string kFDataname="/export/d00/scratch/belt/JetRAA/30July/PbPb_Data_hiBin0_jetID_r3.root",
			std::string kFMCname="/export/d00/scratch/belt/JetRAA/30July/PbPb_MC_jetID_r3.root",
		    std::string kFoname="/export/d00/scratch/belt/JetRAA/30July/PbPb_Data_MC_hiBin0_JetIDPlots_r3.root")
{
// open files		      
...
//#if 0
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_keep[nbins_cent];
    ...
    cphMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_keep[nbins_cent];
    ...
    cphSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet55_rej[nbins_cent];
    ...
    cphMaxJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet55_rej[nbins_cent];
    ...
    cphSumJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet55_rej[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet55_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
//#endif
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet65_keep[nbins_cent];
    ...
    cphMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet65_keep[nbins_cent];
    ...
    cphSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet65_rej[nbins_cent];
    ...
    cphMaxJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet65_rej[nbins_cent];
    ...
    cphSumJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet65_rej[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet65_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// plot jet80
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet80_keep[nbins_cent];
    ...
    cphMaxJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet80_keep[nbins_cent];
    ...
    cphSumJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet80_keep[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchMaxJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/chMaxJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceMaxJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/eMaxJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
   ...
   TCanvas * cphMaxJtpt_jet80_rej[nbins_cent];
    ...
    cphMaxJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/phMaxJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneMaxJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/neMaxJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuMaxJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/muMaxJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
// draw some Sum variables
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cchSumJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/chSumJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceSumJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/eSumJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  TCanvas * cphSumJtpt_jet80_rej[nbins_cent];
    ...
    cphSumJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/phSumJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cneSumJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/neSumJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cmuSumJtpt_jet80_rej[i]->SaveAs(Form("Plots_hiBin0/muSumJtpt_jet80_rej_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ctrkMaxJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
//     leg->Draw();
//     
//     ctrkSumJtpt_jet55_keep[i]->SaveAs(Form("Plots_hiBin0/trkSumJtpt_jet55_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ctrkMaxJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
//     leg->Draw();
//     
//     ctrkSumJtpt_jet65_keep[i]->SaveAs(Form("Plots_hiBin0/trkSumJtpt_jet65_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ctrkMaxJtpt_80_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
...
//     leg->Draw();
//     
//     ctrkSumJtpt_80_keep[i]->SaveAs(Form("Plots_hiBin0/trkSumJtpt_80_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   } 
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_Matched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_Matched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
// 
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet55_Matched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet55_Matched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet65_Matched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet65_Matched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet80_Matched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet80_Matched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
//   
// #if 0
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_Unmatched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_Unmatched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
// 
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet55_Unmatched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet55_Unmatched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet65_Unmatched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet65_Unmatched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_jet80_Unmatched_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_jet80_Unmatched_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
// 
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_Matched_NoTrig_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_Matched_NoTrig_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }
...
//     leg->Draw();
//     
//     ctrkMaxJtpt_Unmatched_NoTrig_keep[i]->SaveAs(Form("Plots_hiBin0/trkMaxJtpt_Unmatched_NoTrig_keep_cent%deMax_MCweight_R%d.pdf",i,radius),"RECREATE");
// 
//   }  
// #endif
