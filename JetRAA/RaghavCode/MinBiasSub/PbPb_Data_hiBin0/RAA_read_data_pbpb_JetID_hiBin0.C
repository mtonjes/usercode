...
void RAA_read_data_pbpb_JetID_hiBin0(int startfile = 0,
		      int endfile = 1,
		      int radius = 3,
...
//     ++nGoodEvt;
    if(hiBin_F!=0) continue; // only analyze hiBin=0, that is 0.5% of the events
    ...
    hcentrality[nbins_cent+1]->Fill(hiBin_F);
    if(jet55_F == 1) hcentrality_Jet55[cBin]->Fill(hiBin_F);
    if(jet55_F == 1) hcentrality_Jet55[nbins_cent+1]->Fill(hiBin_F);
    if(jet55_F == 1) hcentrality_Jet55_Prescl[cBin]->Fill(hiBin_F, jet55_p_F);
    if(jet55_F == 1) hcentrality_Jet55_Prescl[nbins_cent+1]->Fill(hiBin_F, jet55_p_F);
    if(jet65_F == 1) hcentrality_Jet65[cBin]->Fill(hiBin_F);
    if(jet65_F == 1) hcentrality_Jet65[nbins_cent+1]->Fill(hiBin_F);
    if(jet65_F == 1) hcentrality_Jet65_Prescl[cBin]->Fill(hiBin_F, jet65_p_F);
    if(jet65_F == 1) hcentrality_Jet65_Prescl[nbins_cent+1]->Fill(hiBin_F, jet65_p_F);
    if(jet80_F == 1) hcentrality_Jet80[cBin]->Fill(hiBin_F);
    if(jet80_F == 1) hcentrality_Jet80[nbins_cent+1]->Fill(hiBin_F);
    if(jet55_F == 1 && jet65_F == 0 && jet80_F == 0) hcentrality_Jet55not65not80[cBin]->Fill(hiBin_F);
    if(jet55_F == 1 && jet65_F == 0 && jet80_F == 0) hcentrality_Jet55not65not80[nbins_cent+1]->Fill(hiBin_F);
    if(jet55_F == 1 && jet65_F == 0 && jet80_F == 0) hcentrality_Jet55not65not80_Prescl[cBin]->Fill(hiBin_F, jet55_p_F);
    if(jet55_F == 1 && jet65_F == 0 && jet80_F == 0) hcentrality_Jet55not65not80_Prescl[nbins_cent+1]->Fill(hiBin_F, jet55_p_F);
    if(jet65_F == 1 && jet80_F == 0) hcentrality_Jet65not80[cBin]->Fill(hiBin_F);
    if(jet65_F == 1 && jet80_F == 0) hcentrality_Jet65not80[nbins_cent+1]->Fill(hiBin_F);
