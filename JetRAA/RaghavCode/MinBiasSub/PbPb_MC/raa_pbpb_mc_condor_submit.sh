...
do
    ...
    Error="akPu$radius-PbPbMC-$endfile.err"
    Output="akPu$radius-PbPbMC-$endfile.out"
    Log="akPu$radius-PbPbMC-$endfile.log"
...
Input          = /dev/null
# log files
Error          = /export/d00/scratch/belt/JetRAA/30July/PbPb_MC/LOG/$Error
Output         = /export/d00/scratch/belt/JetRAA/30July/PbPb_MC/LOG/$Output
Log            = /export/d00/scratch/belt/JetRAA/30July/PbPb_MC/LOG/$Log
