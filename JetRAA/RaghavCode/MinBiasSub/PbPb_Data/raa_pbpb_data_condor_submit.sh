...
do
    ...
    outfile="PbPb_Data_histograms_FromForest_JetID_akPu${radius}_20_eta_20_${endfile}.root"
...
Input          = /dev/null
# log files
Error          = /export/d00/scratch/belt/JetRAA/30July/PbPb_Data/LOG/$Error
Output         = /export/d00/scratch/belt/JetRAA/30July/PbPb_Data/LOG/$Output
Log            = /export/d00/scratch/belt/JetRAA/30July/PbPb_Data/LOG/$Log
...
transfer_input_files = $tardir/jetRAA_run_PbPb_Data.tar
