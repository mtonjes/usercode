...
void RAA_read_data_pbpb_JetID(int startfile = 0,
		      int endfile = 1,
		      int radius = 3,
  ...
  TH1F * hData_trkMaxJtpt_jet55_keep[nbins_cent], * hData_trSumJtpt_jet55_keep[nbins_cent] ;
  TH1F * hData_trkMaxJtpt_jet65_keep[nbins_cent], * hData_trSumJtpt_jet65_keep[nbins_cent] ;
  TH1F * hData_trkMaxJtpt_jet80_keep[nbins_cent], * hData_trSumJtpt_jet80_keep[nbins_cent] ;
  TH1F * hData_trkMaxJtpt_jet55_rej[nbins_cent], * hData_trSumJtpt_jet55_rej[nbins_cent] ;
  TH1F * hData_trkMaxJtpt_jet65_rej[nbins_cent], * hData_trSumJtpt_jet65_rej[nbins_cent] ;
  TH1F * hData_trkMaxJtpt_jet80_rej[nbins_cent], * hData_trSumJtpt_jet80_rej[nbins_cent] ;
 ...
 Double_t  nData_trkMaxJtpt_jet55_keep[nbins_cent], nData_trSumJtpt_jet55_keep[nbins_cent];
 Double_t  nData_trkMaxJtpt_jet65_keep[nbins_cent], nData_trSumJtpt_jet65_keep[nbins_cent];
 Double_t  nData_trkMaxJtpt_jet80_keep[nbins_cent], nData_trSumJtpt_jet80_keep[nbins_cent];
 Double_t  nData_trkMaxJtpt_jet55_rej[nbins_cent], nData_trSumJtpt_jet55_rej[nbins_cent];
 Double_t  nData_trkMaxJtpt_jet65_rej[nbins_cent], nData_trSumJtpt_jet65_rej[nbins_cent];
 Double_t  nData_trkMaxJtpt_jet80_rej[nbins_cent], nData_trSumJtpt_jet80_rej[nbins_cent];
  ...
  for(int i = 0;i<nbins_cent;++i){
    ...
    hData_muSumJtpt_jet80_rej[i] = new TH1F(Form("hData_muSumJtpt_jet80_rej_cent%d",i),Form("Data muSum/Jtpt, jet80 fail cutA in centrality bin %d",i),100,0,1);
     hData_trkMaxJtpt_jet55_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet55_keep_cent%d",i),Form("Data trkMax/Jtpt, jet55 pass cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_jet55_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet55_keep_cent%d",i),Form("Data trkMax/Jtpt, jet55 pass cutA in centrality bin %d",i),100,0,1);
    hData_trSumJtpt_jet55_keep[i] = new TH1F(Form("hData_trSumJtpt_jet55_keep_cent%d",i),Form("Data trSum/Jtpt, jet55 pass cutA in centrality bin %d",i),100,0,3);
    hData_trkMaxJtpt_jet65_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet65_keep_cent%d",i),Form("Data trkMax/Jtpt, jet65 pass cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_jet80_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet80_keep_cent%d",i),Form("Data trkMax/Jtpt, jet80 pass cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_jet55_rej[i] = new TH1F(Form("hData_trkMaxJtpt_jet55_rej_cent%d",i),Form("Data trkMax/Jtpt, jet55 fail cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_jet65_rej[i] = new TH1F(Form("hData_trkMaxJtpt_jet65_rej_cent%d",i),Form("Data trkMax/Jtpt, jet65 fail cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_jet80_rej[i] = new TH1F(Form("hData_trkMaxJtpt_jet80_rej_cent%d",i),Form("Data trkMax/Jtpt, jet80 fail cutA in centrality bin %d",i),100,0,1);
    ...
    hData_trkMaxJtpt_Matched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_Matched_keep_cent%d",i),Form("Data trkMax/Jtpt, matched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet55_Matched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet55_Matched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet55 matched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet65_Matched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet65_Matched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet65 matched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet80_Matched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet80_Matched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet80 matched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_Unmatched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_Unmatched_keep_cent%d",i),Form("Data trkMax/Jtpt, Unmatched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet55_Unmatched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet55_Unmatched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet55 Unmatched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet65_Unmatched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet65_Unmatched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet65 Unmatched pass cutA in centrality bin %d",i),100,0,1);
    hData_trkMaxJtpt_jet80_Unmatched_keep[i] = new TH1F(Form("hData_trkMaxJtpt_jet80_Unmatched_keep_cent%d",i),Form("Data trkMax/Jtpt, jet80 Unmatched pass cutA in centrality bin %d",i),100,0,1);
  ...
  for(int nEvt = 0; nEvt < nentries; ++ nEvt) {
   ...
   //   if( trkMax_F[jet] < 7 && neMax_F[jet] < 8 ) continue;
	...
	hpbpb_Smear_TrgObj55[cBin]->Fill(recpt + rnd.Gaus(0,1), jet55_p_F* wght);
	    if(pt_F[jet]>pfptmin){
	         hData_chMaxJtpt_jet55_keep[cBin]->Fill(chMax_F[jet]/pt_F[jet], jet55_p_F* wght);
 	         hData_trkMaxJtpt_jet55_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_eMaxJtpt_jet55_keep[cBin]->Fill(eMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_neMaxJtpt_jet55_keep[cBin]->Fill(neMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_phMaxJtpt_jet55_keep[cBin]->Fill(phMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_muMaxJtpt_jet55_keep[cBin]->Fill(muMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_chSumJtpt_jet55_keep[cBin]->Fill(chSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_eSumJtpt_jet55_keep[cBin]->Fill(eSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_neSumJtpt_jet55_keep[cBin]->Fill(neSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_phSumJtpt_jet55_keep[cBin]->Fill(phSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_muSumJtpt_jet55_keep[cBin]->Fill(muSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_trkMaxJtpt_jet55_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_trkMaxJtpt_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], jet55_p_F* wght); 
        }	
      }
	...
	hpbpb_Smear_TrgObj65[cBin]->Fill(recpt + rnd.Gaus(0,1), wght);
	    if(pt_F[jet]>pfptmin){
	         hData_chMaxJtpt_jet65_keep[cBin]->Fill(chMax_F[jet]/pt_F[jet], wght);
	         hData_trkMaxJtpt_jet65_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);
             hData_eMaxJtpt_jet65_keep[cBin]->Fill(eMax_F[jet]/pt_F[jet], wght);
             hData_neMaxJtpt_jet65_keep[cBin]->Fill(neMax_F[jet]/pt_F[jet], wght);
             hData_phMaxJtpt_jet65_keep[cBin]->Fill(phMax_F[jet]/pt_F[jet], wght);
             hData_muMaxJtpt_jet65_keep[cBin]->Fill(muMax_F[jet]/pt_F[jet], wght);
             hData_chSumJtpt_jet65_keep[cBin]->Fill(chSum_F[jet]/pt_F[jet], wght);
             hData_eSumJtpt_jet65_keep[cBin]->Fill(eSum_F[jet]/pt_F[jet], wght);
             hData_neSumJtpt_jet65_keep[cBin]->Fill(neSum_F[jet]/pt_F[jet], wght);
             hData_phSumJtpt_jet65_keep[cBin]->Fill(phSum_F[jet]/pt_F[jet], wght);
             hData_muSumJtpt_jet65_keep[cBin]->Fill(muSum_F[jet]/pt_F[jet], wght); 
             hData_trkMaxJtpt_jet65_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);
             hData_trkMaxJtpt_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);              
        } 	
      }
	...
	hpbpb_Smear_TrgObj80[cBin]->Fill(recpt + rnd.Gaus(0,1), wght);
	    if(pt_F[jet]>pfptmin){
	         hData_chMaxJtpt_jet80_keep[cBin]->Fill(chMax_F[jet]/pt_F[jet], wght);
	         hData_trkMaxJtpt_jet80_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);
             hData_eMaxJtpt_jet80_keep[cBin]->Fill(eMax_F[jet]/pt_F[jet], wght);
             hData_neMaxJtpt_jet80_keep[cBin]->Fill(neMax_F[jet]/pt_F[jet], wght);
             hData_phMaxJtpt_jet80_keep[cBin]->Fill(phMax_F[jet]/pt_F[jet], wght);
             hData_muMaxJtpt_jet80_keep[cBin]->Fill(muMax_F[jet]/pt_F[jet], wght);
             hData_chSumJtpt_jet80_keep[cBin]->Fill(chSum_F[jet]/pt_F[jet], wght);
             hData_eSumJtpt_jet80_keep[cBin]->Fill(eSum_F[jet]/pt_F[jet], wght);
             hData_neSumJtpt_jet80_keep[cBin]->Fill(neSum_F[jet]/pt_F[jet], wght);
             hData_phSumJtpt_jet80_keep[cBin]->Fill(phSum_F[jet]/pt_F[jet], wght);
             hData_muSumJtpt_jet80_keep[cBin]->Fill(muSum_F[jet]/pt_F[jet], wght); 
             hData_trkMaxJtpt_jet80_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);
             hData_trkMaxJtpt_Matched_keep[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);             
        }	
      }
     } else {
     // rejected PFElectron cut jets
      if(jet55_F == 1 && jet65_F == 0 && jet80_F == 0){
	       if(pt_F[jet]>pfptmin){
             hData_chMaxJtpt_jet55_rej[cBin]->Fill(chMax_F[jet]/pt_F[jet], jet55_p_F* wght);
	         hData_trkMaxJtpt_jet55_rej[cBin]->Fill(trkMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_eMaxJtpt_jet55_rej[cBin]->Fill(eMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_neMaxJtpt_jet55_rej[cBin]->Fill(neMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_phMaxJtpt_jet55_rej[cBin]->Fill(phMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_muMaxJtpt_jet55_rej[cBin]->Fill(muMax_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_chSumJtpt_jet55_rej[cBin]->Fill(chSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_eSumJtpt_jet55_rej[cBin]->Fill(eSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_neSumJtpt_jet55_rej[cBin]->Fill(neSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_phSumJtpt_jet55_rej[cBin]->Fill(phSum_F[jet]/pt_F[jet], jet55_p_F* wght);
             hData_muSumJtpt_jet55_rej[cBin]->Fill(muSum_F[jet]/pt_F[jet], jet55_p_F* wght); 	       
	       }
	    }      
      if(jet65_F == 1 && jet80_F == 0){
	       if(pt_F[jet]>pfptmin){
	         hData_chMaxJtpt_jet65_rej[cBin]->Fill(chMax_F[jet]/pt_F[jet], wght);
	         hData_trkMaxJtpt_jet65_rej[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);	         
             hData_eMaxJtpt_jet65_rej[cBin]->Fill(eMax_F[jet]/pt_F[jet], wght);
             hData_neMaxJtpt_jet65_rej[cBin]->Fill(neMax_F[jet]/pt_F[jet], wght);
             hData_phMaxJtpt_jet65_rej[cBin]->Fill(phMax_F[jet]/pt_F[jet], wght);
             hData_muMaxJtpt_jet65_rej[cBin]->Fill(muMax_F[jet]/pt_F[jet], wght);
             hData_chSumJtpt_jet65_rej[cBin]->Fill(chSum_F[jet]/pt_F[jet], wght);
 //             hData_trkSumJtpt_jet65_rej[cBin]->Fill(trkSum_F[jet]/pt_F[jet], wght);
            hData_eSumJtpt_jet65_rej[cBin]->Fill(eSum_F[jet]/pt_F[jet], wght);
             hData_neSumJtpt_jet65_rej[cBin]->Fill(neSum_F[jet]/pt_F[jet], wght);
             hData_phSumJtpt_jet65_rej[cBin]->Fill(phSum_F[jet]/pt_F[jet], wght);
             hData_muSumJtpt_jet65_rej[cBin]->Fill(muSum_F[jet]/pt_F[jet], wght);  
           }
      }     
      if(jet80_F == 1){
 	       if(pt_F[jet]>pfptmin){
	         hData_chMaxJtpt_jet80_rej[cBin]->Fill(chMax_F[jet]/pt_F[jet], wght);
	         hData_trkMaxJtpt_jet80_rej[cBin]->Fill(trkMax_F[jet]/pt_F[jet], wght);	         
             hData_eMaxJtpt_jet80_rej[cBin]->Fill(eMax_F[jet]/pt_F[jet], wght);
             hData_neMaxJtpt_jet80_rej[cBin]->Fill(neMax_F[jet]/pt_F[jet], wght);
             hData_phMaxJtpt_jet80_rej[cBin]->Fill(phMax_F[jet]/pt_F[jet], wght);
             hData_muMaxJtpt_jet80_rej[cBin]->Fill(muMax_F[jet]/pt_F[jet], wght);
             hData_chSumJtpt_jet80_rej[cBin]->Fill(chSum_F[jet]/pt_F[jet], wght);
             hData_eSumJtpt_jet80_rej[cBin]->Fill(eSum_F[jet]/pt_F[jet], wght);
             hData_neSumJtpt_jet80_rej[cBin]->Fill(neSum_F[jet]/pt_F[jet], wght);
             hData_phSumJtpt_jet80_rej[cBin]->Fill(phSum_F[jet]/pt_F[jet], wght);
             hData_muSumJtpt_jet80_rej[cBin]->Fill(muSum_F[jet]/pt_F[jet], wght); 
           }     
      }     
     }
    }// jet loop
