...
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/RooUnfold-1.1.1/src/RooUnfoldResponse.h"
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/RooUnfold-1.1.1/src/RooUnfoldBayes.h"
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/RooUnfold-1.1.1/src/RooUnfoldSvd.h"
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/RooUnfold-1.1.1/src/RooUnfoldBinByBin.h"
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/prior.h"
#include "/net/hisrv0001/home/belt/wrk/JetRAA/matchAnalysis/17April/Headers/bayesianUnfold.h"
...
void RAA_analyze(int radius = 2, char* algo = (char*) "Pu", char *jet_type = (char*) "PF", int unfoldingCut = 40, char* etaWidth = (char*) "20_eta_20", double deltaEta = 4.0){
  ...
  // Pawan's files:
  // I didn't rename the files but they are including chMax/jtpt cuts (Marguerite):
  TFile * fPbPb_in = TFile::Open(Form("/net/hisrv0001/home/belt/wrk/JetRAA/RaghavCode/Output/Pawan_ntuple_PbPb_data_MC_subid0_spectra_JetID_CutA_finebins_%s_R0p%d.root",etaWidth, radius));
  TFile * fPP_in = TFile::Open(Form("/net/hisrv0001/home/belt/wrk/JetRAA/RaghavCode/Output/Pawan_ntuple_PP_data_MC_spectra_residualFactor_finebins_%s_R0p%d.root",etaWidth, radius));
  ...
  TFile * fMCClosure = TFile::Open(" /net/hidsk0001/d00/scratch/pawan/condorfiles/histo/Histogram_pp_PbPb_unfoldMatrix.root");
//  TFile * fMCClosure = TFile::Open("/net/hisrv0001/home/pawan/Validation/CMSSW_7_1_1/src/JetRaa/Histogram_pp_PbPb_unfoldMatrix.root");
  ...
  TFile * ferrorin = TFile::Open(Form("/net/hisrv0001/home/belt/wrk/JetRAA/RaghavCode/Output/Pawan_ntuple_PbPb_R%d_pp_R%d_noJetID_%s_unfoldingCut_%d_noFakeWeight_data_driven_correction_akPu%s_20150514.root",radius, radius, etaWidth, unfoldingCut, jet_type));
  ...
  TFile fout(Form("Output/Pawan_ntuple_PbPb_pp_calopfpt_ppNoJetidcut_R0p%d_noFakeWeight_unfold_mcclosure_oppside_trgMC_BothSmear_%s_%dGeVCut_ak%s_%d.root", radius, etaWidth, unfoldingCut, jet_type, date.GetDate()),"RECREATE");
  fout.cd();
