...
void RAA_NEWcomparisonwithPAS_Edit(char *algo = "Pu", char *jet_type = "PF"){
...
// Fix the input files for your analysis!
  // load in the necessary files:
  TFile *f_unfold_R2 = TFile::Open("Output/Pawan_ntuple_PbPb_pp_calopfpt_ppNoJetidcut_R0p2_noFakeWeight_unfold_mcclosure_oppside_trgMC_BothSmear_20_eta_20_40GeVCut_akPF_20150514.root");
  TFile *f_unfold_R3 = TFile::Open("Output/Pawan_ntuple_PbPb_pp_calopfpt_ppNoJetidcut_R0p3_noFakeWeight_unfold_mcclosure_oppside_trgMC_BothSmear_20_eta_20_40GeVCut_akPF_20150514.root");
  TFile *f_unfold_R4 = TFile::Open("Output/Pawan_ntuple_PbPb_pp_calopfpt_ppNoJetidcut_R0p4_noFakeWeight_unfold_mcclosure_oppside_trgMC_BothSmear_20_eta_20_40GeVCut_akPF_20150514.root");

  TFile *fPbPb_data_R2 = TFile::Open("Output/Pawan_ntuple_PbPb_data_MC_subid0_spectra_JetID_CutA_finebins_20_eta_20_R0p2.root");
  TFile *fPP_data_R2 = TFile::Open("Output/Pawan_ntuple_PP_data_MC_spectra_residualFactor_finebins_20_eta_20_R0p2.root");

  TFile *fPbPb_data_R3 = TFile::Open("Output/Pawan_ntuple_PbPb_data_MC_subid0_spectra_JetID_CutA_finebins_20_eta_20_R0p3.root");
  TFile *fPP_data_R3 = TFile::Open("Output/Pawan_ntuple_PP_data_MC_spectra_residualFactor_finebins_20_eta_20_R0p3.root");

  TFile *fPbPb_data_R4 = TFile::Open("Output/Pawan_ntuple_PbPb_data_MC_subid0_spectra_JetID_CutA_finebins_20_eta_20_R0p4.root");
  TFile *fPP_data_R4 = TFile::Open("Output/Pawan_ntuple_PP_data_MC_spectra_residualFactor_finebins_20_eta_20_R0p4.root");
  ...
  for(int i = 0;i<nbins_cent;i++){
    ...
    cout<<i<<endl;
cout<<"about to get things from f_unfold_R2"<<endl;
...
//      PASRAA_bayesian[1][i]->Scale(CorFac[i]);
    ...
    cRAA->SaveAs(Form("Plots/RAA_newComparingwithPAS_ak%s3%s_%d_Edit.pdf",algo,jet_type,date.GetDate()),"RECREATE");
  }
  ...
  if(doPbPbSpectra){
    ...
    for(int i = 0;i<nbins_cent;i++){
      ...
      PbPb_measured_fine[1][i]->SetAxisRange(1e-1,1e8,"Y");
    ...
    cPbPb_sigma->SaveAs(Form("Plots/PbPb_spectra_newComparingwithPAS_ak%s3%s_%d_Edit.pdf",algo,jet_type,date.GetDate()),"RECREATE");
  }
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  if(doPPSpectra){
    ...
    cPP_sigma->SaveAs(Form("Plots/PP_spectra_newComparingwithPAS_ak3%s_%d_Edit.pdf",jet_type,date.GetDate()),"RECREATE");
