...
//  PP_measured[1] = (TH1F*)f_unfold_R3->Get("PP_measured_unfolded_spectra");
 ...
 // PP_measured[2] = (TH1F*)f_unfold_R4->Get("PP_measured_unfolded_spectra");
  ...
  if(doRAA){
    ...
    tRAA->AddEntry(RAA_bayesian[1][0],"13-005, JetID, no RAA scale,","pl");
  ...
  if(doPPSpectra){
    ...
    NewOverOldPP->SetYTitle("HIN-13-005 jetID/HIN-12-004 trkMax");
    ...
    PP_sigma->AddEntry(PP_measured_fine[1],"13-005 Jet ID","pl");
