...
void RAA_plot_Systematics(int radius = 3, char *algo = "Pu", char *jet_type = "PF", int unfoldingCut = 60){
  ...
  cPbPb_Its->SaveAs(Form("Plots/PbPb_unfoldng_iteration_systematics_%dGeVCut_ak%s%d%s_%d.pdf",unfoldingCut,algo,radius,jet_type,date.GetDate()),"RECREATE");
  ...
  cPP_Its->SaveAs(Form("Plots/PP_unfoldng_iteration_systematics_%dGeVCut_ak%d%s_%d.pdf",unfoldingCut,radius,jet_type,date.GetDate()),"RECREATE");
  ...
  drawText(Form("Anti-k_{T} %s %s Jets R=0.%d",algo, jet_type, radius),0.2,0.23,20);
  drawText("|#eta|<2, |vz|<15",0.6,0.31,20);
  cRAA_JEC_sys->SaveAs(Form("Plots/RAA_JEC_systematics_unfoldingCut%dGeV_ak%s%d%s_%d.pdf",unfoldingCut, algo, radius, jet_type, date.GetDate()),"RECREATE");
  ...
  drawText(Form("Anti-k_{T} %s %s Jets R=0.%d",algo, jet_type, radius),0.2,0.23,20);
  drawText("|#eta|<2, |vz|<15",0.6,0.31,20);
  cRAA_Smear_sys->SaveAs(Form("Plots/RAA_Smear_systematics_unfoldingCut%dGeV_ak%s%d%s_%d.pdf",unfoldingCut, algo, radius, jet_type, date.GetDate()));
  ...
  putCMSPrel();
  linePbPb_iter->Draw();
  cSys->SaveAs(Form("Plots/RAA_total_systematics_unfoldingCut%dGeV_ak%s%d%s_%d.pdf",unfoldingCut, algo, radius, jet_type, date.GetDate()),"RECREATE");
