...
void RAA_plot_CutA_BasicPlots(){
  ...
  Float_t ptCutMC = 30;
  Float_t ptCutData = 30;
  Float_t ptCutHydjetMC = 30;
  Float_t ptCutMinBiasData = 30;
  Float_t ptCutCentralData = 30;
  Float_t ptCutCentralMC = 30;
...
if(pfpt_1>=ptCutData){
   ...
   hData_noCut_phi_cent[cBin]->Fill(pfphi_1);
   hData_noCut_phi_eta->Fill(pfeta_1,pfphi_1);
    if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && eMax_1/Sumcand < ((Float_t)18/7 *(Float_t)calopt_1/pfpt_1 - (Float_t)9/7)) {
   hData_CutA_eta->Fill(pfeta_1);
   hData_CutA_phi->Fill(pfphi_1);
   hData_CutA_eta_cent[cBin]->Fill(pfeta_1);
   hData_CutA_phi_cent[cBin]->Fill(pfphi_1);
   hData_CutA_phi_eta->Fill(pfeta_1,pfphi_1);
    }
   ...
   hData_CutA_phi_cent[cBin]->Fill(pfphi_1);
    ...
    if(jet55_1 == 1 && jet65_1 == 0 && jet80_1 == 0 ) { //jet 55 matched
      
      hData_Jet55_noCut->Fill(pfpt_1, jet55_p_1);
	  hData_Jet55_noCut_eta->Fill(pfeta_1,jet55_p_1);
	  ...
	  hData_Jet55_CutA_eta->Fill(pfeta_1,jet55_p_1);
      ...
      if(calopt_1/pfpt_1 > 0.85) {
		  hData_Jet55_CutA->Fill(pfpt_1, jet55_p_1);
	  hData_Jet55_CutA_eta->Fill(pfeta_1);
	  hData_Jet55_CutA_phi->Fill(pfphi_1);
    ...
    if(jet65_1 == 1 && jet80_1 == 0 ) { //Jet 65 matched
      
      hData_Jet65_noCut->Fill(pfpt_1);
      hData_Jet65_noCut_eta->Fill(pfeta_1);
	  ...
	  hData_Jet65_CutA_eta->Fill(pfeta_1);
    ...
    if(jet80_1 == 1) {  //jet 80 matched
    
      hData_Jet80_noCut->Fill(pfpt_1);
      hData_Jet80_noCut_eta->Fill(pfeta_1);
      ...
      if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && eMax_1/Sumcand < ((Float_t)18/7 *(Float_t)calopt_1/pfpt_1 - (Float_t)9/7)) {
		  ...
		  hData_Jet80_CutA_eta->Fill(pfeta_1);
 ...
 if(pfpt_1>=ptCutData){
   ...
   hData_CutA_phi_eta->Fill(pfeta_1,pfphi_1);
    ...
    if(jet55_1 == 1 && jet65_1 == 0 && jet80_1 == 0 ) {  //jet55 unmatched
    
      hData_unmatched_Jet55_noCut->Fill(pfpt_1, jet55_p_1);
	  hData_Jet55_noCut_eta->Fill(pfeta_1, jet55_p_1); //added prescale here Apr 9 2015
 ...
 if(pfpt_2>=ptCutMC){
   ...
   hMC_noCut_phi_cent[cBin]->Fill(pfphi_2,weight);
   hMC_noCut_phi_eta->Fill(pfeta_2,pfphi_2,weight);
  
    if(calopt_2/pfpt_2 > 0.5 && calopt_2/pfpt_2 <= 0.85 && eMax_2/Sumcand < ((Float_t)18/7 *(Float_t)calopt_2/pfpt_2 - (Float_t)9/7)) {
   hMC_CutA_eta->Fill(pfeta_2,weight);
   hMC_CutA_phi->Fill(pfphi_2,weight);
   hMC_CutA_eta_cent[cBin]->Fill(pfeta_2,weight);
   hMC_CutA_phi_cent[cBin]->Fill(pfphi_2,weight);
      hMC_CutA_phi_eta->Fill(pfeta_2,pfphi_2,weight);
   ...
   hMC_CutA_phi_eta->Fill(pfeta_2,pfphi_2,weight);
    ...
    if(jet55_2 == 1 && jet65_2==0 && jet80_2 == 0){
	  ...
	  hMC_Jet55_noCut_eta->Fill(pfeta_2, weight);
	  hMC_Jet55_noCut_phi->Fill(pfphi_2, weight);
 	  hMC_Jet55_noCut_eta_cent[cBin]->Fill(pfeta_2, weight);
	  hMC_Jet55_noCut_phi_cent[cBin]->Fill(pfphi_2, weight);
	  hMC_Jet55_noCut_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
      if(calopt_2/pfpt_2 > 0.5 && calopt_2/pfpt_2 <= 0.85 && eMax_2/Sumcand < ((Float_t)18/7 *(Float_t)calopt_2/pfpt_2 - (Float_t)9/7)){
	...
	hpbpb_matrix_HLT[cBin]->Fill(pfrefpt_2, pfpt_2, weight);
	  hMC_Jet55_CutA_eta->Fill(pfeta_2, weight);
	  hMC_Jet55_CutA_phi->Fill(pfphi_2, weight);
 	  hMC_Jet55_CutA_eta_cent[cBin]->Fill(pfeta_2, weight);
	  hMC_Jet55_CutA_phi_cent[cBin]->Fill(pfphi_2, weight); 
	  hMC_Jet55_CutA_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
    ...
    if(jet65_2 == 1 && jet80_2 == 0){
      ...
      hMC_Jet65_noCut_eta->Fill(pfeta_2,weight);
      hMC_Jet65_noCut_phi->Fill(pfphi_2,weight);
      hMC_Jet65_noCut_eta_cent[cBin]->Fill(pfeta_2,weight);
      hMC_Jet65_noCut_phi_cent[cBin]->Fill(pfphi_2,weight);
      hMC_Jet65_noCut_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
	...
	hpbpb_matrix_HLT[cBin]->Fill(pfrefpt_2, pfpt_2, weight);
      hMC_Jet65_CutA_eta->Fill(pfeta_2,weight);
      hMC_Jet65_CutA_phi->Fill(pfphi_2,weight);
      hMC_Jet65_CutA_eta_cent[cBin]->Fill(pfeta_2,weight);
      hMC_Jet65_CutA_phi_cent[cBin]->Fill(pfphi_2,weight);
      hMC_Jet65_CutA_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
    ...
    if(jet80_2 == 1){
      ...
      hMC_Jet80_noCut_eta->Fill(pfeta_2,weight);
      hMC_Jet80_noCut_phi->Fill(pfphi_2,weight);
      hMC_Jet80_noCut_eta_cent[cBin]->Fill(pfeta_2,weight);
      hMC_Jet80_noCut_phi_cent[cBin]->Fill(pfphi_2,weight);
      hMC_Jet80_noCut_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
	...
	hpbpb_matrix_HLT[cBin]->Fill(pfrefpt_2, pfpt_2, weight);
      hMC_Jet80_CutA_eta->Fill(pfeta_2,weight);
      hMC_Jet80_CutA_phi->Fill(pfphi_2,weight);
      hMC_Jet80_CutA_eta_cent[cBin]->Fill(pfeta_2,weight);
      hMC_Jet80_CutA_phi_cent[cBin]->Fill(pfphi_2,weight);
      hMC_Jet80_CutA_JetpTeta[cBin]->Fill(pfeta_2,pfpt_2,weight);
 ...
 if(pfpt_2>=ptCutMC){
  ...
  TFile fout(Form("PbPb_BasicPlotsCutA_matched_slantedlinecalopfpt_addingunmatched_exclusionhighertriggers_eMaxSumcand_A_R0p%d.root",radius),"RECREATE");
 fout.cd();
  ...
  for(int i = 0; i<nbins_cent;++i){ //Write centrality histograms
	...
	cmatrix_HTL[i]->SaveAs(Form("Plots/hpbpb_MCmatrix_HLT_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
	...
	cPbPb_pteta_noCut[i]->SaveAs(Form("Plots/hData_pTeta_noCut_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
	...
	cPbPb_pteta_CutA[i]->SaveAs(Form("Plots/hData_pTeta_CutA_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
	...
	cMC_pteta_noCut[i]->SaveAs(Form("Plots/hMC_pTeta_noCut_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
	cMC_pteta_CutA[i]->cd();
	...
	cMC_pteta_CutA[i]->SaveAs(Form("Plots/hMC_pTeta_CutA_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
...
//WRITE Phi vs Eta dist.
 ...
 cMC_noCut_phi_eta->SaveAs(Form("Plots/MC_noCut_phi_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
 
 TCanvas * cMC_CutA_phi_eta = new TCanvas("cMC_noCut_phi_eta","",1000,800);
 cMC_CutA_phi_eta->cd();
 hMC_CutA_phi_eta->Write(); 
 hMC_CutA_phi_eta->Draw("colz"); 
 cMC_CutA_phi_eta->SaveAs(Form("Plots/MC_CutA_phi_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
 ...
 cPbPb_noCut_phi_eta->SaveAs(Form("Plots/Data_noCut_phi_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
 ...
 cPbPb_CutA_phi_eta->SaveAs(Form("Plots/Data_CutA_phi_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
...
//  hMC_Jet80_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet80_CutEfficiency_Jet80->SaveAs(Form("Plots/PbPb_YetkinCuts_Jet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_R0p%d_zoomed.pdf",radius));
 cJet80_CutEfficiency_Jet80->Close();
  ...
  // cCutRejection_Jet80->SaveAs("Plots/PbPb_YetkinCuts_Jet80_eMaxSumcand_A_chMaxJtpt_calopfpt_rejection.pdf","RECREATE");
...
//  hMC_Jet55_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet55_CutEfficiency_Jet55->SaveAs(Form("Plots/PbPb_YetkinCuts_Jet55_noJet65noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_including_unmatched_R0p%d_zoomed.pdf",radius));
  ...
  // cCutRejection_Jet55->SaveAs("Plots/PbPb_YetkinCuts_Jet55_noJet65noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_rejection_including_unmatched.pdf","RECREATE");
...
//  hMC_Jet65_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet65_CutEfficiency_Jet65->SaveAs(Form("Plots/PbPb_YetkinCuts_Jet65_noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_including_unmatched_R0p%d_zoomed.pdf",radius));
cJet65_CutEfficiency_Jet65->Close();
  ...
  // cCutRejection_Jet65->SaveAs("Plots/PbPb_YetkinCuts_Jet65_noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_rejection_including_unmatched.pdf","RECREATE");
  ...
  cCombinedEff->SaveAs(Form("Plots/Combined_trigger_efficiency_YetkinCut_R0p%d.pdf",radius));
  cCombinedEff->Close();
  ...
  cTriggerCombination->SaveAs(Form("Plots/TriggerCombination_YetkinCuts_R0%d.pdf",radius));
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cenoCut_eta_cent[i]->SaveAs(Form("Plots/NoCuts_eta_R%d_cent%d_MCweight.pdf",radius,i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cenoCut_phi_cent[i]->SaveAs(Form("Plots/NoCuts_R%d_phi_cent%d_MCweight.pdf",radius,i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceCutA_eta_cent[i]->SaveAs(Form("Plots/CutA_R%d_eta_cent%d_MCweight.pdf",radius,i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceCutA_phi_cent[i]->SaveAs(Form("Plots/CutA_R%d_phi_cent%d_MCweight.pdf",radius,i),"RECREATE");
...
// 	hData_Jet80_noCut_JetpTeta[i]->Draw("colz");
// 	  }
// 	  cPbPb_pteta80_noCut->SaveAs(Form("Plots/hData_pTeta80_noCut_R%d_n20_eta_p20_allcent.pdf",radius),"RECREATE");
