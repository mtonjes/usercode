...
void RAA_plot_CutA_BasicPlots(){
  ...
  if(radius == 2) fData = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_Data_calo_pf_jet_correlation_deltaR_0p2_akPu2_20150331.root");
  if(radius == 3) fData = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_Data_calo_pf_jet_correlation_deltaR_0p2_akPu3_20150331.root");
  if(radius == 4) fData = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_Data_calo_pf_jet_correlation_deltaR_0p2_akPu4_20150331.root");

  if(radius == 2) fMC = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_MC_calo_pf_jet_correlation_deltaR_0p2_akPu2_20150331.root");
  if(radius == 3) fMC = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_MC_calo_pf_jet_correlation_deltaR_0p2_akPu3_20150331.root");
  if(radius == 4) fMC = TFile::Open("/data/users/belt/JetRAA/MatchNtuples/PbPb_MC_calo_pf_jet_correlation_deltaR_0p2_akPu4_20150331.root");
...
// non-centrality based
  ...
  TH1F * hData_Jet55_noCut_eta = new TH1F("hData_Jet55_noCut_eta","",100,-2.5,2.5);
  TH1F * hData_Jet55_CutA_eta = new TH1F("hData_Jet55_CutA_eta","",100,-2.5,2.5);
  TH1F * hData_Jet65_noCut_eta = new TH1F("hData_Jet65_noCut_eta","",100,-2.5,2.5);
  TH1F * hData_Jet65_CutA_eta = new TH1F("hData_Jet65_CutA_eta","",100,-2.5,2.5);
  TH1F * hData_Jet80_noCut_eta = new TH1F("hData_Jet80_noCut_eta","",100,-2.5,2.5);
  TH1F * hData_Jet80_CutA_eta = new TH1F("hData_Jet80_CutA_eta","",100,-2.5,2.5);

  TH1F * hData_noCut_phi = new TH1F("hData_noCut_phi","",100,-4,4);
  TH1F * hData_CutA_phi = new TH1F("hData_CutA_phi","",100,-4,4);

  TH1F * hData_Jet55_noCut_phi = new TH1F("hData_Jet55_noCut_phi","",100,-4,4);
  TH1F * hData_Jet55_CutA_phi = new TH1F("hData_Jet55_CutA_phi","",100,-4,4);
  TH1F * hData_Jet65_noCut_phi = new TH1F("hData_Jet65_noCut_phi","",100,-4,4);
  TH1F * hData_Jet65_CutA_phi = new TH1F("hData_Jet65_CutA_phi","",100,-4,4);
  TH1F * hData_Jet80_noCut_phi = new TH1F("hData_Jet80_noCut_phi","",100,-4,4);
  TH1F * hData_Jet80_CutA_phi = new TH1F("hData_Jet80_CutA_phi","",100,-4,4);
  ...
  TH2F * hData_CutA_phi_eta = new TH2F("hData_CutA_phi_eta","",100,-2.5,2.5,100,-pi,pi);
   ...
   TH1F * hMC_noCut_eta = new TH1F("hMC_noCut_eta","",100,-2.5,2.5);
   TH1F * hMC_CutA_eta = new TH1F("hMC_CutA_eta","",100,-2.5,2.5);

  TH1F * hMC_Jet55_noCut_eta = new TH1F("hMC_Jet55_noCut_eta","",100,-2.5,2.5);
  TH1F * hMC_Jet55_CutA_eta = new TH1F("hMC_Jet55_CutA_eta","",100,-2.5,2.5);
  TH1F * hMC_Jet65_noCut_eta = new TH1F("hMC_Jet65_noCut_eta","",100,-2.5,2.5);
  TH1F * hMC_Jet65_CutA_eta = new TH1F("hMC_Jet65_CutA_eta","",100,-2.5,2.5);
  TH1F * hMC_Jet80_noCut_eta = new TH1F("hMC_Jet80_noCut_eta","",100,-2.5,2.5);
  TH1F * hMC_Jet80_CutA_eta = new TH1F("hMC_Jet80_CutA_eta","",100,-2.5,2.5);

  TH1F * hMC_noCut_phi = new TH1F("hMC_noCut_phi","",100,-4,4);
  TH1F * hMC_CutA_phi = new TH1F("hMC_CutA_phi","",100,-4,4);

  TH1F * hMC_Jet55_noCut_phi = new TH1F("hMC_Jet55_noCut_phi","",100,-4,4);
  TH1F * hMC_Jet55_CutA_phi = new TH1F("hMC_Jet55_CutA_phi","",100,-4,4);
  TH1F * hMC_Jet65_noCut_phi = new TH1F("hMC_Jet65_noCut_phi","",100,-4,4);
  TH1F * hMC_Jet65_CutA_phi = new TH1F("hMC_Jet65_CutA_phi","",100,-4,4);
  TH1F * hMC_Jet80_noCut_phi = new TH1F("hMC_Jet80_noCut_phi","",100,-4,4);
  TH1F * hMC_Jet80_CutA_phi = new TH1F("hMC_Jet80_CutA_phi","",100,-4,4);
  ...
  for(long nentry = 0; nentry < entries; ++nentry ){
   ...
   hData_CutA_phi_cent[cBin]->Fill(pfphi_1);
    ...
    if(jet55_1 == 1 && jet65_1 == 0 && jet80_1 == 0 ) {
	  ...
	  hData_Jet55_noCut_eta->Fill(pfeta_1);
	  hData_Jet55_noCut_phi->Fill(pfphi_1);
 	  hData_Jet55_noCut_eta_cent[cBin]->Fill(pfeta_1);
	  hData_Jet55_noCut_phi_cent[cBin]->Fill(pfphi_1); 
...
//  hMC_Jet80_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet80_CutEfficiency_Jet80->SaveAs(Form("PbPb_YetkinCuts_Jet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_R0p%d_zoomed.pdf",radius));
...
//  hMC_Jet55_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet55_CutEfficiency_Jet55->SaveAs(Form("PbPb_YetkinCuts_Jet55_noJet65noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_including_unmatched_R0p%d_zoomed.pdf",radius));
...
//  hMC_Jet65_CutA_eff->SetAxisRange(0.85,1.1,"Y");
  ...
  cJet65_CutEfficiency_Jet65->SaveAs(Form("PbPb_YetkinCuts_Jet65_noJet80_eMaxSumcand_A_chMaxJtpt_calopfpt_Eff_including_unmatched_R0p%d_zoomed.pdf",radius));
cJet65_CutEfficiency_Jet65->Close();
  ...
  cCombinedEff->SaveAs(Form("Combined_trigger_efficiency_YetkinCut_R0p%d.pdf",radius));
  cCombinedEff->Close();
  ...
  cTriggerCombination->SaveAs(Form("TriggerCombination_YetkinCuts_R0p%d.pdf",radius));
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cenoCut_eta_cent[i]->SaveAs(Form("NoCuts_eta_cent%d_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    cenoCut_phi_cent[i]->SaveAs(Form("NoCuts_phi_cent%d_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceCutA_eta_cent[i]->SaveAs(Form("CutA_eta_cent%d_MCweight.pdf",i),"RECREATE");
  ...
  for(int i = 0 ; i < nbins_cent ; ++i){
    ...
    ceCutA_phi_cent[i]->SaveAs(Form("CutA_phi_cent%d_MCweight.pdf",i),"RECREATE");
