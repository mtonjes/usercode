// run with: root -l 'comparison_with_ATLAS_pp_SVD_17Sep2015.C(10,40,310,"")'
#include <iostream>
#include <stdio.h>
#include <fstream>
#include <fstream>
...
void comparison_with_ATLAS_pp_SVD_17Sep2015(Int_t nfit=6, Int_t FitStart=60, Int_t FitEnd=300, Option_t *FitOpt="IWL"){
     TH1::SetDefaultSumw2();
   gStyle->SetOptFit(1);
