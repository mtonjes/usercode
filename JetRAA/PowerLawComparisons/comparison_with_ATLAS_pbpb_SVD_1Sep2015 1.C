...
//root -l 'comparison_with_ATLAS_pbpb_SVD_1Sep2015.C(10,60,280,"")'
...
// ------------>Primitives in pad: cATLAS_HistComp_2 PERIPHERAL
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("uPbPb_R4_ATLASComp_cent5","CMS PbPb 70-90%, R=0.4, pow","pl");
   ...
   entry=leg->AddEntry("uATLAS_PbPb_R4_cent7","ATLAS PbPb 70-80%, R=0.4, pow","pl");
...
// ------------>Primitives in pad: cATLAS_HistComp_3 50-60 or 50-70%
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("uPbPb_R4_ATLASComp_cent4","CMS PbPb 50-70%, R=0.4, pow","pl");
   ...
   entry->SetMarkerStyle(27);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("uATLAS_PbPb_R4_cent5","ATLAS PbPb 50-60%, R=0.4, pow","pl");
...
// ------------>Primitives in pad: cATLAS_HistComp_4
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("uPbPb_R4_ATLASComp_cent3","CMS PbPb 30-50%, R=0.4, pow","pl");
   ...
   entry->SetMarkerStyle(27);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("uATLAS_PbPb_R4_cent3","ATLAS PbPb 30-40%, R=0.4, pow","pl");
...
// ------------>Primitives in pad: cATLAS_HistComp_5 10-20 or 10-30%
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("uPbPb_R4_ATLASComp_cent2","CMS PbPb 10-30%, R=0.4, pow","pl");
   ...
   entry->SetMarkerStyle(27);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("uATLAS_PbPb_R4_cent1","ATLAS PbPb 10-20%, R=0.4, pow","pl");
...
// ------------>Primitives in pad: cATLAS_HistComp_6 0-5 or 0-10%
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("uPbPb_R4_ATLASComp_cent0","CMS PbPb 0-5%, R=0.4, pow","pl");
   ...
   entry->SetMarkerStyle(27);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("uATLAS_PbPb_R4_cent0","ATLAS PbPb 0-10%, R=0.4, pow","pl");
...
// Draw Ratios
   ...
   hRatioBlank->GetXaxis()->SetTitle("ak R=0.4, pow Jet p_{T} (GeV/c)");
...
// ------------>Primitives in pad: cATLAS_Ratio_2 PERIPHERAL
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("hFitRatioCMS_periph","CMS 70-90%/ATLAS 70-80%, R=0.4, pow","pl");
   leg->Draw();
...
// ------------>Primitives in pad: cATLAS_Ratio_3 50-60 or 50-70%
 ...
 //  hFitRatioCMS_midperiph->GetXAxis()->SetRangeUser(50,250); 
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("hFitRatioCMS_midperiph","CMS 50-70%/ATLAS 50-60%, R=0.4, pow","pl");
   leg->Draw();
...
// ------------>Primitives in pad: cATLAS_Ratio_4
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("hFitRatioCMS_midcent","CMS 30-50%/ATLAS 30-40%, R=0.4, pow","pl");
   leg->Draw();
...
// ------------>Primitives in pad: cATLAS_Ratio_5 10-20 or 10-30%
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("hFitRatioCMS_cent","CMS 10-30%/ATLAS 10-20%, R=0.4, pow","pl");
   leg->Draw();
...
// ------------>Primitives in pad: cATLAS_Ratio_6 0-5 or 0-10%
   ...
   leg->SetFillColor(19);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("hFitRatioCMS_mostcent","CMS 0-5%/ATLAS 0-10%, R=0.4, pow","pl");
   leg->Draw();
