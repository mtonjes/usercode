...
void RAA_NEWcomparisonwithPAS(char *algo = "Pu", char *jet_type = "PF", char * etaWidth = (char*) "20_eta_20"){
...
// set up a blank ratio histogram for later
   ...
   hRatioBlank->GetXaxis()->SetTitle("ak R=0.3 Jet p_{T} (GeV/c)");
...
//       hRatioNowPAS[1][i]->Divide(static_cast<TH1F*>(PbPb_measured_fine[1][i]));
 ...
 //   }
  ...
  cPbPb_sigma->SaveAs(Form("Plots/PbPb_spectra_newComparingwithPAS_ak%s3%s_%d.root",algo,jet_type,date.GetDate()),"RECREATE");
