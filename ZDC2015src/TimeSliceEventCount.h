...
#ifndef TimeSliceEventCount_h
#define TimeSliceEventCount_h
...
public :
   ...
   TimeSliceEventCount(TTree *tree=0);
   virtual ~TimeSliceEventCount();
...
TimeSliceEventCount::~TimeSliceEventCount()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TimeSliceEventCount::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TimeSliceEventCount::LoadTree(Long64_t entry)
{
...
void TimeSliceEventCount::Init(TTree *tree)
{
...
Bool_t TimeSliceEventCount::Notify()
{
...
void TimeSliceEventCount::Show(Long64_t entry)
{
...
Int_t TimeSliceEventCount::Cut(Long64_t entry)
{
...
#endif // #ifdef TimeSliceEventCount_cxx
