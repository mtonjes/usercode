// -*- C++ -*-
//
// Package:    ZSP_PuAnalyzer_range
// Class:      ZSP_PuAnalyzer_range
// 
/**\class ZSP_PuAnalyzer_range ZSP_PuAnalyzer_range.cc MTonjes/JetMatchAna/src/ZSP_PuAnalyzer_range.cc
...
class ZSP_PuAnalyzer_range : public edm::EDAnalyzer {
   public:
      explicit ZSP_PuAnalyzer_range(const edm::ParameterSet&);
      ~ZSP_PuAnalyzer_range();
...
//    TH1F*       hAllGenJets_pt_etacut0;
    ...
    TH1F*		hAllZSPiC5Jets_et;
    TH1F*		hMatchGenJets_dRltpt2_et;
     TH1F*		hMatchGenJets_dRltpt1_et;   
    TH1F*		hMatchGenJets_et;
    TH1F*		hMatchZSPiC5Jets_dRltpt2_et;
    TH1F*		hMatchZSPiC5Jets_dRltpt1_et;
    TH1F*		hMatchZSPiC5Jets_et;  
 
    TH1F*		hAllZSPiC5Jets_et_etacut0;
    TH1F*		hMatchGenJets_dRltpt2_et_etacut0;
    TH1F*		hMatchGenJets_dRltpt1_et_etacut0;    
    TH1F*		hMatchGenJets_et_etacut0;
    TH1F*		hMatchZSPiC5Jets_dRltpt2_et_etacut0;
    TH1F*		hMatchZSPiC5Jets_dRltpt1_et_etacut0;    
    TH1F*		hMatchZSPiC5Jets_et_etacut0;  
  
    TH1F*       hAllGenJets_pt;
    TH1F*		hAllZSPiC5Jets_pt;
    TH1F*		hMatchGenJets_dRltpt2_pt;
    TH1F*		hMatchGenJets_dRltpt1_pt;    
    TH1F*		hMatchGenJets_pt;
    TH1F*		hMatchZSPiC5Jets_dRltpt2_pt;
    TH1F*		hMatchZSPiC5Jets_dRltpt1_pt;
    TH1F*		hMatchZSPiC5Jets_pt;  
    TH1F*       hUnMatchedZSPiC5Jets_pt;
    TH1F*       hUnMatchedZSPiC5Jets_pt_etacut0;
    TH1F*       hUnMatchedZSPiC5Jets_pt_etacut1;
    
    Int_t    ZSPiC5Jets_unmatchstat[100];
    Double_t    ZSPiC5Jets_eta_unmatch[100];
    Double_t    ZSPiC5Jets_pt_unmatch[100];
    
    TH1F*       hUnMatchedZSPiC5Jets_eta;
    TH1F*       hUnMatchedZSPiC5Jets_eta_etacut0;
    TH1F*       hUnMatchedZSPiC5Jets_eta_etacut1;
//    TH1F*       hUnMatchedZSPiC5Jets_dRltpt2_et;
//    TH1F*       hUnMatchedZSPiC5Jets_dRltpt2_et_etacut0;
//    TH1F*       hUnMatchedZSPiC5Jets_dRltpt2_et_etacut1;
//    TH1F* 		hMatchedGenGNumEv_pt_Ratio;

    TH1F*		hMatchGenJets_pt_etacut0;
    TH1F*		hAllZSPiC5Jets_pt_etacut0;
    TH1F*       hAllGenJets_pt_etacut0;
    TH1F*		hMatchGenJets_dRltpt2_pt_etacut0;
    TH1F*		hMatchZSPiC5Jets_dRltpt2_pt_etacut0;
    TH1F*		hMatchGenJets_dRltpt1_pt_etacut0;
    TH1F*		hMatchZSPiC5Jets_dRltpt1_pt_etacut0;
    TH1F*		hMatchZSPiC5Jets_pt_etacut0;     
//    TH1F* 		hMatchedGenGNumEv_pt_Ratio_etacut0;

 // endcap plots
    TH1F*       hAllGenJets_et_etacut1;
    TH1F*		hAllZSPiC5Jets_et_etacut1;
    TH1F*		hMatchGenJets_dRltpt2_et_etacut1;
    TH1F*		hMatchGenJets_dRltpt1_et_etacut1;
    TH1F*		hMatchGenJets_et_etacut1;
    TH1F*		hMatchZSPiC5Jets_dRltpt2_et_etacut1;
    TH1F*		hMatchZSPiC5Jets_dRltpt1_et_etacut1;
    TH1F*		hMatchZSPiC5Jets_et_etacut1;     
//    TH1F* 		hMatchedGenGNumEv_et_Ratio_etacut1;  
    
     TH1F*       hAllGenJets_pt_etacut1;
     TH1F*		hAllZSPiC5Jets_pt_etacut1;
     TH1F*		hMatchGenJets_dRltpt2_pt_etacut1;
     TH1F*		hMatchGenJets_pt_etacut1;
     TH1F*		hMatchZSPiC5Jets_dRltpt2_pt_etacut1;
     TH1F*		hMatchZSPiC5Jets_pt_etacut1;     
...
//    TH1F* 		hMatchedGenNumEv_Ratio; // (# matched ZSPiC5 Jets)/(# All GenJets)
...
//    TH1F*		hMatchedCaloNumEv_Ratio; // (# matched ZSPiC5 Jets)/(# All ZSPiC5 Jets)
//    TH1F*		hMatchedGCaloNumEv_Ratio; // (# matched GenJets)/(# All ZSPiC5 Jets)
    TH2F*		hRecoVsGen_pt;
    TH2F*		hRecoVsGen_et;
    TH2F*		hRecoVsGen_eta;
    TH2F*		hRecoVsGen_phi;
...
//
ZSP_PuAnalyzer_range::ZSP_PuAnalyzer_range(const edm::ParameterSet& iConfig)
...
int ZSP_PuAnalyzer_range::determineIndex(Double_t* limBins, Double_t data, unsigned int nbreBins)
{
...
ZSP_PuAnalyzer_range::~ZSP_PuAnalyzer_range()
{
...
void
ZSP_PuAnalyzer_range::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
//   Double_t limBins4[]  = {1,5,10,15,20,30,40};
  ...
  cout << "[ZSP_PuAnalyzer_range] analysing event " << iEvent.id() << endl;
  HaveMatchMap = kTRUE;
  try {
    iEvent.getByLabel (source_,source);
    iEvent.getByLabel (matched_,matched);
  } catch(std::exception& ce) {
    cerr << "[ZSP_PuAnalyzer_range] caught std::exception " << ce.what() << endl;
    return;   
  }
  try {
...
//     Double_t GenJetEt = ijet->et();
      ...
      if (fabs(GenEtaAll)<=1.3){
        ...
        cout<<"[ZSP_PuAnalyzer_range::analyze, have an endcap jet, will fill hAllGenJets_pt_etacut1 with pT: "<<ijet->pt()<<endl;
...
//     cout<<"   GenJetEt: "<<GenJetEt<<endl; 
  ...
  double RecoEtaAll = 990.; 
        for(int iset=0; iset<100; iset++){
          ZSPiC5Jets_unmatchstat[iset]=5;  // 0 = matched, 1 = unmatched, 5 = error
          ZSPiC5Jets_eta_unmatch[iset]=9999.;  // eta of those recojets corresponding to index above
          ZSPiC5Jets_pt_unmatch[iset]=0.;   // et of those recojets corresponding to index above  
        }
          Int_t totalZSPiC5Jets=0;
   for (CandidateCollection::const_iterator imjet=matched->begin(); imjet!=matched->end(); imjet++) {
 
       RecoEtaAll = imjet->eta();
      if(!HaveMatchMap){
        hUnMatchedZSPiC5Jets_pt->Fill(imjet->pt());
        hUnMatchedZSPiC5Jets_eta->Fill(imjet->eta());
          if (fabs(RecoEtaAll)<=1.3){
            hUnMatchedZSPiC5Jets_pt_etacut0->Fill(imjet->pt());         
            hUnMatchedZSPiC5Jets_eta_etacut0->Fill(imjet->eta());         
          } else if (fabs(RecoEtaAll) >1.3 && fabs(RecoEtaAll)<3){
            hUnMatchedZSPiC5Jets_pt_etacut1->Fill(imjet->pt());                   
            hUnMatchedZSPiC5Jets_eta_etacut1->Fill(imjet->eta());                   
          }
      } else {
          ZSPiC5Jets_unmatchstat[totalZSPiC5Jets]=1;
          ZSPiC5Jets_eta_unmatch[totalZSPiC5Jets]=imjet->eta();  // eta of those recojets corresponding to index above
          ZSPiC5Jets_pt_unmatch[totalZSPiC5Jets]=imjet->pt();   // et of those recojets corresponding to index above
          totalZSPiC5Jets++;
    }
      hAllZSPiC5Jets_et->Fill(imjet->et());     
      hAllZSPiC5Jets_pt->Fill(imjet->pt());
      if (fabs(RecoEtaAll)<=1.3){
        hAllZSPiC5Jets_et_etacut0->Fill(imjet->et());
        hAllZSPiC5Jets_pt_etacut0->Fill(imjet->pt());
     } else if (fabs(RecoEtaAll) >1.3 && fabs(RecoEtaAll)<3){
        cout<<"[ZSP_PuAnalyzer_range::analyze, have an endcap jet, will fill hAllZSPiC5Jets_pt_etacut1 with pT: "<<imjet->pt()<<endl;
        hAllZSPiC5Jets_et_etacut1->Fill(imjet->et());
        hAllZSPiC5Jets_pt_etacut1->Fill(imjet->pt());   
     }           
...
//   cout << "**********************" << endl;
  ...
  for( CandMatchMap::const_iterator f  = matchedjetsOne->begin();
      ...
      hdeltaR->Fill(dR);
//       printf("[ZSP_PuAnalyzer_range] (et,eta,phi) source = %6.2f %5.2f %5.2f matched = %6.2f %5.2f %5.2f dR=%5.3f\n",
// 	     sourceRef->et(),
// 	     sourceRef->eta(),
// 	     sourceRef->phi(), 
// 	     matchRef->et(), 
...
// 	     matchRef->phi(), 
// 	     dR);
//      printf("[ZSP_PuAnalyzer_range] (pt) source = %6.2f matched = %6.2f dR=%5.3f\n",
// 	     sourceRef->pt(),
// 	     matchRef->pt(), 
// 	     dR);
      ...
      hMatchZSPiC5Jets_et->Fill(matchRef->et());    
      hMatchGenJets_pt->Fill(sourceRef->pt());
      hMatchZSPiC5Jets_pt->Fill(matchRef->pt());
      ...
      if (dR<=0.2){
          ...
          hMatchZSPiC5Jets_dRltpt2_et->Fill(matchRef->et());
          hMatchGenJets_dRltpt2_pt->Fill(sourceRef->pt());
          hMatchZSPiC5Jets_dRltpt2_pt->Fill(matchRef->pt());
          ...
          for(int imatched = 0;imatched<totalZSPiC5Jets;imatched++){
             if(ZSPiC5Jets_pt_unmatch[imatched]==matchRef->pt()) {
                ZSPiC5Jets_unmatchstat[imatched]=0;
             }
          }
...
//	      cout<<"did pthist"<<endl;
        if (dR<=0.1){
          ...
          hMatchZSPiC5Jets_dRltpt1_et->Fill(matchRef->et());
          hMatchGenJets_dRltpt1_pt->Fill(sourceRef->pt());
          hMatchZSPiC5Jets_dRltpt1_pt->Fill(matchRef->pt());
...
//         hUnMatchedZSPiC5Jets_pt->Fill(matchRef->et());
//         hUnMatchedZSPiC5Jets_eta->Fill(matchRef->eta());
//           if (fabs(RecoEta)<=1.3){
//             hUnMatchedZSPiC5Jets_pt_etacut0->Fill(matchRef->et());         
//             hUnMatchedZSPiC5Jets_eta_etacut0->Fill(matchRef->eta());         
//           } else if (fabs(RecoEta) >1.3 && fabs(RecoEta)<3){
//             hUnMatchedZSPiC5Jets_eta_etacut1->Fill(matchRef->eta());                   
//             hUnMatchedZSPiC5Jets_eta_etacut1->Fill(matchRef->eta());                   
//           }
      }
 // Barrel     
    if(fabs(GenEta)<=1.3){
      ...
      hMatchZSPiC5Jets_et_etacut0->Fill(matchRef->et());    
      
      hMatchGenJets_pt_etacut0->Fill(sourceRef->pt());
      hMatchZSPiC5Jets_pt_etacut0->Fill(matchRef->pt());  
     ...
     if(dR<=0.2) {
          ...
          hMatchZSPiC5Jets_dRltpt2_et_etacut0->Fill(matchRef->et());
          hMatchGenJets_dRltpt2_pt_etacut0->Fill(sourceRef->pt());
          hMatchZSPiC5Jets_dRltpt2_pt_etacut0->Fill(matchRef->pt());
	      ...
	      if(dR<=0.1){
            ...
            hMatchZSPiC5Jets_dRltpt1_et_etacut0->Fill(matchRef->et());
            hMatchGenJets_dRltpt1_pt_etacut0->Fill(sourceRef->pt());
            hMatchZSPiC5Jets_dRltpt1_pt_etacut0->Fill(matchRef->pt());	      	      
	      }
...
// endcap
      ...
      hMatchZSPiC5Jets_et_etacut1->Fill(matchRef->et());    
      
      hMatchGenJets_pt_etacut1->Fill(sourceRef->pt());
//      hMatchZSPiC5Jets_pt_etacut1->Fill(matchRef->pt());  
...
//          Double_t ResFrac_etacut1=(matchRef->et())/(sourceRef->et());
   //       hSimpleResolution_Energy_etacut1->Fill(sourceRef->et(),ResFrac_etacut1);
        cout<<"[ZSP_PuAnalyzer_range::analyze, have a matched endcap jet DeltaR<=0.1, will fill hMatchGenJets_dRltpt2_pt_etacut1 with Et: "<<sourceRef->pt()<<" and hMatchZSPiC5Jets_dRltpt2_pt_etacut1 with pT: "<<matchRef->pt()<<endl;
          hMatchGenJets_dRltpt2_et_etacut1->Fill(sourceRef->et());
          hMatchZSPiC5Jets_dRltpt2_et_etacut1->Fill(matchRef->et());
          hMatchGenJets_dRltpt2_pt_etacut1->Fill(sourceRef->pt());
          hMatchZSPiC5Jets_dRltpt2_pt_etacut1->Fill(matchRef->pt());
	      ...
	      if(dR<=0.1){
            ...
            hMatchZSPiC5Jets_dRltpt1_et_etacut1->Fill(matchRef->et());
	      }	      
     }  
    }
  }
   for(int imatchedjets = 0;imatchedjets<totalZSPiC5Jets;imatchedjets++){
      if(ZSPiC5Jets_unmatchstat[imatchedjets]==1) {
        hUnMatchedZSPiC5Jets_pt->Fill(ZSPiC5Jets_pt_unmatch[imatchedjets]);
        hUnMatchedZSPiC5Jets_eta->Fill(ZSPiC5Jets_eta_unmatch[imatchedjets]);
          if (fabs(ZSPiC5Jets_eta_unmatch[imatchedjets])<=1.3){
            hUnMatchedZSPiC5Jets_pt_etacut0->Fill(ZSPiC5Jets_pt_unmatch[imatchedjets]);         
            hUnMatchedZSPiC5Jets_eta_etacut0->Fill(ZSPiC5Jets_eta_unmatch[imatchedjets]);         
          } else if (fabs(ZSPiC5Jets_eta_unmatch[imatchedjets]) >1.3 && fabs(ZSPiC5Jets_eta_unmatch[imatchedjets])<3){
            hUnMatchedZSPiC5Jets_pt_etacut1->Fill(ZSPiC5Jets_pt_unmatch[imatchedjets]);                   
            hUnMatchedZSPiC5Jets_eta_etacut1->Fill(ZSPiC5Jets_eta_unmatch[imatchedjets]);                   
          }             
       } else if(ZSPiC5Jets_unmatchstat[imatchedjets]==5){
         cout<<"[ZSP_PuAnalyzer_range::analyze, Error (5) in ZSPiC5Jets_unmatchstat for imatchedjets = "<<imatchedjets<<endl;
       }
   }
 } else {
 ...
 cout<<"[ZSP_PuAnalyzer_range]:: end analyze"<<endl;
...
void 
ZSP_PuAnalyzer_range::beginJob(const edm::EventSetup&)
{
 cout<<"[ZSP_PuAnalyzer_range]:: start beginJob"<<endl;
   ...
   ratiopT = new TH1F ("ratiopT", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, all #eta",6,limBins2);
   ratiopT->Sumw2();
   sigmapTrpTm = new TH1F ("sigmapTrpTm", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmapTrpTm->Sumw2();
   ...
   ratiopTOld = new TH1F ("ratiopTOld", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T} (different bins), all #eta",13,limBinsOld2);
   ratiopTOld->Sumw2();
   sigmapTrpTmOld = new TH1F ("sigmapTrpTmOld", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), all #eta",13,limBinsOld2);
   ...
   ratiopT_dRltpt1 = new TH1F ("ratiopT_dRltpt1", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, all #eta, #DeltaR_{m}<=0.1",6,limBins2);
   ratiopT_dRltpt1->Sumw2();
   sigmapTrpTm_dRltpt1 = new TH1F ("sigmapTrpTm_dRltpt1", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.1, all #eta",6,limBins2);
   ...
   ratiopT_dRltpt1Old = new TH1F ("ratiopT_dRltpt1Old", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T} (different bins), all #eta, #DeltaR_{m}<=0.1",13,limBinsOld2);
   ratiopT_dRltpt1Old->Sumw2();
   sigmapTrpTm_dRltpt1Old = new TH1F ("sigmapTrpTm_dRltpt1Old", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.1 (diff bins), all #eta",13,limBinsOld2);
...
// barrel plots make:
   ratiopT_etacut0 = new TH1F ("ratiopT_etacut0", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, 0<= | #eta | <=1.3",6,limBins2);
   ratiopT_etacut0->Sumw2();
   sigmapTrpTm_etacut0 = new TH1F ("sigmapTrpTm_etacut0", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratiopT_etacut0Old = new TH1F ("ratiopT_etacut0Old", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T} (different bins), 0<= | #eta | <=1.3",13,limBinsOld2);
   ratiopT_etacut0Old->Sumw2();
   sigmapTrpTm_etacut0Old = new TH1F ("sigmapTrpTm_etacut0Old", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), 0<= | #eta | <=1.3",13,limBinsOld2);
...
// endcap plots make:
   ratiopT_etacut1 = new TH1F ("ratiopT_etacut1", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, 1.3 <| #eta | <3",6,limBins2);
   ratiopT_etacut1->Sumw2();
   sigmapTrpTm_etacut1 = new TH1F ("sigmapTrpTm_etacut1", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
   ...
   ratiopT_etacut1Old = new TH1F ("ratiopT_etacut1Old", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T} (different bins), 1.3 <| #eta | <3",13,limBinsOld2);
   ratiopT_etacut1Old->Sumw2();
   sigmapTrpTm_etacut1Old = new TH1F ("sigmapTrpTm_etacut1Old", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), 1.3 <| #eta | <3",13,limBinsOld2);
...
//
// position resolution:
   ratioeta = new TH1F ("ratioeta", "<|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|>, all #eta",6,limBins2);
   ratioeta->Sumw2();
   sigmaeta = new TH1F ("sigmaeta", "sigma(|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmaeta->Sumw2();  
    for (unsigned int indexH=0;indexH<6;indexH++)  {
   ...
   ratioeta_etacut0 = new TH1F ("ratioeta_etacut0", "<|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|>, 0<= | #eta | <=1.3",6,limBins2);
   ratioeta_etacut0->Sumw2();
   sigmaeta_etacut0 = new TH1F ("sigmaeta_etacut0", "sigma(|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratioeta_etacut1 = new TH1F ("ratioeta_etacut1", "<|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|>, 1.3 <| #eta | <3",6,limBins2);
   ratioeta_etacut1->Sumw2();
   sigmaeta_etacut1 = new TH1F ("sigmaeta_etacut1", "sigma(|#eta(ZSPCorJetICone5)|-|#eta(GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
   ...
   ratioPhi = new TH1F ("ratioPhi", "<#phi(ZSPCorJetICone5)-#phi(GenJets)>, all #eta",6,limBins2);
   ratioPhi->Sumw2();
   sigmaphi = new TH1F ("sigmaphi", "sigma(#phi(ZSPCorJetICone5)-#phi(GenJets)) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmaphi->Sumw2();  
    for (unsigned int indexH=0;indexH<6;indexH++)  {
   ...
   ratioPhi_etacut0 = new TH1F ("ratioPhi_etacut0", "<#phi(ZSPCorJetICone5)-#phi(GenJets)>, 0<= | #eta | <=1.3",6,limBins2);
   ratioPhi_etacut0->Sumw2();
   sigmaphi_etacut0 = new TH1F ("sigmaphi_etacut0", "sigma(#phi(ZSPCorJetICone5)-#phi(GenJets)) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratioPhi_etacut1 = new TH1F ("ratioPhi_etacut1", "<#phi(ZSPCorJetICone5)-#phi(GenJets)>, 1.3 <| #eta | <3",6,limBins2);
   ratioPhi_etacut1->Sumw2();
   sigmaphi_etacut1 = new TH1F ("sigmaphi_etacut1", "sigma(#phi(ZSPCorJetICone5)-#phi(GenJets)) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
...
//   hSimpleEfficiency_Energy = new TH2F("hSimpleEfficiency_Energy","(# matched jets)/(# All ZSPiC5 jets) vs. p_{T} Gen - matched OneToOne #DeltaR_{m}<=0.2",50,0,5,50,0,225);
///   hMatchedGenNumEv_Ratio = new TH1F("hMatchedGenNumEv_Ratio","(# matched ZSPiC5 Jets)/(# All GenJets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
//   hMatchedGenNumEv_Ratio->Sumw2();
 //  hMatchedCaloNumEv_Ratio = new TH1F("hMatchedCaloNumEv_Ratio","(# matched ZSPiC5 Jets)/(# All ZSPiC5 Jets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
//   hMatchedCaloNumEv_Ratio->Sumw2();
   ...
   hFakeRatio = new TH1F("hFakeRatio","(# unmatched ZSPCorICone5Jets)/(# All ZSPCorICone5Jets), All #eta",100,0,225);
   hFakeRatio->Sumw2();
   hFakeRatio_etacut0 = new TH1F("hFakeRatio_etacut0","(# unmatched ZSPCorICone5Jets)/(# All ZSPCorICone5Jets), 0<= | #eta | <=1.3",100,0,225);
   hFakeRatio_etacut0->Sumw2();
   hFakeRatio_etacut1 = new TH1F("hFakeRatio_etacut1","(# unmatched ZSPCorICone5Jets)/(# All ZSPCorICone5Jets), 1.3 <| #eta | <3",100,0,225);
   ...
   hMatchZSPiC5Jets_dRltpt2_et = new TH1F("hMatchZSPiC5Jets_dRltpt2_et","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchZSPiC5Jets_dRltpt2_et->Sumw2();
   hMatchZSPiC5Jets_et = new TH1F("hMatchZSPiC5Jets_et","GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchZSPiC5Jets_et->Sumw2();
   hAllZSPiC5Jets_et = new TH1F("hAllZSPiC5Jets_et","All ZSPCorJetICone5 E_{T}, All #eta",100,0,225);
   hAllZSPiC5Jets_et->Sumw2();   

   hUnMatchedZSPiC5Jets_pt = new TH1F("hUnMatchedZSPiC5Jets_pt","Unmatched ZSPCorJetICone5 p_{T}, All #eta",100,0,225);
//   hUnMatchedZSPiC5Jets_dRltpt2_et = new TH1F("hUnMatchedZSPiC5Jets_dRltpt2_et","Unmatched ZSPCorJetICone5 p_{T}, outside of #DeltaR_{m}<=0.2 cut, All #eta",100,0,225);
   hUnMatchedZSPiC5Jets_pt_etacut0 = new TH1F("hUnMatchedZSPiC5Jets_pt_etacut0","Unmatched ZSPCorJetICone5 p_{T}, 0<= | #eta | <=1.3",100,0,225);
//   hUnMatchedZSPiC5Jets_dRltpt2_et_etacut0 = new TH1F("hUnMatchedZSPiC5Jets_dRltpt2_et_etacut0","Unmatched ZSPCorJetICone5 p_{T}, outside of #DeltaR_{m}<=0.2 cut, 0<= | #eta | <=1.3",100,0,225);
   hUnMatchedZSPiC5Jets_pt_etacut1 = new TH1F("hUnMatchedZSPiC5Jets_pt_etacut1","Unmatched ZSPCorJetICone5 p_{T}, 1.3 <| #eta | <3",100,0,225);
//   hUnMatchedZSPiC5Jets_dRltpt2_et_etacut1 = new TH1F("hUnMatchedZSPiC5Jets_dRltpt2_et_etacut1","Unmatched ZSPCorJetICone5 p_{T}, outside of #DeltaR_{m}<=0.2 cut, 1.3 <| #eta | <3",100,0,225);

   hUnMatchedZSPiC5Jets_eta = new TH1F("hUnMatchedZSPiC5Jets_eta","Unmatched ZSPCorJetICone5 #eta, All #eta",100,-3,3);
   hUnMatchedZSPiC5Jets_eta_etacut0 = new TH1F("hUnMatchedZSPiC5Jets_eta_etacut0","Unmatched ZSPCorJetICone5 #eta, 0<= | #eta | <=1.3",100,-0.5,0.5);
   hUnMatchedZSPiC5Jets_eta_etacut1 = new TH1F("hUnMatchedZSPiC5Jets_eta_etacut1","Unmatched ZSPCorJetICone5 #eta, 1.3 <| #eta | <3",100,-2,2);
   ...
   hMatchZSPiC5Jets_dRltpt2_et_etacut0 = new TH1F("hMatchZSPiC5Jets_dRltpt2_et_etacut0","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_dRltpt2_et_etacut0->Sumw2();
   hMatchZSPiC5Jets_et_etacut0 = new TH1F("hMatchZSPiC5Jets_et_etacut0","GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_et_etacut0->Sumw2();
   hAllZSPiC5Jets_et_etacut0 = new TH1F("hAllZSPiC5Jets_et_etacut0","All ZSPCorJetICone5 E_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllZSPiC5Jets_et_etacut0->Sumw2();   
   ...
   hAllZSPiC5Jets_et_etacut1 = new TH1F("hAllZSPiC5Jets_et_etacut1","All ZSPCorJetICone5 E_{T}, 1.3 <| #eta | <3",100,0,225);
   hAllZSPiC5Jets_et_etacut1->Sumw2();
   hMatchZSPiC5Jets_dRltpt2_et_etacut1 = new TH1F("hMatchZSPiC5Jets_dRltpt2_et_etacut1","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
   hMatchZSPiC5Jets_dRltpt2_et_etacut1->Sumw2();
   hMatchZSPiC5Jets_et_etacut1 = new TH1F("hMatchZSPiC5Jets_et_etacut1","GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
   hMatchZSPiC5Jets_et_etacut1->Sumw2(); 
...
// pt plots
   ...
   hAllZSPiC5Jets_pt = new TH1F("hAllZSPiC5Jets_pt","All ZSPCorJetICone5 p_{T}, All #eta",100,0,225);
   hAllZSPiC5Jets_pt->Sumw2();
   hMatchZSPiC5Jets_pt = new TH1F("hMatchZSPiC5Jets_pt","GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchZSPiC5Jets_pt->Sumw2();
...
//   hMatchedGenGNumEv_pt_Ratio->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt2_pt = new TH1F("hMatchZSPiC5Jets_dRltpt2_pt","ZSPCorJetICone5 p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchZSPiC5Jets_dRltpt2_pt->Sumw2();
   ...
   hAllZSPiC5Jets_pt_etacut0 = new TH1F("hAllZSPiC5Jets_pt_etacut0","All ZSPCorJetICone5 p_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllZSPiC5Jets_pt_etacut0->Sumw2();
   hMatchZSPiC5Jets_pt_etacut0 = new TH1F("hMatchZSPiC5Jets_pt_etacut0","GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_pt_etacut0->Sumw2();
...
//   hMatchedGenGNumEv_pt_Ratio_etacut0->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt2_pt_etacut0 = new TH1F("hMatchZSPiC5Jets_dRltpt2_pt_etacut0","ZSPCorJetICone5 p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_dRltpt2_pt_etacut0->Sumw2();
   
    hAllGenJets_pt_etacut1 = new TH1F("hAllGenJets_pt_etacut1","All GenJets p_{T}, 1.3 <| #eta | <3",100,0,225);
    hAllGenJets_pt_etacut1->Sumw2();
    hAllZSPiC5Jets_pt_etacut1 = new TH1F("hAllZSPiC5Jets_pt_etacut1","All ZSPCorJetICone5 p_{T}, 1.3 <| #eta | <3",100,0,225);
    hAllZSPiC5Jets_pt_etacut1->Sumw2();

//     ratiopt = new TH1F ("ratiopt", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, 0<= | #eta | <=1.3",6, 0, 225);
//    ratiopt->Sumw2();
//    sigmapTrpTm_pt = new TH1F ("sigmapTrpTm_pt", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",7, 0, 225);
...
//      }
// 
//    ratiopt_etacut1 = new TH1F ("ratiopt_etacut1", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}, 1.3 <| #eta | <3",7, 0, 225);
//    ratiopt_etacut1->Sumw2();
//    sigmapTrpTm_pt_etacut1 = new TH1F ("sigmapTrpTm_pt_etacut1", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",7, 0, 225);
...
//      }
//      
//      ratioptOld = new TH1F ("ratioptOld", "p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T} (different bins)",13, 0, 350);
//    ratioptOld->Sumw2();
//    sigmapTrpTm_ptOld = new TH1F ("sigmapTrpTm_ptOld", "sigma(p^{ZSPCorJetICone5}_{T}/p^{GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins)",13, 0, 350);
...
//    hMatchedGenGNumEv_pt_Ratio_etacut1->Sumw2();
    ...
    hMatchZSPiC5Jets_dRltpt2_pt_etacut1 = new TH1F("hMatchZSPiC5Jets_dRltpt2_pt_etacut1","ZSPCorJetICone5 p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
    hMatchZSPiC5Jets_dRltpt2_pt_etacut1->Sumw2();
//    hMatchZSPiC5Jets_pt_etacut1 = new TH1F("hMatchZSPiC5Jets_pt_etacut1","GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
//    hMatchZSPiC5Jets_pt_etacut1->Sumw2();
   
   hRecoVsGen_et_etacut1 = new TH2F( "RecoVsGen_et_etacut1", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt_etacut1 = new TH2F( "RecoVsGen_pt_etacut1", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta_etacut1 = new TH2F( "RecoVsGen_eta_etacut1", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi_etacut1 = new TH2F( "RecoVsGen_phi_etacut1", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et_etacut1 = new TH2F( "RecoVsGen_dRltpt2_et_etacut1", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt_etacut1 = new TH2F( "RecoVsGen_dRltpt2_pt_etacut1", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta_etacut1 = new TH2F( "RecoVsGen_dRltpt2_eta_etacut1", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi_etacut1 = new TH2F( "RecoVsGen_dRltpt2_phi_etacut1", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );

 
   hRecoVsGen_et_etacut0 = new TH2F( "RecoVsGen_et_etacut0", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt_etacut0 = new TH2F( "RecoVsGen_pt_etacut0", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta_etacut0 = new TH2F( "RecoVsGen_eta_etacut0", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi_etacut0 = new TH2F( "RecoVsGen_phi_etacut0", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et_etacut0 = new TH2F( "RecoVsGen_dRltpt2_et_etacut0", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt_etacut0 = new TH2F( "RecoVsGen_dRltpt2_pt_etacut0", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta_etacut0 = new TH2F( "RecoVsGen_dRltpt2_eta_etacut0", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi_etacut0 = new TH2F( "RecoVsGen_dRltpt2_phi_etacut0", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
 
   hRecoVsGen_et = new TH2F( "RecoVsGen_et", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt = new TH2F( "RecoVsGen_pt", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta = new TH2F( "RecoVsGen_eta", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi = new TH2F( "RecoVsGen_phi", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et = new TH2F( "RecoVsGen_dRltpt2_et", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt = new TH2F( "RecoVsGen_dRltpt2_pt", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta = new TH2F( "RecoVsGen_dRltpt2_eta", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi = new TH2F( "RecoVsGen_dRltpt2_phi", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
// setup deltaR<=0.05 plots:
   ...
   hMatchZSPiC5Jets_dRltpt1_et = new TH1F("hMatchZSPiC5Jets_dRltpt1_et","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchZSPiC5Jets_dRltpt1_et->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt1_et_etacut0 = new TH1F("hMatchZSPiC5Jets_dRltpt1_et_etacut0","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_dRltpt1_et_etacut0->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt1_et_etacut1 = new TH1F("hMatchZSPiC5Jets_dRltpt1_et_etacut1","ZSPCorJetICone5 E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 1.3 <| #eta | <3",100,0,225);
   hMatchZSPiC5Jets_dRltpt1_et_etacut1->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt1_pt = new TH1F("hMatchZSPiC5Jets_dRltpt1_pt","ZSPCorJetICone5 p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchZSPiC5Jets_dRltpt1_pt->Sumw2();
   ...
   hMatchZSPiC5Jets_dRltpt1_pt_etacut0 = new TH1F("hMatchZSPiC5Jets_dRltpt1_pt_etacut0","ZSPCorJetICone5 p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchZSPiC5Jets_dRltpt1_pt_etacut0->Sumw2();
   hRecoVsGen_dRltpt1_et_etacut1 = new TH2F( "RecoVsGen_dRltpt1_et_etacut1", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt_etacut1 = new TH2F( "RecoVsGen_dRltpt1_pt_etacut1", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta_etacut1 = new TH2F( "RecoVsGen_dRltpt1_eta_etacut1", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi_etacut1 = new TH2F( "RecoVsGen_dRltpt1_phi_etacut1", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt1_et_etacut0 = new TH2F( "RecoVsGen_dRltpt1_et_etacut0", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt_etacut0 = new TH2F( "RecoVsGen_dRltpt1_pt_etacut0", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta_etacut0 = new TH2F( "RecoVsGen_dRltpt1_eta_etacut0", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi_etacut0 = new TH2F( "RecoVsGen_dRltpt1_phi_etacut0", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt1_et = new TH2F( "RecoVsGen_dRltpt1_et", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt = new TH2F( "RecoVsGen_dRltpt1_pt", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta = new TH2F( "RecoVsGen_dRltpt1_eta", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi = new TH2F( "RecoVsGen_dRltpt1_phi", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );   
//    hRecoVsGen_dRltpt5_et = new TH2F( "RecoVsGen_dRltpt5_et", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRltpt5_pt = new TH2F( "RecoVsGen_dRltpt5_pt", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRltpt5_eta = new TH2F( "RecoVsGen_dRltpt5_eta", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
//    hRecoVsGen_dRltpt5_phi = new TH2F( "RecoVsGen_dRltpt5_phi", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
//    hRecoVsGen_dRlt1_et = new TH2F( "RecoVsGen_dRlt1_et", "ZSPCorJetICone5 E_{T} vs. GenJets E_{T} - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRlt1_pt = new TH2F( "RecoVsGen_dRlt1_pt", "ZSPCorJetICone5 p_{T} vs. GenJets p_{T} - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRlt1_eta = new TH2F( "RecoVsGen_dRlt1_eta", "ZSPCorJetICone5 #eta vs. GenJets #eta - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
//    hRecoVsGen_dRlt1_phi = new TH2F( "RecoVsGen_dRlt1_phi", "ZSPCorJetICone5 #phi vs. GenJets #phi - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   cout<<"[ZSP_PuAnalyzer_range]:: finish beginJob"<<endl;
         return ;
}

// ------------ method called once each job just after ending the event loop  ------------
void 
ZSP_PuAnalyzer_range::endJob() {
 //  hOutputFile->cd() ;
//   Double_t limBins3[]  = {10,20,30,40,50,60,70,80,100.0,120.,150.,200};
  ...
  cout<<"[ZSP_PuAnalyzer_range::endJob]: just made our limBins"<<endl;
//   hMatchedGenNumEv_Ratio->Divide(hMatchZSPiC5Jets_dRltpt2_et,hAllGenJets_et,1.,1.,"B");
   hMatchedGenGNumEv_Ratio->Divide(hMatchGenJets_dRltpt2_pt,hAllGenJets_pt,1.,1.,"B");
  cout<<"[ZSP_PuAnalyzer_range::endJob]: just made hMatchedGenGNumEv_Ratio"<<endl;
   hMatchedGenGNumEv_Ratio_etacut0->Divide(hMatchGenJets_dRltpt2_pt_etacut0,hAllGenJets_pt_etacut0,1.,1.,"B");
  cout<<"[ZSP_PuAnalyzer_range::endJob]:going to make hMatchedGenGNumEv_Ratio_dRltpt1 and hMatchedGenGNumEv_Ratio_dRltpt1_etacut0"<<endl;
  ...
  cout<<"[ZSP_PuAnalyzer_range::endJob]:made hMatchedGenGNumEv_Ratio_dRltpt1 and hMatchedGenGNumEv_Ratio_dRltpt1_etacut0, next fake ratios"<<endl;
   hFakeRatio->Divide(hUnMatchedZSPiC5Jets_pt,hAllZSPiC5Jets_pt,1.,1.,"B");
   hFakeRatio_etacut0->Divide(hUnMatchedZSPiC5Jets_pt_etacut0,hAllZSPiC5Jets_pt_etacut0,1.,1.,"B");
   hFakeRatio_etacut1->Divide(hUnMatchedZSPiC5Jets_pt_etacut1,hAllZSPiC5Jets_pt_etacut1,1.,1.,"B");
   cout<<"[ZSP_PuAnalyzer_range::endJob]: made FakeRatio plots, next lines are commented out"<<endl;
//   hMatchedGenGNumEv_pt_Ratio->Divide(hMatchGenJets_dRltpt2_pt,hAllGenJets_pt_etacut0,1.,1.,"B");
//  cout<<"[ZSP_PuAnalyzer_range::endJob]: just made hMatchedGenGNumEv_pt_Ratio"<<endl;

//   hMatchedCaloNumEv_Ratio->Divide(hMatchZSPiC5Jets_dRltpt2_et,hAllZSPiC5Jets_et,1.,1.,"B");
//   hMatchedGCaloNumEv_Ratio->Divide(hMatchGenJets_dRltpt2_et,hAllZSPiC5Jets_et,1.,1.,"B");
...
//   hMatchedGenGNumEv_pt_Ratio_etacut1->Divide(hMatchGenJets_dRltpt2_pt_etacut1,hAllGenJets_pt_etacut1,1.,1.,"B");
  cout<<"[ZSP_PuAnalyzer_range::endJob]: about to make hMatchedGenGNumEv_Ratio_etacut1"<<endl;
  ...
  cout<<"[ZSP_PuAnalyzer_range::endJob]: did hMatchedGenGNumEv_Ratio_etacut1"<<endl;

  cout<<"[ZSP_PuAnalyzer_range::endJob]: about to loop over 6 bins in outputI"<<endl;
  for(unsigned int outputI=0;outputI<6;outputI++){
   ...
   cout<<"[ZSP_PuAnalyzer_range::endJob]: just did gaussian fit for pThist for bin: "<<outputI<<endl;
...
//    pThist[outputI]->Write();
    cout<<"[ZSP_PuAnalyzer_range::endJob]: Just wrote out pThist for bin: "<<outputI<<endl;
   ...
   cout<<"[ZSP_PuAnalyzer_range::endJob]: just did gaussian fit for pThist_dRltpt1 for bin: "<<outputI<<endl;
...
//    pThist_dRltpt1[outputI]->Write();
    cout<<"[ZSP_PuAnalyzer_range::endJob]: Just wrote out pThist_dRltpt1 for bin: "<<outputI<<endl;
...
// position eta
   ...
   cout<<"[ZSP_PuAnalyzer_range::endJob]: just did gaussian fit for etahist for bin: "<<outputI<<endl;
...
//    etahist[outputI]->Write();
    cout<<"[ZSP_PuAnalyzer_range::endJob]: Just wrote out etahist for bin: "<<outputI<<endl;
// barrel
...
// position phi
   ...
   cout<<"[ZSP_PuAnalyzer_range::endJob]: just did gaussian fit for phihist for bin: "<<outputI<<endl;
...
//    }
 //   phihist[outputI]->Write();
    cout<<"[ZSP_PuAnalyzer_range::endJob]: Just wrote out phihist for bin: "<<outputI<<endl;
// barrel
...
//   ratioptOld->Write();  
//   hOutputFile->Write() ;
cout<<"[ZSP_PuAnalyzer_range]:: start doing Write histos as part of destruction"<<endl;
		 hTotalLenght->Write();
		hdeltaR->Write();
...
cout<<"[ZSP_PuAnalyzer_range]:: Wrote basic histos as part of destruction"<<endl;
...
//
cout<<"[ZSP_PuAnalyzer_range]:: Wrote barrel+endcap histos as part of destruction"<<endl;

// position resolution:
		ratioeta->Write();
//				cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioeta->Write();histos as part of destruction"<<endl;
		sigmaeta->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaeta->Write();histos as part of destruction"<<endl;
		etahist [6]->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		etahist [6]->Write();histos as part of destruction"<<endl;
		ratioPhi->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioPhi->Write();histos as part of destruction"<<endl;
		sigmaphi->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaphi->Write();histos as part of destruction"<<endl;
		phihist [6]->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		phihist [6]->Write();histos as part of destruction"<<endl;
		ratioeta_etacut0->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioeta_etacut0->Write();histos as part of destruction"<<endl;
		sigmaeta_etacut0->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaeta_etacut0->Write();histos as part of destruction"<<endl;
		etahist_etacut0 [6]->Write();    
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		etahist_etacut0 [6]->Write();    histos as part of destruction"<<endl;
		ratioPhi_etacut0->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioPhi_etacut0->Write();histos as part of destruction"<<endl;
		sigmaphi_etacut0->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaphi_etacut0->Write();histos as part of destruction"<<endl;
		phihist_etacut0[6]->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		phihist_etacut0[6]->Write();histos as part of destruction"<<endl;
		ratioeta_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioeta_etacut1->Write();histos as part of destruction"<<endl;
		sigmaeta_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaeta_etacut1->Write();histos as part of destruction"<<endl;
		etahist_etacut1 [6]->Write();      
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		etahist_etacut1 [6]->Write();      histos as part of destruction"<<endl;
		ratioPhi_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		ratioPhi_etacut1->Write();histos as part of destruction"<<endl;
		sigmaphi_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		sigmaphi_etacut1->Write();histos as part of destruction"<<endl;
//	    phihist_etacut1[6]->Write();   
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote		phihist_etacut1[6]->Write();   histos as part of destruction"<<endl;
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote position histos as part of destruction"<<endl;
...
//		hAllGenJets_pt_etacut0->Write();
		...
		hAllZSPiC5Jets_et->Write();
		hMatchGenJets_dRltpt2_et->Write();
 		hMatchGenJets_dRltpt1_et->Write();   
		hMatchGenJets_et->Write();
		hMatchZSPiC5Jets_dRltpt2_et->Write();
		hMatchZSPiC5Jets_dRltpt1_et->Write();
		hMatchZSPiC5Jets_et->Write();  
 
		hAllZSPiC5Jets_et_etacut0->Write();
		hMatchGenJets_dRltpt2_et_etacut0->Write();
		hMatchGenJets_dRltpt1_et_etacut0->Write();    
		hMatchGenJets_et_etacut0->Write();
		hMatchZSPiC5Jets_dRltpt2_et_etacut0->Write();
		hMatchZSPiC5Jets_dRltpt1_et_etacut0->Write();    
		hMatchZSPiC5Jets_et_etacut0->Write();  
 		cout<<"[ZSP_PuAnalyzer_range]:: Wrote match histos as part of destruction"<<endl;
 
		hAllGenJets_pt->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllGenJets_pt"<<endl;
		hAllZSPiC5Jets_pt->Write();
				cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllZSPiC5Jets_pt"<<endl;
		hMatchGenJets_dRltpt2_pt->Write();
				cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllZSPiC5Jets_pt"<<endl;
		hMatchGenJets_dRltpt1_pt->Write();    
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt1_pt"<<endl;
		hMatchGenJets_pt->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_pt"<<endl;
		hMatchZSPiC5Jets_dRltpt2_pt->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_dRltpt2_pt"<<endl;
		hMatchZSPiC5Jets_dRltpt1_pt->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_dRltpt1_pt"<<endl;
		hMatchZSPiC5Jets_pt->Write();  
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_pt"<<endl;
		hUnMatchedZSPiC5Jets_pt->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_pt"<<endl;
		hUnMatchedZSPiC5Jets_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_pt_etacut0"<<endl;
		hUnMatchedZSPiC5Jets_pt_etacut1->Write();
        cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_pt_etacut1"<<endl;
		hUnMatchedZSPiC5Jets_eta->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_eta"<<endl;
		hUnMatchedZSPiC5Jets_eta_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_eta_etacut0"<<endl;
		hUnMatchedZSPiC5Jets_eta_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hUnMatchedZSPiC5Jets_eta_etacut1"<<endl;
//		hUnMatchedZSPiC5Jets_dRltpt2_et->Write();
//		hUnMatchedZSPiC5Jets_dRltpt2_et_etacut0->Write();
//		hUnMatchedZSPiC5Jets_dRltpt2_et_etacut1->Write();
//		hMatchedGenGNumEv_pt_Ratio->Write();

		hMatchGenJets_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_pt_etacut0"<<endl;
		hAllZSPiC5Jets_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllZSPiC5Jets_pt_etacut0"<<endl;
		hAllGenJets_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllGenJets_pt_etacut0"<<endl;
		hMatchGenJets_dRltpt2_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt2_pt_etacut0"<<endl;
		hMatchZSPiC5Jets_dRltpt2_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_dRltpt2_pt_etacut0"<<endl;
		hMatchGenJets_dRltpt1_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt1_pt_etacut0"<<endl;
		hMatchZSPiC5Jets_dRltpt1_pt_etacut0->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_dRltpt1_pt_etacut0"<<endl;
		hMatchZSPiC5Jets_pt_etacut0->Write();     
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_pt_etacut0"<<endl;
//		hMatchedGenGNumEv_pt_Ratio_etacut0->Write();

 // endcap plots
//		hAllGenJets_et_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllGenJets_et_etacut1"<<endl;
//		hAllZSPiC5Jets_et_etacut1->Write();
//		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllZSPiC5Jets_et_etacut1"<<endl;
		hMatchGenJets_dRltpt2_et_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt2_et_etacut1"<<endl;
		hMatchGenJets_dRltpt1_et_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt1_et_etacut1"<<endl;
		hMatchGenJets_et_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_et_etacut1"<<endl;
		hMatchZSPiC5Jets_dRltpt2_et_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote 	hMatchZSPiC5Jets_dRltpt2_et_etacut1"<<endl;
		hMatchZSPiC5Jets_dRltpt1_et_etacut1->Write();
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_dRltpt1_et_etacut1"<<endl;
		hMatchZSPiC5Jets_et_etacut1->Write();     
		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchZSPiC5Jets_et_etacut1"<<endl;
//		hMatchedGenGNumEv_et_Ratio_etacut1->Write();  
    
 		hAllGenJets_pt_etacut1->Write();
 		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllGenJets_pt_etacut1"<<endl;
 		hAllZSPiC5Jets_pt_etacut1->Write();
 		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hAllZSPiC5Jets_pt_etacut1"<<endl;
 		hMatchGenJets_dRltpt2_pt_etacut1->Write();
 		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_dRltpt2_pt_etacut1"<<endl;
 		hMatchGenJets_pt_etacut1->Write();
 		cout<<"[ZSP_PuAnalyzer_range]:: Wrote hMatchGenJets_pt_etacut1"<<endl;
// 		hMatchZSPiC5Jets_dRltpt2_pt_etacut1->Write();
// 		hMatchZSPiC5Jets_pt_etacut1->Write();     
// 		hMatchedGenGNumEv_pt_Ratio_etacut1->Write();   
  		cout<<"[ZSP_PuAnalyzer_range]:: Wrote more match histos as part of destruction"<<endl;
...
//		hMatchedGenNumEv_Ratio->Write(); // (# matched ZSPiC5 Jets)/(# All GenJets)
...
//		hMatchedCaloNumEv_Ratio->Write(); // (# matched ZSPiC5 Jets)/(# All ZSPiC5 Jets)
//		hMatchedGCaloNumEv_Ratio->Write(); // (# matched GenJets)/(# All ZSPiC5 Jets)
		hRecoVsGen_pt->Write();
		hRecoVsGen_et->Write();
...
cout<<"[ZSP_PuAnalyzer_range]:: finish doing Write histos as part of destruction"<<endl;
   hOutputFile->Write() ;
 cout<<"[ZSP_PuAnalyzer_range]:: going to close File part of destruction"<<endl;

//   hOutputFile->Close() ; 
 cout<<"[ZSP_PuAnalyzer_range]:: end destruction"<<endl;

cout<<"[ZSP_PuAnalyzer_range]:: finished endJob"<<endl;
   return ;
}

//define this as a plug-in
DEFINE_FWK_MODULE(ZSP_PuAnalyzer_range);
