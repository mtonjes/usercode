// -*- C++ -*-
//
// Package:    KT6_PuAnalyzer_range
// Class:      KT6_PuAnalyzer_range
// 
/**\class KT6_PuAnalyzer_range KT6_PuAnalyzer_range.cc MTonjes/JetMatchAna/src/KT6_PuAnalyzer_range.cc
...
class KT6_PuAnalyzer_range : public edm::EDAnalyzer {
   public:
      explicit KT6_PuAnalyzer_range(const edm::ParameterSet&);
      ~KT6_PuAnalyzer_range();
...
//    TH2F* 		hSimpleEfficiency_Energy; // (#matched jets)/(# reco jets) vs. p_{T} Gen  (what Korea group did)
    TH1F*       hAllKT6GenJets_et;
//    TH1F*       hAllKT6GenJets_pt_etacut0;
    TH1F*       hAllKT6GenJets_et_etacut0;

    TH1F*		hAllKT6Jets_et;
    TH1F*		hMatchKT6GenJets_dRltpt2_et;
     TH1F*		hMatchKT6GenJets_dRltpt1_et;   
    TH1F*		hMatchKT6GenJets_et;
    TH1F*		hMatchKT6Jets_dRltpt2_et;
    TH1F*		hMatchKT6Jets_dRltpt1_et;
    TH1F*		hMatchKT6Jets_et;  
 
    TH1F*		hAllKT6Jets_et_etacut0;
    TH1F*		hMatchKT6GenJets_dRltpt2_et_etacut0;
    TH1F*		hMatchKT6GenJets_dRltpt1_et_etacut0;    
    TH1F*		hMatchKT6GenJets_et_etacut0;
    TH1F*		hMatchKT6Jets_dRltpt2_et_etacut0;
    TH1F*		hMatchKT6Jets_dRltpt1_et_etacut0;    
    TH1F*		hMatchKT6Jets_et_etacut0;  
  
    TH1F*       hAllKT6GenJets_pt;
    TH1F*		hAllKT6Jets_pt;
    TH1F*		hMatchKT6GenJets_dRltpt2_pt;
    TH1F*		hMatchKT6GenJets_dRltpt1_pt;    
    TH1F*		hMatchKT6GenJets_pt;
    TH1F*		hMatchKT6Jets_dRltpt2_pt;
    TH1F*		hMatchKT6Jets_dRltpt1_pt;
    TH1F*		hMatchKT6Jets_pt;  
    TH1F*       hUnMatchedKT6Jets_pt;
    TH1F*       hUnMatchedKT6Jets_pt_etacut0;
    TH1F*       hUnMatchedKT6Jets_pt_etacut1;
    
    Int_t    KT6Jets_unmatchstat[100];
    Double_t    KT6Jets_eta_unmatch[100];
    Double_t    KT6Jets_pt_unmatch[100];
    
    TH1F*       hUnMatchedKT6Jets_eta;
    TH1F*       hUnMatchedKT6Jets_eta_etacut0;
    TH1F*       hUnMatchedKT6Jets_eta_etacut1;
//    TH1F*       hUnMatchedKT6Jets_dRltpt2_et;
//    TH1F*       hUnMatchedKT6Jets_dRltpt2_et_etacut0;
//    TH1F*       hUnMatchedKT6Jets_dRltpt2_et_etacut1;
//    TH1F* 		hMatchedGenGNumEv_pt_Ratio;

    TH1F*		hMatchKT6GenJets_pt_etacut0;
    TH1F*		hAllKT6Jets_pt_etacut0;
    TH1F*       hAllKT6GenJets_pt_etacut0;
    TH1F*		hMatchKT6GenJets_dRltpt2_pt_etacut0;
    TH1F*		hMatchKT6Jets_dRltpt2_pt_etacut0;
    TH1F*		hMatchKT6GenJets_dRltpt1_pt_etacut0;
    TH1F*		hMatchKT6Jets_dRltpt1_pt_etacut0;
    TH1F*		hMatchKT6Jets_pt_etacut0;     
//    TH1F* 		hMatchedGenGNumEv_pt_Ratio_etacut0;

 // endcap plots
    TH1F*       hAllKT6GenJets_et_etacut1;
    TH1F*		hAllKT6Jets_et_etacut1;
    TH1F*		hMatchKT6GenJets_dRltpt2_et_etacut1;
    TH1F*		hMatchKT6GenJets_dRltpt1_et_etacut1;
    TH1F*		hMatchKT6GenJets_et_etacut1;
    TH1F*		hMatchKT6Jets_dRltpt2_et_etacut1;
    TH1F*		hMatchKT6Jets_dRltpt1_et_etacut1;
    TH1F*		hMatchKT6Jets_et_etacut1;     
//    TH1F* 		hMatchedGenGNumEv_et_Ratio_etacut1;  
    
     TH1F*       hAllKT6GenJets_pt_etacut1;
     TH1F*		hAllKT6Jets_pt_etacut1;
     TH1F*		hMatchKT6GenJets_dRltpt2_pt_etacut1;
     TH1F*		hMatchKT6GenJets_pt_etacut1;
     TH1F*		hMatchKT6Jets_dRltpt2_pt_etacut1;
     TH1F*		hMatchKT6Jets_pt_etacut1;     
    ...
    TH1F* 		hMatchedGenGNumEv_Ratio_etacut1; // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
...
//    TH1F* 		hMatchedGenNumEv_Ratio; // (# matched KT6 Jets)/(# All KT6GenJets)
    TH1F* 		hMatchedGenGNumEv_Ratio; // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
    TH1F* 		hMatchedGenGNumEv_Ratio_etacut0; // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
    TH1F* 		hMatchedGenGNumEv_Ratio_dRltpt1; // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
    TH1F* 		hMatchedGenGNumEv_Ratio_dRltpt1_etacut0; // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
    TH1F*       hFakeRatio;
...
//    TH1F*		hMatchedCaloNumEv_Ratio; // (# matched KT6 Jets)/(# All KT6 Jets)
//    TH1F*		hMatchedGCaloNumEv_Ratio; // (# matched KT6GenJets)/(# All KT6 Jets)
    TH2F*		hRecoVsGen_pt;
    TH2F*		hRecoVsGen_et;
    TH2F*		hRecoVsGen_eta;
    TH2F*		hRecoVsGen_phi;
...
//
KT6_PuAnalyzer_range::KT6_PuAnalyzer_range(const edm::ParameterSet& iConfig)
...
int KT6_PuAnalyzer_range::determineIndex(Double_t* limBins, Double_t data, unsigned int nbreBins)
{
...
KT6_PuAnalyzer_range::~KT6_PuAnalyzer_range()
{
...
void
KT6_PuAnalyzer_range::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
//   Double_t limBins4[]  = {1,5,10,15,20,30,40};
  ...
  cout << "[KT6_PuAnalyzer_range] analysing event " << iEvent.id() << endl;
  HaveMatchMap = kTRUE;
  try {
    iEvent.getByLabel (source_,source);
    iEvent.getByLabel (matched_,matched);
  } catch(std::exception& ce) {
    cerr << "[KT6_PuAnalyzer_range] caught std::exception " << ce.what() << endl;
    return;   
  }
  try {
  ...
  //
    int nKT6GenJets=source->size();
    int nRecoJets=matched->size();
    int nMatchedRecoJets=matchedjetsOne->size();
   cout << "**********************" << endl;
   cout << "* Raw Jets Printout  *" << endl;
   cout << "**********************" << endl;
   cout << "In this Event: "<<iEvent.id()<<", there are: "<<nKT6GenJets<<" KT6GenJets (pass cfg file analysis cut-sometimes pt>20) and "<<nRecoJets<<" "<<matched_<<" (pass cfg file analysis cut-sometimes pt>20)"<<endl;
   cout << "  There are also: "<<nMatchedRecoJets<< " matched "<<matched_<<" (pass cfg file analysis cut-sometimes pt>20)."<<endl;
 
//    hMatchedGenNumEv_Ratio->Fill(nMatchedRecoJets/nKT6GenJets);
...
//     Double_t KT6GenJetEt = ijet->et();
      hAllKT6GenJets_et->Fill(ijet->et());
      hAllKT6GenJets_pt->Fill(ijet->pt());      
      GenEtaAll=ijet->eta();
      if (fabs(GenEtaAll)<=1.3){
        hAllKT6GenJets_et_etacut0->Fill(ijet->et());
        hAllKT6GenJets_pt_etacut0->Fill(ijet->pt());
     } else if (fabs(GenEtaAll) >1.3 && fabs(GenEtaAll)<3){
        cout<<"[KT6_PuAnalyzer_range::analyze, have an endcap jet, will fill hAllKT6GenJets_pt_etacut1 with pT: "<<ijet->pt()<<endl;
        hAllKT6GenJets_pt_etacut1->Fill(ijet->pt());
//        hAllKT6GenJets_pt_etacut1->Fill(ijet->pt());   
     }
//     cout<<"   KT6GenJetEt: "<<KT6GenJetEt<<endl; 
   }
  double RecoEtaAll = 990.; 
        for(int iset=0; iset<100; iset++){
          KT6Jets_unmatchstat[iset]=5;  // 0 = matched, 1 = unmatched, 5 = error
          KT6Jets_eta_unmatch[iset]=9999.;  // eta of those recojets corresponding to index above
          KT6Jets_pt_unmatch[iset]=0.;   // et of those recojets corresponding to index above  
        }
          Int_t totalKT6Jets=0;
   for (CandidateCollection::const_iterator imjet=matched->begin(); imjet!=matched->end(); imjet++) {
 
       RecoEtaAll = imjet->eta();
      if(!HaveMatchMap){
        hUnMatchedKT6Jets_pt->Fill(imjet->pt());
        hUnMatchedKT6Jets_eta->Fill(imjet->eta());
          if (fabs(RecoEtaAll)<=1.3){
            hUnMatchedKT6Jets_pt_etacut0->Fill(imjet->pt());         
            hUnMatchedKT6Jets_eta_etacut0->Fill(imjet->eta());         
          } else if (fabs(RecoEtaAll) >1.3 && fabs(RecoEtaAll)<3){
            hUnMatchedKT6Jets_pt_etacut1->Fill(imjet->pt());                   
            hUnMatchedKT6Jets_eta_etacut1->Fill(imjet->eta());                   
          }
      } else {
          KT6Jets_unmatchstat[totalKT6Jets]=1;
          KT6Jets_eta_unmatch[totalKT6Jets]=imjet->eta();  // eta of those recojets corresponding to index above
          KT6Jets_pt_unmatch[totalKT6Jets]=imjet->pt();   // et of those recojets corresponding to index above
          totalKT6Jets++;
    }
      hAllKT6Jets_et->Fill(imjet->et());     
      hAllKT6Jets_pt->Fill(imjet->pt());
      if (fabs(RecoEtaAll)<=1.3){
        hAllKT6Jets_et_etacut0->Fill(imjet->et());
        hAllKT6Jets_pt_etacut0->Fill(imjet->pt());
     } else if (fabs(RecoEtaAll) >1.3 && fabs(RecoEtaAll)<3){
        cout<<"[KT6_PuAnalyzer_range::analyze, have an endcap jet, will fill hAllKT6Jets_pt_etacut1 with pT: "<<imjet->pt()<<endl;
        hAllKT6Jets_et_etacut1->Fill(imjet->et());
        hAllKT6Jets_pt_etacut1->Fill(imjet->pt());   
     }           
...
//   cout << "**********************" << endl;
  ...
  for( CandMatchMap::const_iterator f  = matchedjetsOne->begin();
      ...
      hdeltaR->Fill(dR);
//       printf("[KT6_PuAnalyzer_range] (et,eta,phi) source = %6.2f %5.2f %5.2f matched = %6.2f %5.2f %5.2f dR=%5.3f\n",
// 	     sourceRef->et(),
// 	     sourceRef->eta(),
// 	     sourceRef->phi(), 
// 	     matchRef->et(), 
...
// 	     matchRef->phi(), 
// 	     dR);
//      printf("[KT6_PuAnalyzer_range] (pt) source = %6.2f matched = %6.2f dR=%5.3f\n",
// 	     sourceRef->pt(),
// 	     matchRef->pt(), 
// 	     dR);
      ...
      hMatchKT6GenJets_et->Fill(sourceRef->et());
      hMatchKT6Jets_et->Fill(matchRef->et());    
      hMatchKT6GenJets_pt->Fill(sourceRef->pt());
      hMatchKT6Jets_pt->Fill(matchRef->pt());
      ...
      if (dR<=0.2){
          hMatchKT6GenJets_dRltpt2_et->Fill(sourceRef->et());
          hMatchKT6Jets_dRltpt2_et->Fill(matchRef->et());
          hMatchKT6GenJets_dRltpt2_pt->Fill(sourceRef->pt());
          hMatchKT6Jets_dRltpt2_pt->Fill(matchRef->pt());
          ...
          for(int imatched = 0;imatched<totalKT6Jets;imatched++){
             if(KT6Jets_pt_unmatch[imatched]==matchRef->pt()) {
                KT6Jets_unmatchstat[imatched]=0;
             }
          }
...
//	      cout<<"did pthist"<<endl;
        if (dR<=0.1){
           hMatchKT6GenJets_dRltpt1_et->Fill(sourceRef->et());
          hMatchKT6Jets_dRltpt1_et->Fill(matchRef->et());
          hMatchKT6GenJets_dRltpt1_pt->Fill(sourceRef->pt());
          hMatchKT6Jets_dRltpt1_pt->Fill(matchRef->pt());
...
//         hUnMatchedKT6Jets_pt->Fill(matchRef->et());
//         hUnMatchedKT6Jets_eta->Fill(matchRef->eta());
//           if (fabs(RecoEta)<=1.3){
//             hUnMatchedKT6Jets_pt_etacut0->Fill(matchRef->et());         
//             hUnMatchedKT6Jets_eta_etacut0->Fill(matchRef->eta());         
//           } else if (fabs(RecoEta) >1.3 && fabs(RecoEta)<3){
//             hUnMatchedKT6Jets_eta_etacut1->Fill(matchRef->eta());                   
//             hUnMatchedKT6Jets_eta_etacut1->Fill(matchRef->eta());                   
//           }
      }
 // Barrel     
    if(fabs(GenEta)<=1.3){
      ...
      hMatchKT6GenJets_et_etacut0->Fill(sourceRef->et());
      hMatchKT6Jets_et_etacut0->Fill(matchRef->et());    
      
      hMatchKT6GenJets_pt_etacut0->Fill(sourceRef->pt());
      hMatchKT6Jets_pt_etacut0->Fill(matchRef->pt());  
     ...
     if(dR<=0.2) {
          ...
          hMatchKT6GenJets_dRltpt2_et_etacut0->Fill(sourceRef->et());
          hMatchKT6Jets_dRltpt2_et_etacut0->Fill(matchRef->et());
          hMatchKT6GenJets_dRltpt2_pt_etacut0->Fill(sourceRef->pt());
          hMatchKT6Jets_dRltpt2_pt_etacut0->Fill(matchRef->pt());
	      ...
	      if(dR<=0.1){
            ...
            hMatchKT6GenJets_dRltpt1_et_etacut0->Fill(sourceRef->et());
            hMatchKT6Jets_dRltpt1_et_etacut0->Fill(matchRef->et());
            hMatchKT6GenJets_dRltpt1_pt_etacut0->Fill(sourceRef->pt());
            hMatchKT6Jets_dRltpt1_pt_etacut0->Fill(matchRef->pt());	      	      
	      }
...
// endcap
      ...
      hMatchKT6GenJets_et_etacut1->Fill(sourceRef->et());
      hMatchKT6Jets_et_etacut1->Fill(matchRef->et());    
      
      hMatchKT6GenJets_pt_etacut1->Fill(sourceRef->pt());
//      hMatchKT6Jets_pt_etacut1->Fill(matchRef->pt());  
...
//          Double_t ResFrac_etacut1=(matchRef->et())/(sourceRef->et());
   //       hSimpleResolution_Energy_etacut1->Fill(sourceRef->et(),ResFrac_etacut1);
        cout<<"[KT6_PuAnalyzer_range::analyze, have a matched endcap jet DeltaR<=0.1, will fill hMatchKT6GenJets_dRltpt2_pt_etacut1 with Et: "<<sourceRef->pt()<<" and hMatchKT6Jets_dRltpt2_pt_etacut1 with pT: "<<matchRef->pt()<<endl;
          hMatchKT6GenJets_dRltpt2_et_etacut1->Fill(sourceRef->et());
          hMatchKT6Jets_dRltpt2_et_etacut1->Fill(matchRef->et());
          hMatchKT6GenJets_dRltpt2_pt_etacut1->Fill(sourceRef->pt());
          hMatchKT6Jets_dRltpt2_pt_etacut1->Fill(matchRef->pt());
	      ...
	      if(dR<=0.1){
            ...
            hMatchKT6GenJets_dRltpt1_et_etacut1->Fill(sourceRef->et());
            hMatchKT6Jets_dRltpt1_et_etacut1->Fill(matchRef->et());
	      }	      
     }  
    }
  }
   for(int imatchedjets = 0;imatchedjets<totalKT6Jets;imatchedjets++){
      if(KT6Jets_unmatchstat[imatchedjets]==1) {
        hUnMatchedKT6Jets_pt->Fill(KT6Jets_pt_unmatch[imatchedjets]);
        hUnMatchedKT6Jets_eta->Fill(KT6Jets_eta_unmatch[imatchedjets]);
          if (fabs(KT6Jets_eta_unmatch[imatchedjets])<=1.3){
            hUnMatchedKT6Jets_pt_etacut0->Fill(KT6Jets_pt_unmatch[imatchedjets]);         
            hUnMatchedKT6Jets_eta_etacut0->Fill(KT6Jets_eta_unmatch[imatchedjets]);         
          } else if (fabs(KT6Jets_eta_unmatch[imatchedjets]) >1.3 && fabs(KT6Jets_eta_unmatch[imatchedjets])<3){
            hUnMatchedKT6Jets_pt_etacut1->Fill(KT6Jets_pt_unmatch[imatchedjets]);                   
            hUnMatchedKT6Jets_eta_etacut1->Fill(KT6Jets_eta_unmatch[imatchedjets]);                   
          }             
       } else if(KT6Jets_unmatchstat[imatchedjets]==5){
         cout<<"[KT6_PuAnalyzer_range::analyze, Error (5) in KT6Jets_unmatchstat for imatchedjets = "<<imatchedjets<<endl;
       }
   }
 } else {
 ...
 cout<<"[KT6_PuAnalyzer_range]:: end analyze"<<endl;
...
void 
KT6_PuAnalyzer_range::beginJob(const edm::EventSetup&)
{
 cout<<"[KT6_PuAnalyzer_range]:: start beginJob"<<endl;
   ...
   ratiopT = new TH1F ("ratiopT", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, all #eta",6,limBins2);
   ratiopT->Sumw2();
   sigmapTrpTm = new TH1F ("sigmapTrpTm", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmapTrpTm->Sumw2();
   ...
   ratiopTOld = new TH1F ("ratiopTOld", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T} (different bins), all #eta",13,limBinsOld2);
   ratiopTOld->Sumw2();
   sigmapTrpTmOld = new TH1F ("sigmapTrpTmOld", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), all #eta",13,limBinsOld2);
   ...
   ratiopT_dRltpt1 = new TH1F ("ratiopT_dRltpt1", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, all #eta, #DeltaR_{m}<=0.1",6,limBins2);
   ratiopT_dRltpt1->Sumw2();
   sigmapTrpTm_dRltpt1 = new TH1F ("sigmapTrpTm_dRltpt1", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.1, all #eta",6,limBins2);
   ...
   ratiopT_dRltpt1Old = new TH1F ("ratiopT_dRltpt1Old", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T} (different bins), all #eta, #DeltaR_{m}<=0.1",13,limBinsOld2);
   ratiopT_dRltpt1Old->Sumw2();
   sigmapTrpTm_dRltpt1Old = new TH1F ("sigmapTrpTm_dRltpt1Old", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.1 (diff bins), all #eta",13,limBinsOld2);
...
// barrel plots make:
   ratiopT_etacut0 = new TH1F ("ratiopT_etacut0", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, 0<= | #eta | <=1.3",6,limBins2);
   ratiopT_etacut0->Sumw2();
   sigmapTrpTm_etacut0 = new TH1F ("sigmapTrpTm_etacut0", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratiopT_etacut0Old = new TH1F ("ratiopT_etacut0Old", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T} (different bins), 0<= | #eta | <=1.3",13,limBinsOld2);
   ratiopT_etacut0Old->Sumw2();
   sigmapTrpTm_etacut0Old = new TH1F ("sigmapTrpTm_etacut0Old", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), 0<= | #eta | <=1.3",13,limBinsOld2);
...
// endcap plots make:
   ratiopT_etacut1 = new TH1F ("ratiopT_etacut1", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, 1.3 <| #eta | <3",6,limBins2);
   ratiopT_etacut1->Sumw2();
   sigmapTrpTm_etacut1 = new TH1F ("sigmapTrpTm_etacut1", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
   ...
   ratiopT_etacut1Old = new TH1F ("ratiopT_etacut1Old", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T} (different bins), 1.3 <| #eta | <3",13,limBinsOld2);
   ratiopT_etacut1Old->Sumw2();
   sigmapTrpTm_etacut1Old = new TH1F ("sigmapTrpTm_etacut1Old", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins), 1.3 <| #eta | <3",13,limBinsOld2);
...
//
// position resolution:
   ratioeta = new TH1F ("ratioeta", "<|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|>, all #eta",6,limBins2);
   ratioeta->Sumw2();
   sigmaeta = new TH1F ("sigmaeta", "sigma(|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmaeta->Sumw2();  
    for (unsigned int indexH=0;indexH<6;indexH++)  {
   ...
   ratioeta_etacut0 = new TH1F ("ratioeta_etacut0", "<|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|>, 0<= | #eta | <=1.3",6,limBins2);
   ratioeta_etacut0->Sumw2();
   sigmaeta_etacut0 = new TH1F ("sigmaeta_etacut0", "sigma(|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratioeta_etacut1 = new TH1F ("ratioeta_etacut1", "<|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|>, 1.3 <| #eta | <3",6,limBins2);
   ratioeta_etacut1->Sumw2();
   sigmaeta_etacut1 = new TH1F ("sigmaeta_etacut1", "sigma(|#eta(K_{T}6Jet)|-|#eta(KT6GenJets)|) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
   ...
   ratioPhi = new TH1F ("ratioPhi", "<#phi(K_{T}6Jet)-#phi(KT6GenJets)>, all #eta",6,limBins2);
   ratioPhi->Sumw2();
   sigmaphi = new TH1F ("sigmaphi", "sigma(#phi(K_{T}6Jet)-#phi(KT6GenJets)) matched OneToOne #DeltaR_{m}<=0.2, all #eta",6,limBins2);
   sigmaphi->Sumw2();  
    for (unsigned int indexH=0;indexH<6;indexH++)  {
   ...
   ratioPhi_etacut0 = new TH1F ("ratioPhi_etacut0", "<#phi(K_{T}6Jet)-#phi(KT6GenJets)>, 0<= | #eta | <=1.3",6,limBins2);
   ratioPhi_etacut0->Sumw2();
   sigmaphi_etacut0 = new TH1F ("sigmaphi_etacut0", "sigma(#phi(K_{T}6Jet)-#phi(KT6GenJets)) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",6,limBins2);
   ...
   ratioPhi_etacut1 = new TH1F ("ratioPhi_etacut1", "<#phi(K_{T}6Jet)-#phi(KT6GenJets)>, 1.3 <| #eta | <3",6,limBins2);
   ratioPhi_etacut1->Sumw2();
   sigmaphi_etacut1 = new TH1F ("sigmaphi_etacut1", "sigma(#phi(K_{T}6Jet)-#phi(KT6GenJets)) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",6,limBins2);
...
//   hSimpleEfficiency_Energy = new TH2F("hSimpleEfficiency_Energy","(# matched jets)/(# All KT6 jets) vs. p_{T} Gen - matched OneToOne #DeltaR_{m}<=0.2",50,0,5,50,0,225);
///   hMatchedGenNumEv_Ratio = new TH1F("hMatchedGenNumEv_Ratio","(# matched KT6 Jets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
//   hMatchedGenNumEv_Ratio->Sumw2();
 //  hMatchedCaloNumEv_Ratio = new TH1F("hMatchedCaloNumEv_Ratio","(# matched KT6 Jets)/(# All KT6 Jets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
//   hMatchedCaloNumEv_Ratio->Sumw2();
   hMatchedGenGNumEv_Ratio = new TH1F("hMatchedGenGNumEv_Ratio","(# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchedGenGNumEv_Ratio->Sumw2();

   hMatchedGenGNumEv_Ratio_dRltpt1 = new TH1F("hMatchedGenGNumEv_Ratio_dRltpt1","(# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchedGenGNumEv_Ratio_dRltpt1->Sumw2();

   hFakeRatio = new TH1F("hFakeRatio","(# unmatched K_{T}6Jets)/(# All K_{T}6Jets), All #eta",100,0,225);
   hFakeRatio->Sumw2();
   hFakeRatio_etacut0 = new TH1F("hFakeRatio_etacut0","(# unmatched K_{T}6Jets)/(# All K_{T}6Jets), 0<= | #eta | <=1.3",100,0,225);
   hFakeRatio_etacut0->Sumw2();
   hFakeRatio_etacut1 = new TH1F("hFakeRatio_etacut1","(# unmatched K_{T}6Jets)/(# All K_{T}6Jets), 1.3 <| #eta | <3",100,0,225);
   hFakeRatio_etacut1->Sumw2();

   hAllKT6GenJets_et = new TH1F("hAllKT6GenJets_et","All KT6GenJets E_{T}, All #eta",100,0,225);
   hAllKT6GenJets_et->Sumw2();
   hMatchKT6GenJets_dRltpt2_et = new TH1F("hMatchKT6GenJets_dRltpt2_et","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchKT6GenJets_dRltpt2_et->Sumw2();
   hMatchKT6GenJets_et = new TH1F("hMatchKT6GenJets_et","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchKT6GenJets_et->Sumw2();
   hMatchKT6Jets_dRltpt2_et = new TH1F("hMatchKT6Jets_dRltpt2_et","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchKT6Jets_dRltpt2_et->Sumw2();
   hMatchKT6Jets_et = new TH1F("hMatchKT6Jets_et","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchKT6Jets_et->Sumw2();
   hAllKT6Jets_et = new TH1F("hAllKT6Jets_et","All K_{T}6Jet E_{T}, All #eta",100,0,225);
   hAllKT6Jets_et->Sumw2();   

   hUnMatchedKT6Jets_pt = new TH1F("hUnMatchedKT6Jets_pt","Unmatched K_{T}6Jet p_{T}, All #eta",100,0,225);
//   hUnMatchedKT6Jets_dRltpt2_et = new TH1F("hUnMatchedKT6Jets_dRltpt2_et","Unmatched K_{T}6Jet p_{T}, outside of #DeltaR_{m}<=0.2 cut, All #eta",100,0,225);
   hUnMatchedKT6Jets_pt_etacut0 = new TH1F("hUnMatchedKT6Jets_pt_etacut0","Unmatched K_{T}6Jet p_{T}, 0<= | #eta | <=1.3",100,0,225);
//   hUnMatchedKT6Jets_dRltpt2_et_etacut0 = new TH1F("hUnMatchedKT6Jets_dRltpt2_et_etacut0","Unmatched K_{T}6Jet p_{T}, outside of #DeltaR_{m}<=0.2 cut, 0<= | #eta | <=1.3",100,0,225);
   hUnMatchedKT6Jets_pt_etacut1 = new TH1F("hUnMatchedKT6Jets_pt_etacut1","Unmatched K_{T}6Jet p_{T}, 1.3 <| #eta | <3",100,0,225);
//   hUnMatchedKT6Jets_dRltpt2_et_etacut1 = new TH1F("hUnMatchedKT6Jets_dRltpt2_et_etacut1","Unmatched K_{T}6Jet p_{T}, outside of #DeltaR_{m}<=0.2 cut, 1.3 <| #eta | <3",100,0,225);

   hUnMatchedKT6Jets_eta = new TH1F("hUnMatchedKT6Jets_eta","Unmatched K_{T}6Jet #eta, All #eta",100,-3,3);
   hUnMatchedKT6Jets_eta_etacut0 = new TH1F("hUnMatchedKT6Jets_eta_etacut0","Unmatched K_{T}6Jet #eta, 0<= | #eta | <=1.3",100,-0.5,0.5);
   hUnMatchedKT6Jets_eta_etacut1 = new TH1F("hUnMatchedKT6Jets_eta_etacut1","Unmatched K_{T}6Jet #eta, 1.3 <| #eta | <3",100,-2,2);

   hMatchedGenGNumEv_Ratio_etacut0 = new TH1F("hMatchedGenGNumEv_Ratio_etacut0","(# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchedGenGNumEv_Ratio_etacut0->Sumw2();

   hMatchedGenGNumEv_Ratio_dRltpt1_etacut0 = new TH1F("hMatchedGenGNumEv_Ratio_dRltpt1_etacut0","(# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchedGenGNumEv_Ratio_dRltpt1_etacut0->Sumw2();

   hAllKT6GenJets_et_etacut0 = new TH1F("hAllKT6GenJets_et_etacut0","All KT6GenJets E_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllKT6GenJets_et_etacut0->Sumw2();   
   hMatchKT6GenJets_dRltpt2_et_etacut0 = new TH1F("hMatchKT6GenJets_dRltpt2_et_etacut0","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_dRltpt2_et_etacut0->Sumw2();
   hMatchKT6GenJets_et_etacut0 = new TH1F("hMatchKT6GenJets_et_etacut0","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_et_etacut0->Sumw2();
   hMatchKT6Jets_dRltpt2_et_etacut0 = new TH1F("hMatchKT6Jets_dRltpt2_et_etacut0","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_dRltpt2_et_etacut0->Sumw2();
   hMatchKT6Jets_et_etacut0 = new TH1F("hMatchKT6Jets_et_etacut0","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_et_etacut0->Sumw2();
   hAllKT6Jets_et_etacut0 = new TH1F("hAllKT6Jets_et_etacut0","All K_{T}6Jet E_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllKT6Jets_et_etacut0->Sumw2();   


   hMatchedGenGNumEv_Ratio_etacut1 = new TH1F("hMatchedGenGNumEv_Ratio_etacut1","ratio (# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
   hMatchedGenGNumEv_Ratio_etacut1->Sumw2();
   hAllKT6GenJets_et_etacut1 = new TH1F("hAllKT6GenJets_et_etacut1","All KT6GenJets E_{T}, 1.3 <| #eta | <3",100,0,225);
   hAllKT6GenJets_et_etacut1->Sumw2();
   hMatchKT6GenJets_dRltpt2_et_etacut1 = new TH1F("hMatchKT6GenJets_dRltpt2_et_etacut1","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6GenJets_dRltpt2_et_etacut1->Sumw2();
   hMatchKT6GenJets_et_etacut1 = new TH1F("hMatchKT6GenJets_et_etacut1","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6GenJets_et_etacut1->Sumw2();
   hAllKT6Jets_et_etacut1 = new TH1F("hAllKT6Jets_et_etacut1","All K_{T}6Jet E_{T}, 1.3 <| #eta | <3",100,0,225);
   hAllKT6Jets_et_etacut1->Sumw2();
   hMatchKT6Jets_dRltpt2_et_etacut1 = new TH1F("hMatchKT6Jets_dRltpt2_et_etacut1","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6Jets_dRltpt2_et_etacut1->Sumw2();
   hMatchKT6Jets_et_etacut1 = new TH1F("hMatchKT6Jets_et_etacut1","KT6GenJets E_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6Jets_et_etacut1->Sumw2(); 

// pt plots
   hAllKT6GenJets_pt = new TH1F("hAllKT6GenJets_pt","All KT6GenJets p_{T}, All #eta",100,0,225);
   hAllKT6GenJets_pt->Sumw2();
   hMatchKT6GenJets_pt = new TH1F("hMatchKT6GenJets_pt","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchKT6GenJets_pt->Sumw2(); 
   hAllKT6Jets_pt = new TH1F("hAllKT6Jets_pt","All K_{T}6Jet p_{T}, All #eta",100,0,225);
   hAllKT6Jets_pt->Sumw2();
   hMatchKT6Jets_pt = new TH1F("hMatchKT6Jets_pt","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, All #eta",100,0,225);
   hMatchKT6Jets_pt->Sumw2();
//   hMatchedGenGNumEv_pt_Ratio = new TH1F("hMatchedGenGNumEv_pt_Ratio","pt (# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, All #eta",100,0,225);
//   hMatchedGenGNumEv_pt_Ratio->Sumw2();
   hMatchKT6GenJets_dRltpt2_pt = new TH1F("hMatchKT6GenJets_dRltpt2_pt","KT6GenJets p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchKT6GenJets_dRltpt2_pt->Sumw2();
   hMatchKT6Jets_dRltpt2_pt = new TH1F("hMatchKT6Jets_dRltpt2_pt","K_{T}6Jet p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, All #eta",100,0,225);
   hMatchKT6Jets_dRltpt2_pt->Sumw2();

   hAllKT6GenJets_pt_etacut0 = new TH1F("hAllKT6GenJets_pt_etacut0","All KT6GenJets p_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllKT6GenJets_pt_etacut0->Sumw2();
   hMatchKT6GenJets_pt_etacut0 = new TH1F("hMatchKT6GenJets_pt_etacut0","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_pt_etacut0->Sumw2(); 
   hAllKT6Jets_pt_etacut0 = new TH1F("hAllKT6Jets_pt_etacut0","All K_{T}6Jet p_{T}, 0<= | #eta | <=1.3",100,0,225);
   hAllKT6Jets_pt_etacut0->Sumw2();
   hMatchKT6Jets_pt_etacut0 = new TH1F("hMatchKT6Jets_pt_etacut0","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_pt_etacut0->Sumw2();
//   hMatchedGenGNumEv_pt_Ratio_etacut0 = new TH1F("hMatchedGenGNumEv_pt_Ratio_etacut0","pt (# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
//   hMatchedGenGNumEv_pt_Ratio_etacut0->Sumw2();
   hMatchKT6GenJets_dRltpt2_pt_etacut0 = new TH1F("hMatchKT6GenJets_dRltpt2_pt_etacut0","KT6GenJets p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_dRltpt2_pt_etacut0->Sumw2();
   hMatchKT6Jets_dRltpt2_pt_etacut0 = new TH1F("hMatchKT6Jets_dRltpt2_pt_etacut0","K_{T}6Jet p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_dRltpt2_pt_etacut0->Sumw2();
   
    hAllKT6GenJets_pt_etacut1 = new TH1F("hAllKT6GenJets_pt_etacut1","All KT6GenJets p_{T}, 1.3 <| #eta | <3",100,0,225);
    hAllKT6GenJets_pt_etacut1->Sumw2();
    hAllKT6Jets_pt_etacut1 = new TH1F("hAllKT6Jets_pt_etacut1","All K_{T}6Jet p_{T}, 1.3 <| #eta | <3",100,0,225);
    hAllKT6Jets_pt_etacut1->Sumw2();

//     ratiopt = new TH1F ("ratiopt", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, 0<= | #eta | <=1.3",6, 0, 225);
//    ratiopt->Sumw2();
//    sigmapTrpTm_pt = new TH1F ("sigmapTrpTm_pt", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3",7, 0, 225);
...
//      }
// 
//    ratiopt_etacut1 = new TH1F ("ratiopt_etacut1", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}, 1.3 <| #eta | <3",7, 0, 225);
//    ratiopt_etacut1->Sumw2();
//    sigmapTrpTm_pt_etacut1 = new TH1F ("sigmapTrpTm_pt_etacut1", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",7, 0, 225);
...
//      }
//      
//      ratioptOld = new TH1F ("ratioptOld", "p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T} (different bins)",13, 0, 350);
//    ratioptOld->Sumw2();
//    sigmapTrpTm_ptOld = new TH1F ("sigmapTrpTm_ptOld", "sigma(p^{K_{T}6Jet}_{T}/p^{KT6GenJets}_{T}) matched OneToOne #DeltaR_{m}<=0.2 (diff bins)",13, 0, 350);
...
//    hMatchedGenGNumEv_pt_Ratio_etacut1 = new TH1F("hMatchedGenGNumEv_pt_Ratio_etacut1","pt (# matched KT6GenJets)/(# All KT6GenJets) - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
//    hMatchedGenGNumEv_pt_Ratio_etacut1->Sumw2();
    hMatchKT6GenJets_dRltpt2_pt_etacut1 = new TH1F("hMatchKT6GenJets_dRltpt2_pt_etacut1","KT6GenJets p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
    hMatchKT6GenJets_dRltpt2_pt_etacut1->Sumw2();
    hMatchKT6GenJets_pt_etacut1 = new TH1F("hMatchKT6GenJets_pt_etacut1","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
    hMatchKT6GenJets_pt_etacut1->Sumw2();
    hMatchKT6Jets_dRltpt2_pt_etacut1 = new TH1F("hMatchKT6Jets_dRltpt2_pt_etacut1","K_{T}6Jet p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.2, 1.3 <| #eta | <3",100,0,225);
    hMatchKT6Jets_dRltpt2_pt_etacut1->Sumw2();
//    hMatchKT6Jets_pt_etacut1 = new TH1F("hMatchKT6Jets_pt_etacut1","KT6GenJets p_{T} - which have a OneToOne Match, no #DeltaR_{m} cut, 1.3 <| #eta | <3",100,0,225);
//    hMatchKT6Jets_pt_etacut1->Sumw2();
   
   hRecoVsGen_et_etacut1 = new TH2F( "RecoVsGen_et_etacut1", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt_etacut1 = new TH2F( "RecoVsGen_pt_etacut1", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta_etacut1 = new TH2F( "RecoVsGen_eta_etacut1", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi_etacut1 = new TH2F( "RecoVsGen_phi_etacut1", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et_etacut1 = new TH2F( "RecoVsGen_dRltpt2_et_etacut1", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt_etacut1 = new TH2F( "RecoVsGen_dRltpt2_pt_etacut1", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta_etacut1 = new TH2F( "RecoVsGen_dRltpt2_eta_etacut1", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi_etacut1 = new TH2F( "RecoVsGen_dRltpt2_phi_etacut1", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );

 
   hRecoVsGen_et_etacut0 = new TH2F( "RecoVsGen_et_etacut0", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt_etacut0 = new TH2F( "RecoVsGen_pt_etacut0", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta_etacut0 = new TH2F( "RecoVsGen_eta_etacut0", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi_etacut0 = new TH2F( "RecoVsGen_phi_etacut0", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et_etacut0 = new TH2F( "RecoVsGen_dRltpt2_et_etacut0", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt_etacut0 = new TH2F( "RecoVsGen_dRltpt2_pt_etacut0", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta_etacut0 = new TH2F( "RecoVsGen_dRltpt2_eta_etacut0", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi_etacut0 = new TH2F( "RecoVsGen_dRltpt2_phi_etacut0", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
 
   hRecoVsGen_et = new TH2F( "RecoVsGen_et", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_pt = new TH2F( "RecoVsGen_pt", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_eta = new TH2F( "RecoVsGen_eta", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_phi = new TH2F( "RecoVsGen_phi", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt2_et = new TH2F( "RecoVsGen_dRltpt2_et", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_pt = new TH2F( "RecoVsGen_dRltpt2_pt", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt2_eta = new TH2F( "RecoVsGen_dRltpt2_eta", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt2_phi = new TH2F( "RecoVsGen_dRltpt2_phi", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.2, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
// setup deltaR<=0.05 plots:
   hMatchKT6GenJets_dRltpt1_et = new TH1F("hMatchKT6GenJets_dRltpt1_et","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchKT6GenJets_dRltpt1_et->Sumw2();
   hMatchKT6Jets_dRltpt1_et = new TH1F("hMatchKT6Jets_dRltpt1_et","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchKT6Jets_dRltpt1_et->Sumw2();
   hMatchKT6GenJets_dRltpt1_et_etacut0 = new TH1F("hMatchKT6GenJets_dRltpt1_et_etacut0","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_dRltpt1_et_etacut0->Sumw2();
   hMatchKT6Jets_dRltpt1_et_etacut0 = new TH1F("hMatchKT6Jets_dRltpt1_et_etacut0","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_dRltpt1_et_etacut0->Sumw2();
   hMatchKT6GenJets_dRltpt1_et_etacut1 = new TH1F("hMatchKT6GenJets_dRltpt1_et_etacut1","KT6GenJets E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6GenJets_dRltpt1_et_etacut1->Sumw2();
   hMatchKT6Jets_dRltpt1_et_etacut1 = new TH1F("hMatchKT6Jets_dRltpt1_et_etacut1","K_{T}6Jet E_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 1.3 <| #eta | <3",100,0,225);
   hMatchKT6Jets_dRltpt1_et_etacut1->Sumw2();
   hMatchKT6GenJets_dRltpt1_pt = new TH1F("hMatchKT6GenJets_dRltpt1_pt","KT6GenJets p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchKT6GenJets_dRltpt1_pt->Sumw2();
   hMatchKT6Jets_dRltpt1_pt = new TH1F("hMatchKT6Jets_dRltpt1_pt","K_{T}6Jet p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, All #eta",100,0,225);
   hMatchKT6Jets_dRltpt1_pt->Sumw2();
   hMatchKT6GenJets_dRltpt1_pt_etacut0 = new TH1F("hMatchKT6GenJets_dRltpt1_pt_etacut0","KT6GenJets p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6GenJets_dRltpt1_pt_etacut0->Sumw2();
   hMatchKT6Jets_dRltpt1_pt_etacut0 = new TH1F("hMatchKT6Jets_dRltpt1_pt_etacut0","K_{T}6Jet p_{T} - which have a OneToOne Match within #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3",100,0,225);
   hMatchKT6Jets_dRltpt1_pt_etacut0->Sumw2();
   hRecoVsGen_dRltpt1_et_etacut1 = new TH2F( "RecoVsGen_dRltpt1_et_etacut1", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt_etacut1 = new TH2F( "RecoVsGen_dRltpt1_pt_etacut1", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta_etacut1 = new TH2F( "RecoVsGen_dRltpt1_eta_etacut1", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi_etacut1 = new TH2F( "RecoVsGen_dRltpt1_phi_etacut1", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, 1.3 <| #eta | <3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt1_et_etacut0 = new TH2F( "RecoVsGen_dRltpt1_et_etacut0", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt_etacut0 = new TH2F( "RecoVsGen_dRltpt1_pt_etacut0", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta_etacut0 = new TH2F( "RecoVsGen_dRltpt1_eta_etacut0", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi_etacut0 = new TH2F( "RecoVsGen_dRltpt1_phi_etacut0", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   hRecoVsGen_dRltpt1_et = new TH2F( "RecoVsGen_dRltpt1_et", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_pt = new TH2F( "RecoVsGen_dRltpt1_pt", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, 0, 225, 100, 0, 225);
   hRecoVsGen_dRltpt1_eta = new TH2F( "RecoVsGen_dRltpt1_eta", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100, -3, 3, 100, -3, 3 );
   hRecoVsGen_dRltpt1_phi = new TH2F( "RecoVsGen_dRltpt1_phi", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.1, All #eta", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );   
//    hRecoVsGen_dRltpt5_et = new TH2F( "RecoVsGen_dRltpt5_et", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRltpt5_pt = new TH2F( "RecoVsGen_dRltpt5_pt", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRltpt5_eta = new TH2F( "RecoVsGen_dRltpt5_eta", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
//    hRecoVsGen_dRltpt5_phi = new TH2F( "RecoVsGen_dRltpt5_phi", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=0.5, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
//    hRecoVsGen_dRlt1_et = new TH2F( "RecoVsGen_dRlt1_et", "K_{T}6Jet E_{T} vs. KT6GenJets E_{T} - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRlt1_pt = new TH2F( "RecoVsGen_dRlt1_pt", "K_{T}6Jet p_{T} vs. KT6GenJets p_{T} - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, 0, 225, 100, 0, 225);
//    hRecoVsGen_dRlt1_eta = new TH2F( "RecoVsGen_dRlt1_eta", "K_{T}6Jet #eta vs. KT6GenJets #eta - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100, -3, 3, 100, -3, 3 );
//    hRecoVsGen_dRlt1_phi = new TH2F( "RecoVsGen_dRlt1_phi", "K_{T}6Jet #phi vs. KT6GenJets #phi - matched OneToOne #DeltaR_{m}<=1.0, 0<= | #eta | <=1.3", 100,  -M_PI, M_PI, 100,  -M_PI, M_PI );
   cout<<"[KT6_PuAnalyzer_range]:: finish beginJob"<<endl;
         return ;
}

// ------------ method called once each job just after ending the event loop  ------------
void 
KT6_PuAnalyzer_range::endJob() {
 //  hOutputFile->cd() ;
//   Double_t limBins3[]  = {10,20,30,40,50,60,70,80,100.0,120.,150.,200};
  ...
  cout<<"[KT6_PuAnalyzer_range::endJob]: just made our limBins"<<endl;
//   hMatchedGenNumEv_Ratio->Divide(hMatchKT6Jets_dRltpt2_et,hAllKT6GenJets_et,1.,1.,"B");
   hMatchedGenGNumEv_Ratio->Divide(hMatchKT6GenJets_dRltpt2_pt,hAllKT6GenJets_pt,1.,1.,"B");
  cout<<"[KT6_PuAnalyzer_range::endJob]: just made hMatchedGenGNumEv_Ratio"<<endl;
   hMatchedGenGNumEv_Ratio_etacut0->Divide(hMatchKT6GenJets_dRltpt2_pt_etacut0,hAllKT6GenJets_pt_etacut0,1.,1.,"B");
  cout<<"[KT6_PuAnalyzer_range::endJob]:going to make hMatchedGenGNumEv_Ratio_dRltpt1 and hMatchedGenGNumEv_Ratio_dRltpt1_etacut0"<<endl;
   hMatchedGenGNumEv_Ratio_dRltpt1->Divide(hMatchKT6GenJets_dRltpt1_pt,hAllKT6GenJets_pt,1.,1.,"B");
   hMatchedGenGNumEv_Ratio_dRltpt1_etacut0->Divide(hMatchKT6GenJets_dRltpt1_pt_etacut0,hAllKT6GenJets_pt_etacut0,1.,1.,"B");
  cout<<"[KT6_PuAnalyzer_range::endJob]:made hMatchedGenGNumEv_Ratio_dRltpt1 and hMatchedGenGNumEv_Ratio_dRltpt1_etacut0, next fake ratios"<<endl;
   hFakeRatio->Divide(hUnMatchedKT6Jets_pt,hAllKT6Jets_pt,1.,1.,"B");
   hFakeRatio_etacut0->Divide(hUnMatchedKT6Jets_pt_etacut0,hAllKT6Jets_pt_etacut0,1.,1.,"B");
   hFakeRatio_etacut1->Divide(hUnMatchedKT6Jets_pt_etacut1,hAllKT6Jets_pt_etacut1,1.,1.,"B");
   cout<<"[KT6_PuAnalyzer_range::endJob]: made FakeRatio plots, next lines are commented out"<<endl;
//   hMatchedGenGNumEv_pt_Ratio->Divide(hMatchKT6GenJets_dRltpt2_pt,hAllKT6GenJets_pt_etacut0,1.,1.,"B");
//  cout<<"[KT6_PuAnalyzer_range::endJob]: just made hMatchedGenGNumEv_pt_Ratio"<<endl;

//   hMatchedCaloNumEv_Ratio->Divide(hMatchKT6Jets_dRltpt2_et,hAllKT6Jets_et,1.,1.,"B");
//   hMatchedGCaloNumEv_Ratio->Divide(hMatchKT6GenJets_dRltpt2_et,hAllKT6Jets_et,1.,1.,"B");

//   hMatchedGenGNumEv_pt_Ratio->Divide(hMatchKT6GenJets_dRltpt2_pt,hAllKT6GenJets_pt,1.,1.,"B");
 // endcap
//   hMatchedGenGNumEv_pt_Ratio_etacut1->Divide(hMatchKT6GenJets_dRltpt2_pt_etacut1,hAllKT6GenJets_pt_etacut1,1.,1.,"B");
  cout<<"[KT6_PuAnalyzer_range::endJob]: about to make hMatchedGenGNumEv_Ratio_etacut1"<<endl;

   hMatchedGenGNumEv_Ratio_etacut1->Divide(hMatchKT6GenJets_dRltpt2_pt_etacut1,hAllKT6GenJets_pt_etacut1,1.,1.,"B"); 
   //--> for no apparent reason this line crashes the program!
  cout<<"[KT6_PuAnalyzer_range::endJob]: did hMatchedGenGNumEv_Ratio_etacut1"<<endl;

  cout<<"[KT6_PuAnalyzer_range::endJob]: about to loop over 6 bins in outputI"<<endl;
  for(unsigned int outputI=0;outputI<6;outputI++){
   ...
   cout<<"[KT6_PuAnalyzer_range::endJob]: just did gaussian fit for pThist for bin: "<<outputI<<endl;
...
//    pThist[outputI]->Write();
    cout<<"[KT6_PuAnalyzer_range::endJob]: Just wrote out pThist for bin: "<<outputI<<endl;
   ...
   cout<<"[KT6_PuAnalyzer_range::endJob]: just did gaussian fit for pThist_dRltpt1 for bin: "<<outputI<<endl;
...
//    pThist_dRltpt1[outputI]->Write();
    cout<<"[KT6_PuAnalyzer_range::endJob]: Just wrote out pThist_dRltpt1 for bin: "<<outputI<<endl;
...
// position eta
   ...
   cout<<"[KT6_PuAnalyzer_range::endJob]: just did gaussian fit for etahist for bin: "<<outputI<<endl;
...
//    etahist[outputI]->Write();
    cout<<"[KT6_PuAnalyzer_range::endJob]: Just wrote out etahist for bin: "<<outputI<<endl;
// barrel
...
// position phi
   ...
   cout<<"[KT6_PuAnalyzer_range::endJob]: just did gaussian fit for phihist for bin: "<<outputI<<endl;
...
//    }
 //   phihist[outputI]->Write();
    cout<<"[KT6_PuAnalyzer_range::endJob]: Just wrote out phihist for bin: "<<outputI<<endl;
// barrel
...
//   ratioptOld->Write();  
//   hOutputFile->Write() ;
cout<<"[KT6_PuAnalyzer_range]:: start doing Write histos as part of destruction"<<endl;
		 hTotalLenght->Write();
		hdeltaR->Write();
...
cout<<"[KT6_PuAnalyzer_range]:: Wrote basic histos as part of destruction"<<endl;
...
//
cout<<"[KT6_PuAnalyzer_range]:: Wrote barrel+endcap histos as part of destruction"<<endl;

// position resolution:
		ratioeta->Write();
//				cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioeta->Write();histos as part of destruction"<<endl;
		sigmaeta->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaeta->Write();histos as part of destruction"<<endl;
		etahist [6]->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		etahist [6]->Write();histos as part of destruction"<<endl;
		ratioPhi->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioPhi->Write();histos as part of destruction"<<endl;
		sigmaphi->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaphi->Write();histos as part of destruction"<<endl;
		phihist [6]->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		phihist [6]->Write();histos as part of destruction"<<endl;
		ratioeta_etacut0->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioeta_etacut0->Write();histos as part of destruction"<<endl;
		sigmaeta_etacut0->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaeta_etacut0->Write();histos as part of destruction"<<endl;
		etahist_etacut0 [6]->Write();    
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		etahist_etacut0 [6]->Write();    histos as part of destruction"<<endl;
		ratioPhi_etacut0->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioPhi_etacut0->Write();histos as part of destruction"<<endl;
		sigmaphi_etacut0->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaphi_etacut0->Write();histos as part of destruction"<<endl;
		phihist_etacut0[6]->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		phihist_etacut0[6]->Write();histos as part of destruction"<<endl;
		ratioeta_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioeta_etacut1->Write();histos as part of destruction"<<endl;
		sigmaeta_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaeta_etacut1->Write();histos as part of destruction"<<endl;
		etahist_etacut1 [6]->Write();      
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		etahist_etacut1 [6]->Write();      histos as part of destruction"<<endl;
		ratioPhi_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		ratioPhi_etacut1->Write();histos as part of destruction"<<endl;
		sigmaphi_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		sigmaphi_etacut1->Write();histos as part of destruction"<<endl;
//	    phihist_etacut1[6]->Write();   
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote		phihist_etacut1[6]->Write();   histos as part of destruction"<<endl;
		cout<<"[KT6_PuAnalyzer_range]:: Wrote position histos as part of destruction"<<endl;
...
//    TH2F* 		hSimpleEfficiency_Energy->Write(); // (#matched jets)/(# reco jets) vs. p_{T} Gen  (what Korea group did)
		hAllKT6GenJets_et->Write();
//		hAllKT6GenJets_pt_etacut0->Write();
		hAllKT6GenJets_et_etacut0->Write();

		hAllKT6Jets_et->Write();
		hMatchKT6GenJets_dRltpt2_et->Write();
 		hMatchKT6GenJets_dRltpt1_et->Write();   
		hMatchKT6GenJets_et->Write();
		hMatchKT6Jets_dRltpt2_et->Write();
		hMatchKT6Jets_dRltpt1_et->Write();
		hMatchKT6Jets_et->Write();  
 
		hAllKT6Jets_et_etacut0->Write();
		hMatchKT6GenJets_dRltpt2_et_etacut0->Write();
		hMatchKT6GenJets_dRltpt1_et_etacut0->Write();    
		hMatchKT6GenJets_et_etacut0->Write();
		hMatchKT6Jets_dRltpt2_et_etacut0->Write();
		hMatchKT6Jets_dRltpt1_et_etacut0->Write();    
		hMatchKT6Jets_et_etacut0->Write();  
 		cout<<"[KT6_PuAnalyzer_range]:: Wrote match histos as part of destruction"<<endl;
 
		hAllKT6GenJets_pt->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6GenJets_pt"<<endl;
		hAllKT6Jets_pt->Write();
				cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6Jets_pt"<<endl;
		hMatchKT6GenJets_dRltpt2_pt->Write();
				cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6Jets_pt"<<endl;
		hMatchKT6GenJets_dRltpt1_pt->Write();    
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt1_pt"<<endl;
		hMatchKT6GenJets_pt->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_pt"<<endl;
		hMatchKT6Jets_dRltpt2_pt->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_dRltpt2_pt"<<endl;
		hMatchKT6Jets_dRltpt1_pt->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_dRltpt1_pt"<<endl;
		hMatchKT6Jets_pt->Write();  
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_pt"<<endl;
		hUnMatchedKT6Jets_pt->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_pt"<<endl;
		hUnMatchedKT6Jets_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_pt_etacut0"<<endl;
		hUnMatchedKT6Jets_pt_etacut1->Write();
        cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_pt_etacut1"<<endl;
		hUnMatchedKT6Jets_eta->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_eta"<<endl;
		hUnMatchedKT6Jets_eta_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_eta_etacut0"<<endl;
		hUnMatchedKT6Jets_eta_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hUnMatchedKT6Jets_eta_etacut1"<<endl;
//		hUnMatchedKT6Jets_dRltpt2_et->Write();
//		hUnMatchedKT6Jets_dRltpt2_et_etacut0->Write();
//		hUnMatchedKT6Jets_dRltpt2_et_etacut1->Write();
//		hMatchedGenGNumEv_pt_Ratio->Write();

		hMatchKT6GenJets_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_pt_etacut0"<<endl;
		hAllKT6Jets_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6Jets_pt_etacut0"<<endl;
		hAllKT6GenJets_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6GenJets_pt_etacut0"<<endl;
		hMatchKT6GenJets_dRltpt2_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt2_pt_etacut0"<<endl;
		hMatchKT6Jets_dRltpt2_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_dRltpt2_pt_etacut0"<<endl;
		hMatchKT6GenJets_dRltpt1_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt1_pt_etacut0"<<endl;
		hMatchKT6Jets_dRltpt1_pt_etacut0->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_dRltpt1_pt_etacut0"<<endl;
		hMatchKT6Jets_pt_etacut0->Write();     
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_pt_etacut0"<<endl;
//		hMatchedGenGNumEv_pt_Ratio_etacut0->Write();

 // endcap plots
//		hAllKT6GenJets_et_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6GenJets_et_etacut1"<<endl;
//		hAllKT6Jets_et_etacut1->Write();
//		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6Jets_et_etacut1"<<endl;
		hMatchKT6GenJets_dRltpt2_et_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt2_et_etacut1"<<endl;
		hMatchKT6GenJets_dRltpt1_et_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt1_et_etacut1"<<endl;
		hMatchKT6GenJets_et_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_et_etacut1"<<endl;
		hMatchKT6Jets_dRltpt2_et_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote 	hMatchKT6Jets_dRltpt2_et_etacut1"<<endl;
		hMatchKT6Jets_dRltpt1_et_etacut1->Write();
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_dRltpt1_et_etacut1"<<endl;
		hMatchKT6Jets_et_etacut1->Write();     
		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6Jets_et_etacut1"<<endl;
//		hMatchedGenGNumEv_et_Ratio_etacut1->Write();  
    
 		hAllKT6GenJets_pt_etacut1->Write();
 		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6GenJets_pt_etacut1"<<endl;
 		hAllKT6Jets_pt_etacut1->Write();
 		cout<<"[KT6_PuAnalyzer_range]:: Wrote hAllKT6Jets_pt_etacut1"<<endl;
 		hMatchKT6GenJets_dRltpt2_pt_etacut1->Write();
 		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_dRltpt2_pt_etacut1"<<endl;
 		hMatchKT6GenJets_pt_etacut1->Write();
 		cout<<"[KT6_PuAnalyzer_range]:: Wrote hMatchKT6GenJets_pt_etacut1"<<endl;
// 		hMatchKT6Jets_dRltpt2_pt_etacut1->Write();
// 		hMatchKT6Jets_pt_etacut1->Write();     
// 		hMatchedGenGNumEv_pt_Ratio_etacut1->Write();   
  		cout<<"[KT6_PuAnalyzer_range]:: Wrote more match histos as part of destruction"<<endl;
		...
		hMatchedGenGNumEv_Ratio_etacut1->Write(); // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
...
//		hMatchedGenNumEv_Ratio->Write(); // (# matched KT6 Jets)/(# All KT6GenJets)
		hMatchedGenGNumEv_Ratio->Write(); // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
		hMatchedGenGNumEv_Ratio_etacut0->Write(); // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
		hMatchedGenGNumEv_Ratio_dRltpt1->Write(); // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
		hMatchedGenGNumEv_Ratio_dRltpt1_etacut0->Write(); // (# matched KT6GenJets)/(# All KT6GenJets) --> this is the one
		hFakeRatio->Write();
...
//		hMatchedCaloNumEv_Ratio->Write(); // (# matched KT6 Jets)/(# All KT6 Jets)
//		hMatchedGCaloNumEv_Ratio->Write(); // (# matched KT6GenJets)/(# All KT6 Jets)
		hRecoVsGen_pt->Write();
		hRecoVsGen_et->Write();
...
cout<<"[KT6_PuAnalyzer_range]:: finish doing Write histos as part of destruction"<<endl;
   hOutputFile->Write() ;
// cout<<"[KT6_PuAnalyzer_range]:: going to close File part of destruction"<<endl;

//   hOutputFile->Close() ; 
 cout<<"[KT6_PuAnalyzer_range]:: end destruction"<<endl;

cout<<"[KT6_PuAnalyzer_range]:: finished endJob"<<endl;
   return ;
}

//define this as a plug-in
DEFINE_FWK_MODULE(KT6_PuAnalyzer_range);
