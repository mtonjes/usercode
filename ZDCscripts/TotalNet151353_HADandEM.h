...
#ifndef TotalNet151353_HADandEM_h
#define TotalNet151353_HADandEM_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class TotalNet151353_HADandEM {
public :
   ...
   TotalNet151353_HADandEM(TTree *tree=0);
   virtual ~TotalNet151353_HADandEM();
...
#ifdef TotalNet151353_HADandEM_cxx
TotalNet151353_HADandEM::TotalNet151353_HADandEM(TTree *tree)
{
...
TotalNet151353_HADandEM::~TotalNet151353_HADandEM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TotalNet151353_HADandEM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TotalNet151353_HADandEM::LoadTree(Long64_t entry)
{
...
void TotalNet151353_HADandEM::Init(TTree *tree)
{
...
Bool_t TotalNet151353_HADandEM::Notify()
{
...
void TotalNet151353_HADandEM::Show(Long64_t entry)
{
...
Int_t TotalNet151353_HADandEM::Cut(Long64_t entry)
{
...
#endif // #ifdef TotalNet151353_HADandEM_cxx
