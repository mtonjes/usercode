...
// Tue Jul 19 14:31:11 2011 by ROOT version 5.27/06b
// from TTree ZDCDigiTree/ZDC Digi Tree
// found on file: /data/users/belt/PbPb_data/zdc/zdctrees_151353_allFiles.root
//////////////////////////////////////////////////////////

#ifndef TotalNet151353_HADandEM_sum_456_h
#define TotalNet151353_HADandEM_sum_456_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class TotalNet151353_HADandEM_sum_456 {
public :
   ...
   TotalNet151353_HADandEM_sum_456(TTree *tree=0);
   virtual ~TotalNet151353_HADandEM_sum_456();
...
#ifdef TotalNet151353_HADandEM_sum_456_cxx
TotalNet151353_HADandEM_sum_456::TotalNet151353_HADandEM_sum_456(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/users/belt/PbPb_data/zdc/zdctrees_151353_allFiles.root");
      if (!f) {
         f = new TFile("/data/users/belt/PbPb_data/zdc/zdctrees_151353_allFiles.root");
      }
...
TotalNet151353_HADandEM_sum_456::~TotalNet151353_HADandEM_sum_456()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TotalNet151353_HADandEM_sum_456::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TotalNet151353_HADandEM_sum_456::LoadTree(Long64_t entry)
{
...
void TotalNet151353_HADandEM_sum_456::Init(TTree *tree)
{
...
Bool_t TotalNet151353_HADandEM_sum_456::Notify()
{
...
void TotalNet151353_HADandEM_sum_456::Show(Long64_t entry)
{
...
Int_t TotalNet151353_HADandEM_sum_456::Cut(Long64_t entry)
{
...
#endif // #ifdef TotalNet151353_HADandEM_sum_456_cxx
