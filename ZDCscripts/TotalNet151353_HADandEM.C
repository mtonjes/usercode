#define TotalNet151353_HADandEM_cxx
#include "TotalNet151353_HADandEM.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void TotalNet151353_HADandEM::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L TotalNet151353_HADandEM.C
//      Root > TotalNet151353_HADandEM t
...
//    fChain->GetEntry(jentry);       //read all branches
  gStyle->SetPalette(1);
    ...
    TChain *chain=new TChain("ZDCDigiTree","");
     ...
     TH1F* histogram_1 = new TH1F("TotalNetNegEMandHAD", "151353NetHAD", 1000, -100, 5000); 

    TH2F* histogram_2D = new TH2F("TotalNetNegEMandHAD2D", "NetEMvsHAD TS 6 7 8",  200, -100, 3000, 200, -100, 1000); 
  ...
  float TotalNoise5=0;
   ...
   histogram_1->Fill(HADsum, EMsum<200);
