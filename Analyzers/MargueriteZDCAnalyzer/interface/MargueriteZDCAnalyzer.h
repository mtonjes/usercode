...
// $Id: MargueriteZDCAnalyzer.h,v 1.1.1.1 2010/01/21 00:44:19 ssen Exp $
//
//
...
class MargueriteZDCAnalyzer : public edm::EDAnalyzer {
public:
	explicit MargueriteZDCAnalyzer(const edm::ParameterSet&);
	~MargueriteZDCAnalyzer();
...
private:
	...
	TH1F* h_ZDCP_EM_NoiseAve;
	TH1F* h_ZDCP_HAD_NoiseAve;
	TH1F* h_ZDCP_EM_EnAve;
	TH1F* h_ZDCP_HAD_EnAve;
	TH1F* h_ZDCP_EM_Noise[5];
	TH1F* h_ZDCP_HAD_Noise[4];
	TH1F* h_ZDCP_EM_En[5];
	TH1F* h_ZDCP_HAD_En[4];
	TH1F* h_ZDCP_EM_Saturation;
	TH1F* h_ZDCP_HAD_Saturation;
	...
	TH1F* h_ZDCM_EM_NoiseAve;
	TH1F* h_ZDCM_HAD_NoiseAve;
	TH1F* h_ZDCM_EM_EnAve;
	TH1F* h_ZDCM_HAD_EnAve;
	TH1F* h_ZDCM_EM_Noise[5];
	TH1F* h_ZDCM_HAD_Noise[4];
	TH1F* h_ZDCM_EM_En[5];
	TH1F* h_ZDCM_HAD_En[4];	
	TH1F* h_ZDCM_EM_Saturation;
	TH1F* h_ZDCM_HAD_Saturation;
...
DEFINE_FWK_MODULE(MargueriteZDCAnalyzer);
