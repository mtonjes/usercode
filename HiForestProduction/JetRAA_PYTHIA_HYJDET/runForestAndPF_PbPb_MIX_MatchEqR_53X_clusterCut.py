...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("HiForest_PYTHIA_HYDJET.root"))
...
process.jetSequences = cms.Sequence(process.hiReRecoPFJetsMatchEqRJetRAA +
...
### Re-reco the electron and PF sequences with a new cut on cluster Et ###
process.rereco_step = cms.Path(process.siPixelRecHits +
...
process.ecalDrivenElectronSeeds.SCEtCut = cms.double(15.0)
process.ecalDrivenElectronSeeds.SeedConfiguration.SCEtCut = cms.double(15.0)
#########################################
